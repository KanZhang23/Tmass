...
enum XYRescaleModes {XY_NO_RESCALE, XY_RESCALE, XY_RESCALE_AT_MAX,
	XY_GROW_ONLY, XY_REBIN_MODE, XY_REFRESH};
enum XYMarkStyles {XY_NO_MARK = 0, XY_SQUARE_MARK, XY_CIRCLE_MARK, XY_STAR_MARK,
	XY_X_MARK, XY_TRIANGLE_MARK, XY_SOLID_SQUARE_MARK, XY_SOLID_CIRCLE_MARK,
	XY_THICK_SQUARE_MARK, XY_THICK_CIRCLE_MARK, XY_N_MARK_STYLES};
enum XYMarkSizes {XY_TINY = 0, XY_SMALL, XY_MEDIUM, XY_LARGE, XY_N_MARK_SIZES};
enum XYLineStyles {XY_NO_LINE = 0, XY_PLAIN_LINE, XY_FINE_DASH, XY_MED_FINE_DASH,
...
#define XmNpsFont     "psFont"
#define XmCPsFont     "PsFont"
#define XmNpsFontSize "psFontSize"
#define XmCPsFontSize "PsFontSize"
#define XmNredisplayCallback "redisplayCallback"
#define XmCRedisplayCallback "RedisplayCallback"
#define XmNlineColors "lineColors"
#define XmNaddLeftMargin "addLeftMargin"
#define XmCAddLeftMargin "AddLeftMargin"
#define XmNaddRightMargin "addRightMargin"
#define XmCAddRightMargin "AddRightMargin"
#define XmNaddTopMargin "addTopMargin"
#define XmCAddTopMargin "AddTopMargin"
#define XmNaddBottomMargin "addBottomMargin"
#define XmCAddBottomMargin "AddBottomMargin"
...
typedef struct _XYCurve {
    XmString name;
    unsigned char markerStyle;
    unsigned char markerSize;
