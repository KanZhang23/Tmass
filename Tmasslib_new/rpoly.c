...
static void quad(double a,double b1,double c,double *sr,double *si,
                 double *lr,double *li);
...
static void quadsd(int n,double *u,double *v,double *p,double *q,
                   double *a,double *b);

static double *workmem = 0;
static unsigned len_workmem = 0;

static double *p,*qp,*k,*qk,*svk;
static double sr,si,u,v,a,b,c,d,a1;
static double a3,a7,e,f,g,h,szr,szi,lzr,lzi;
 ...
 */
    get_static_memory((void **)&workmem, sizeof(double),
                      &len_workmem, 7*(degree+1));
    memset(workmem, 0, 7*(degree+1)*sizeof(double));
