      DOUBLE PRECISION FUNCTION P0_DSIG10(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! g d > e+ ve g d d u~
      PD(IPROC)=G1*D2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g s > e+ ve g s s c~
      PD(IPROC)=G1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP0_MATRIX10(PP,DSIGUU)
      IF (DSIGUU.LT.1D199) THEN
        P0_DSIG10=PD(0)*CONV*DSIGUU
      ELSE
