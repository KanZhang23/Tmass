      DOUBLE PRECISION FUNCTION P0_DSIG72(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! d d > e+ ve d d d u~
      PD(IPROC)=D1*D2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! s s > e+ ve s s s c~
      PD(IPROC)=S1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP0_MATRIX72(PP,DSIGUU)
      IF (DSIGUU.LT.1D199) THEN
        P0_DSIG72=PD(0)*CONV*DSIGUU
      ELSE
