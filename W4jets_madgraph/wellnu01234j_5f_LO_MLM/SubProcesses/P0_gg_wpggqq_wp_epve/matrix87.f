...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX87(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX87(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1P0_3(W(1,8),W(1,4),GC_11,ZERO,ZERO,W(1,13))
      CALL FFV1_1(W(1,2),W(1,9),GC_11,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,7),W(1,14),W(1,13),GC_11,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,12),W(1,2),W(1,13),GC_11,AMP(4))
      CALL FFV1P0_3(W(1,7),W(1,2),GC_11,ZERO,ZERO,W(1,15))
      CALL FFV1_2(W(1,8),W(1,9),GC_11,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,16),W(1,4),W(1,15),GC_11,AMP(5))
      CALL FFV1_2(W(1,8),W(1,15),GC_11,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,17),W(1,4),W(1,9),GC_11,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL VVV1_0(W(1,9),W(1,15),W(1,13),GC_10,AMP(7))
      CALL FFV1P0_3(W(1,7),W(1,4),GC_11,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,16),W(1,2),W(1,17),GC_11,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL VVV1_0(W(1,9),W(1,17),W(1,10),GC_10,AMP(9))
      CALL FFV1_2(W(1,8),W(1,17),GC_11,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,16),W(1,2),W(1,9),GC_11,AMP(10))
      CALL FFV1_2(W(1,6),W(1,15),GC_11,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,16),W(1,1),W(1,13),GC_11,AMP(11))
      CALL FFV1_1(W(1,1),W(1,15),GC_11,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,6),W(1,8),W(1,13),GC_11,AMP(12))
...
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,6),W(1,18),W(1,10),GC_11,AMP(14))
      CALL FFV1P0_3(W(1,3),W(1,1),GC_11,ZERO,ZERO,W(1,10))
      CALL FFV2_2(W(1,6),W(1,5),GC_100,ZERO,ZERO,W(1,19))
      CALL FFV1_1(W(1,2),W(1,10),GC_11,ZERO,ZERO,W(1,20))
      CALL FFV1P0_3(W(1,19),W(1,4),GC_11,ZERO,ZERO,W(1,21))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,7),W(1,20),W(1,21),GC_11,AMP(15))
      CALL FFV1_1(W(1,4),W(1,10),GC_11,ZERO,ZERO,W(1,22))
      CALL FFV1P0_3(W(1,19),W(1,2),GC_11,ZERO,ZERO,W(1,23))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,7),W(1,22),W(1,23),GC_11,AMP(16))
      CALL FFV1_2(W(1,7),W(1,10),GC_11,ZERO,ZERO,W(1,24))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,24),W(1,4),W(1,23),GC_11,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,24),W(1,2),W(1,21),GC_11,AMP(18))
      CALL FFV1_2(W(1,19),W(1,10),GC_11,ZERO,ZERO,W(1,25))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,25),W(1,4),W(1,15),GC_11,AMP(19))
      CALL VVV1P0_1(W(1,10),W(1,15),GC_10,ZERO,ZERO,W(1,26))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,19),W(1,4),W(1,26),GC_11,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,19),W(1,22),W(1,15),GC_11,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,25),W(1,2),W(1,17),GC_11,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,19),W(1,20),W(1,17),GC_11,AMP(23))
      CALL VVV1P0_1(W(1,10),W(1,17),GC_10,ZERO,ZERO,W(1,25))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,19),W(1,2),W(1,25),GC_11,AMP(24))
      CALL FFV2_1(W(1,2),W(1,5),GC_100,ZERO,ZERO,W(1,19))
      CALL FFV1P0_3(W(1,6),W(1,19),GC_11,ZERO,ZERO,W(1,27))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,7),W(1,22),W(1,27),GC_11,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,24),W(1,4),W(1,27),GC_11,AMP(26))
      CALL FFV1_2(W(1,6),W(1,10),GC_11,ZERO,ZERO,W(1,28))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,28),W(1,19),W(1,17),GC_11,AMP(27))
      CALL FFV1_1(W(1,19),W(1,10),GC_11,ZERO,ZERO,W(1,29))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,6),W(1,29),W(1,17),GC_11,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,6),W(1,19),W(1,25),GC_11,AMP(29))
      CALL FFV2_1(W(1,4),W(1,5),GC_100,ZERO,ZERO,W(1,25))
      CALL FFV1P0_3(W(1,6),W(1,25),GC_11,ZERO,ZERO,W(1,29))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,7),W(1,20),W(1,29),GC_11,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,24),W(1,2),W(1,29),GC_11,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,28),W(1,25),W(1,15),GC_11,AMP(32))
      CALL FFV1_1(W(1,25),W(1,10),GC_11,ZERO,ZERO,W(1,24))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,6),W(1,24),W(1,15),GC_11,AMP(33))
C     Amplitude(s) for diagram number 34
      CALL FFV1_0(W(1,6),W(1,25),W(1,26),GC_11,AMP(34))
      CALL FFV1_1(W(1,4),W(1,15),GC_11,ZERO,ZERO,W(1,26))
C     Amplitude(s) for diagram number 35
      CALL FFV2_0(W(1,28),W(1,26),W(1,5),GC_100,AMP(35))
C     Amplitude(s) for diagram number 36
      CALL FFV2_0(W(1,16),W(1,22),W(1,5),GC_100,AMP(36))
      CALL FFV1_1(W(1,2),W(1,17),GC_11,ZERO,ZERO,W(1,22))
C     Amplitude(s) for diagram number 37
      CALL FFV2_0(W(1,28),W(1,22),W(1,5),GC_100,AMP(37))
C     Amplitude(s) for diagram number 38
      CALL FFV2_0(W(1,13),W(1,20),W(1,5),GC_100,AMP(38))
      CALL FFV1_2(W(1,3),W(1,15),GC_11,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 39
      CALL FFV1_0(W(1,20),W(1,1),W(1,21),GC_11,AMP(39))
C     Amplitude(s) for diagram number 40
      CALL FFV1_0(W(1,3),W(1,8),W(1,21),GC_11,AMP(40))
      CALL FFV1_2(W(1,3),W(1,17),GC_11,ZERO,ZERO,W(1,21))
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,21),W(1,1),W(1,23),GC_11,AMP(41))
C     Amplitude(s) for diagram number 42
      CALL FFV1_0(W(1,3),W(1,18),W(1,23),GC_11,AMP(42))
      CALL FFV1P0_3(W(1,3),W(1,19),GC_11,ZERO,ZERO,W(1,23))
C     Amplitude(s) for diagram number 43
      CALL FFV1_0(W(1,7),W(1,11),W(1,23),GC_11,AMP(43))
C     Amplitude(s) for diagram number 44
      CALL FFV1_0(W(1,12),W(1,4),W(1,23),GC_11,AMP(44))
      CALL FFV1_2(W(1,3),W(1,9),GC_11,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 45
      CALL FFV1_0(W(1,4),W(1,19),W(1,17),GC_11,AMP(45))
C     Amplitude(s) for diagram number 46
      CALL VVV1_0(W(1,9),W(1,17),W(1,23),GC_10,AMP(46))
C     Amplitude(s) for diagram number 47
      CALL FFV1_0(W(1,21),W(1,19),W(1,9),GC_11,AMP(47))
      CALL FFV1P0_3(W(1,3),W(1,25),GC_11,ZERO,ZERO,W(1,19))
C     Amplitude(s) for diagram number 48
      CALL FFV1_0(W(1,7),W(1,14),W(1,19),GC_11,AMP(48))
C     Amplitude(s) for diagram number 49
      CALL FFV1_0(W(1,12),W(1,2),W(1,19),GC_11,AMP(49))
C     Amplitude(s) for diagram number 50
      CALL FFV1_0(W(1,4),W(1,25),W(1,15),GC_11,AMP(50))
C     Amplitude(s) for diagram number 51
      CALL VVV1_0(W(1,9),W(1,15),W(1,19),GC_10,AMP(51))
C     Amplitude(s) for diagram number 52
      CALL FFV1_0(W(1,20),W(1,25),W(1,9),GC_11,AMP(52))
C     Amplitude(s) for diagram number 53
      CALL FFV2_0(W(1,4),W(1,26),W(1,5),GC_100,AMP(53))
C     Amplitude(s) for diagram number 54
      CALL FFV2_0(W(1,20),W(1,11),W(1,5),GC_100,AMP(54))
C     Amplitude(s) for diagram number 55
      CALL FFV2_0(W(1,4),W(1,22),W(1,5),GC_100,AMP(55))
C     Amplitude(s) for diagram number 56
      CALL FFV2_0(W(1,21),W(1,14),W(1,5),GC_100,AMP(56))
C     Amplitude(s) for diagram number 57
      CALL FFV1_0(W(1,13),W(1,1),W(1,23),GC_11,AMP(57))
C     Amplitude(s) for diagram number 58
      CALL FFV1_0(W(1,6),W(1,18),W(1,23),GC_11,AMP(58))
C     Amplitude(s) for diagram number 59
      CALL FFV1_0(W(1,21),W(1,1),W(1,27),GC_11,AMP(59))
C     Amplitude(s) for diagram number 60
      CALL FFV1_0(W(1,3),W(1,18),W(1,27),GC_11,AMP(60))
C     Amplitude(s) for diagram number 61
      CALL FFV1_0(W(1,16),W(1,1),W(1,19),GC_11,AMP(61))
C     Amplitude(s) for diagram number 62
      CALL FFV1_0(W(1,6),W(1,8),W(1,19),GC_11,AMP(62))
C     Amplitude(s) for diagram number 63
      CALL FFV1_0(W(1,20),W(1,1),W(1,29),GC_11,AMP(63))
C     Amplitude(s) for diagram number 64
      CALL FFV1_0(W(1,3),W(1,8),W(1,29),GC_11,AMP(64))
      JAMP(1)=+1D0/4D0*(+AMP(3)+AMP(5)+IMAG1*AMP(7)+1D0/3D0*AMP(8)
     $ +1D0/3D0*AMP(10)+AMP(11)+1D0/3D0*AMP(13)+1D0/3D0*AMP(14)
     $ +1D0/3D0*AMP(15)+1D0/9D0*AMP(16)+1D0/9D0*AMP(17)+1D0/3D0
     $ *AMP(18)+1D0/3D0*AMP(19)+1D0/3D0*AMP(21)+1D0/9D0*AMP(22)
     $ +1D0/9D0*AMP(23)+1D0/9D0*AMP(25)+1D0/9D0*AMP(26)+1D0/9D0
     $ *AMP(27)+1D0/9D0*AMP(28)+1D0/3D0*AMP(30)+1D0/3D0*AMP(31)
     $ +1D0/3D0*AMP(32)+1D0/3D0*AMP(33)+1D0/3D0*AMP(35)+1D0/3D0
     $ *AMP(36)+1D0/9D0*AMP(37)+1D0/9D0*AMP(38)+1D0/9D0*AMP(41)
     $ +1D0/9D0*AMP(42)+1D0/3D0*AMP(45)+1D0/3D0*AMP(47)+AMP(48)
     $ +AMP(50)+IMAG1*AMP(51)+AMP(53)+1D0/3D0*AMP(55)+1D0/3D0*AMP(56)
     $ +1D0/3D0*AMP(57)+1D0/3D0*AMP(58)+1D0/9D0*AMP(59)+1D0/9D0
     $ *AMP(60)+AMP(61))
      JAMP(2)=+1D0/4D0*(-AMP(1)-1D0/3D0*AMP(5)-1D0/3D0*AMP(6)-AMP(8)
     $ -IMAG1*AMP(9)-1D0/3D0*AMP(11)-1D0/3D0*AMP(12)-AMP(13)-1D0/9D0
     $ *AMP(15)-1D0/3D0*AMP(16)-1D0/3D0*AMP(17)-1D0/9D0*AMP(18)
     $ -1D0/9D0*AMP(19)-1D0/9D0*AMP(21)-1D0/3D0*AMP(22)-1D0/3D0
     $ *AMP(23)-1D0/3D0*AMP(25)-1D0/3D0*AMP(26)-1D0/3D0*AMP(27)
     $ -1D0/3D0*AMP(28)-1D0/9D0*AMP(30)-1D0/9D0*AMP(31)-1D0/9D0
     $ *AMP(32)-1D0/9D0*AMP(33)-1D0/9D0*AMP(35)-1D0/9D0*AMP(36)
     $ -1D0/3D0*AMP(37)-1D0/3D0*AMP(38)-1D0/9D0*AMP(39)-1D0/9D0
     $ *AMP(40)-AMP(43)-AMP(45)-IMAG1*AMP(46)-1D0/3D0*AMP(50)
     $ -1D0/3D0*AMP(52)-1D0/3D0*AMP(53)-1D0/3D0*AMP(54)-AMP(55)
     $ -AMP(57)-1D0/3D0*AMP(61)-1D0/3D0*AMP(62)-1D0/9D0*AMP(63)
     $ -1D0/9D0*AMP(64))
      JAMP(3)=+1D0/4D0*(-1D0/9D0*AMP(1)-1D0/9D0*AMP(2)-1D0/3D0*AMP(3)
     $ -1D0/3D0*AMP(4)-1D0/3D0*AMP(5)-1D0/3D0*AMP(6)-1D0/9D0*AMP(8)
     $ -1D0/9D0*AMP(10)-1D0/9D0*AMP(13)-1D0/9D0*AMP(14)-AMP(15)
     $ -AMP(19)-IMAG1*AMP(20)-1D0/3D0*AMP(22)-1D0/3D0*AMP(23)
     $ -1D0/3D0*AMP(27)-1D0/3D0*AMP(28)-AMP(30)-AMP(32)-IMAG1*AMP(34)
     $ -AMP(35)-1D0/3D0*AMP(37)-1D0/3D0*AMP(38)-AMP(39)-1D0/3D0
     $ *AMP(41)-1D0/3D0*AMP(42)-1D0/9D0*AMP(43)-1D0/9D0*AMP(44)
     $ -1D0/9D0*AMP(45)-1D0/9D0*AMP(47)-1D0/3D0*AMP(48)-1D0/3D0
     $ *AMP(49)-1D0/3D0*AMP(50)-1D0/3D0*AMP(52)-1D0/3D0*AMP(53)
     $ -1D0/3D0*AMP(54)-1D0/9D0*AMP(55)-1D0/9D0*AMP(56)-1D0/9D0
     $ *AMP(57)-1D0/9D0*AMP(58)-1D0/3D0*AMP(59)-1D0/3D0*AMP(60)
     $ -AMP(63))
      JAMP(4)=+1D0/4D0*(+1D0/3D0*AMP(1)+1D0/3D0*AMP(2)+1D0/9D0*AMP(3)
     $ +1D0/9D0*AMP(4)+1D0/9D0*AMP(5)+1D0/9D0*AMP(6)+1D0/3D0*AMP(8)
     $ +1D0/3D0*AMP(10)+1D0/9D0*AMP(11)+1D0/9D0*AMP(12)+AMP(16)
     $ +1D0/3D0*AMP(19)+1D0/3D0*AMP(21)+AMP(22)+IMAG1*AMP(24)+AMP(25)
     $ +AMP(27)+IMAG1*AMP(29)+1D0/3D0*AMP(32)+1D0/3D0*AMP(33)
     $ +1D0/3D0*AMP(35)+1D0/3D0*AMP(36)+AMP(37)+1D0/3D0*AMP(39)
     $ +1D0/3D0*AMP(40)+AMP(41)+1D0/3D0*AMP(43)+1D0/3D0*AMP(44)
     $ +1D0/3D0*AMP(45)+1D0/3D0*AMP(47)+1D0/9D0*AMP(48)+1D0/9D0
     $ *AMP(49)+1D0/9D0*AMP(50)+1D0/9D0*AMP(52)+1D0/9D0*AMP(53)
     $ +1D0/9D0*AMP(54)+1D0/3D0*AMP(55)+1D0/3D0*AMP(56)+AMP(59)
     $ +1D0/9D0*AMP(61)+1D0/9D0*AMP(62)+1D0/3D0*AMP(63)+1D0/3D0
     $ *AMP(64))
      JAMP(5)=+1D0/4D0*(+1D0/3D0*AMP(1)+1D0/3D0*AMP(2)+AMP(4)
     $ +AMP(6)-IMAG1*AMP(7)+AMP(12)+1D0/3D0*AMP(13)+1D0/3D0*AMP(14)
     $ +1D0/3D0*AMP(15)+AMP(17)+1D0/3D0*AMP(18)+AMP(23)-IMAG1*AMP(24)
     $ +AMP(26)+AMP(28)-IMAG1*AMP(29)+1D0/3D0*AMP(30)+1D0/3D0*AMP(31)
     $ +AMP(38)+1D0/3D0*AMP(39)+1D0/3D0*AMP(40)+AMP(42)+1D0/3D0
     $ *AMP(43)+1D0/3D0*AMP(44)+AMP(49)-IMAG1*AMP(51)+AMP(52)+AMP(54)
     $ +1D0/3D0*AMP(57)+1D0/3D0*AMP(58)+AMP(60)+AMP(62)+1D0/3D0
     $ *AMP(63)+1D0/3D0*AMP(64))
      JAMP(6)=+1D0/4D0*(-AMP(2)-1D0/3D0*AMP(3)-1D0/3D0*AMP(4)
     $ +IMAG1*AMP(9)-AMP(10)-1D0/3D0*AMP(11)-1D0/3D0*AMP(12)-AMP(14)
     $ -1D0/3D0*AMP(16)-1D0/3D0*AMP(17)-AMP(18)+IMAG1*AMP(20)-AMP(21)
     $ -1D0/3D0*AMP(25)-1D0/3D0*AMP(26)-AMP(31)-AMP(33)+IMAG1*AMP(34)
     $ -AMP(36)-AMP(40)-1D0/3D0*AMP(41)-1D0/3D0*AMP(42)-AMP(44)
     $ +IMAG1*AMP(46)-AMP(47)-1D0/3D0*AMP(48)-1D0/3D0*AMP(49)-AMP(56)
     $ -AMP(58)-1D0/3D0*AMP(59)-1D0/3D0*AMP(60)-1D0/3D0*AMP(61)
     $ -1D0/3D0*AMP(62)-AMP(64))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX87 = P0_MATRIX87+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
