...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX79(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX79(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFV1P0_3(W(1,1),W(1,4),GC_11,ZERO,ZERO,W(1,19))
...
C     Amplitude(s) for diagram number 42
      ...
      CALL FFV1P0_3(W(1,6),W(1,10),GC_11,ZERO,ZERO,W(1,33))
...
C     Amplitude(s) for diagram number 44
      ...
      CALL FFV1_2(W(1,6),W(1,9),GC_11,ZERO,ZERO,W(1,34))
...
C     Amplitude(s) for diagram number 46
      ...
      CALL FFV1_2(W(1,6),W(1,18),GC_11,ZERO,ZERO,W(1,35))
C     Amplitude(s) for diagram number 47
      ...
      CALL FFV1P0_3(W(1,6),W(1,36),GC_11,ZERO,ZERO,W(1,37))
...
C     Amplitude(s) for diagram number 51
      ...
      CALL FFV1_2(W(1,6),W(1,15),GC_11,ZERO,ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 56
      ...
      CALL FFV1P0_3(W(1,6),W(1,14),GC_11,ZERO,ZERO,W(1,34))
...
C     Amplitude(s) for diagram number 58
      ...
      CALL FFV1_2(W(1,6),W(1,19),GC_11,ZERO,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 65
      ...
      CALL FFV1_2(W(1,6),W(1,24),GC_11,ZERO,ZERO,W(1,22))
...
C     Amplitude(s) for diagram number 72
      ...
      CALL FFV1_2(W(1,6),W(1,16),GC_11,ZERO,ZERO,W(1,35))
...
C     Amplitude(s) for diagram number 96
     ...
     $ *AMP(88)+AMP(90)+1D0/3D0*AMP(91)+1D0/3D0*AMP(92)+AMP(95))
      JAMP(4)=+1D0/4D0*(-AMP(1)-1D0/3D0*AMP(5)-1D0/3D0*AMP(6)-AMP(8)
     ...
     $ *AMP(93)-1D0/9D0*AMP(94)-1D0/3D0*AMP(95)-1D0/3D0*AMP(96))
      JAMP(6)=+1D0/4D0*(+1D0/3D0*AMP(1)+1D0/3D0*AMP(2)+AMP(4)
     ...
     $ +AMP(96))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX79 = P0_MATRIX79+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
