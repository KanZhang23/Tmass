...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX83(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX83(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,9),W(1,4),W(1,14),GC_11,AMP(4))
      CALL FFV1_1(W(1,4),W(1,8),GC_11,ZERO,ZERO,W(1,15))
...
C     Amplitude(s) for diagram number 32
     ...
     $ *AMP(30)-AMP(32))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX83 = P0_MATRIX83+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
