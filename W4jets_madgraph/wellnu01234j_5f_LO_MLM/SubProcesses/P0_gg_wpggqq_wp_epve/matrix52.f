...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX52(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX52(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      PARAMETER (NWAVEFUNCS=25, NCOLOR=6)
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
      COMPLEX*16 IMAG1
...
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV1P0_3(W(1,1),W(1,10),GC_11,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,7),W(1,11),W(1,15),GC_11,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,12),W(1,3),W(1,15),GC_11,AMP(9))
      CALL FFV1_2(W(1,1),W(1,9),GC_11,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,12),W(1,10),W(1,13),GC_11,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL VVV1_0(W(1,9),W(1,13),W(1,15),GC_10,AMP(11))
      CALL FFV1_2(W(1,1),W(1,13),GC_11,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,3),W(1,10),W(1,9),GC_11,AMP(12))
      CALL FFV1_1(W(1,4),W(1,13),GC_11,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 13
      CALL FFV2_0(W(1,12),W(1,10),W(1,5),GC_100,AMP(13))
      CALL FFV1_1(W(1,4),W(1,9),GC_11,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 14
      CALL FFV2_0(W(1,3),W(1,10),W(1,5),GC_100,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,14),W(1,2),W(1,15),GC_11,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,6),W(1,8),W(1,15),GC_11,AMP(16))
      JAMP(1)=+1D0/4D0*(-1D0/3D0*AMP(3)-1D0/3D0*AMP(5)-1D0/3D0*AMP(6)
     $ -1D0/3D0*AMP(7)-1D0/3D0*AMP(10)-1D0/3D0*AMP(12)-1D0/3D0*AMP(13)
     $ -1D0/3D0*AMP(14)-1D0/3D0*AMP(15)-1D0/3D0*AMP(16))
      JAMP(2)=+1D0/4D0*(+AMP(1)+AMP(3)+IMAG1*AMP(4)+AMP(6)+AMP(8)
     $ +AMP(10)+IMAG1*AMP(11)+AMP(13)+AMP(15))
      JAMP(3)=+1D0/4D0*(+1D0/9D0*AMP(1)+1D0/9D0*AMP(2)+1D0/9D0*AMP(3)
     $ +1D0/9D0*AMP(5)+1D0/9D0*AMP(6)+1D0/9D0*AMP(7)+1D0/9D0*AMP(8)
     $ +1D0/9D0*AMP(9)+1D0/9D0*AMP(10)+1D0/9D0*AMP(12)+1D0/9D0*AMP(13)
     $ +1D0/9D0*AMP(14)+1D0/9D0*AMP(15)+1D0/9D0*AMP(16))
      JAMP(4)=+1D0/4D0*(-1D0/3D0*AMP(1)-1D0/3D0*AMP(2)-1D0/3D0*AMP(3)
     $ -1D0/3D0*AMP(5)-1D0/3D0*AMP(8)-1D0/3D0*AMP(9)-1D0/3D0*AMP(10)
     $ -1D0/3D0*AMP(12)-1D0/3D0*AMP(13)-1D0/3D0*AMP(14))
      JAMP(5)=+1D0/4D0*(-1D0/3D0*AMP(1)-1D0/3D0*AMP(2)-1D0/3D0*AMP(6)
     $ -1D0/3D0*AMP(7)-1D0/3D0*AMP(8)-1D0/3D0*AMP(9)-1D0/3D0*AMP(15)
     $ -1D0/3D0*AMP(16))
      JAMP(6)=+1D0/4D0*(+AMP(2)-IMAG1*AMP(4)+AMP(5)+AMP(7)+AMP(9)
     $ -IMAG1*AMP(11)+AMP(12)+AMP(14)+AMP(16))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX52 = P0_MATRIX52+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
