      DOUBLE PRECISION FUNCTION P0_DSIG31(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! u c > e+ ve c d s s~
      PD(IPROC)=U1*C2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! u c > e+ ve c d b b~
      PD(IPROC)=U1*C2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! u s > e+ ve s d c c~
      PD(IPROC)=U1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! u s > e+ ve s d b b~
      PD(IPROC)=U1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! c d > e+ ve s u d u~
      PD(IPROC)=C1*D2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! c d > e+ ve d s b b~
      PD(IPROC)=C1*D2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP0_MATRIX31(PP,DSIGUU)
      IF (DSIGUU.LT.1D199) THEN
        P0_DSIG31=PD(0)*CONV*DSIGUU
      ELSE
