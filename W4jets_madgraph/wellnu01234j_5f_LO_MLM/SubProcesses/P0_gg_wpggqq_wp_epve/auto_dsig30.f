      DOUBLE PRECISION FUNCTION P0_DSIG30(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! u c > e+ ve c d d d~
      PD(IPROC)=U1*C2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! u s > e+ ve s d d d~
      PD(IPROC)=U1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! c d > e+ ve d s s s~
      PD(IPROC)=C1*D2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP0_MATRIX30(PP,DSIGUU)
      IF (DSIGUU.LT.1D199) THEN
        P0_DSIG30=PD(0)*CONV*DSIGUU
      ELSE
