...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX70(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX70(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,9),W(1,4),W(1,11),GC_11,AMP(25))
...
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,11),W(1,4),W(1,13),GC_11,AMP(27))
...
C     Amplitude(s) for diagram number 32
     ...
     $ *AMP(30)-AMP(31))
      JAMP(2)=+1D0/4D0*(+1D0/3D0*AMP(1)+AMP(3)+1D0/3D0*AMP(4)
     ...
     $ *AMP(26)+AMP(28)+AMP(30)+1D0/3D0*AMP(31)+1D0/3D0*AMP(32))
      JAMP(3)=+1D0/4D0*(+1D0/3D0*AMP(1)+1D0/9D0*AMP(2)+1D0/9D0*AMP(3)
     ...
     $ *AMP(28)+1D0/9D0*AMP(29)+1D0/9D0*AMP(30))
      JAMP(4)=+1D0/4D0*(-1D0/3D0*AMP(2)-1D0/3D0*AMP(3)-AMP(4)
     ...
     $ -1D0/3D0*AMP(28)-1D0/3D0*AMP(29)-1D0/3D0*AMP(30)-AMP(32))
      JAMP(5)=+1D0/4D0*(-1D0/9D0*AMP(1)-1D0/3D0*AMP(2)-1D0/3D0*AMP(3)
     ...
     $ *AMP(26)-1D0/9D0*AMP(31)-1D0/9D0*AMP(32))
      JAMP(6)=+1D0/4D0*(+AMP(2)+1D0/3D0*AMP(5)+1D0/3D0*AMP(7)+AMP(8)
     ...
     $ *AMP(31)+1D0/3D0*AMP(32))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX70 = P0_MATRIX70+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
