      DOUBLE PRECISION FUNCTION P0_DSIG2(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! g g > e+ ve u d u~ u~
      PD(IPROC)=G1*G2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g g > e+ ve c s c~ c~
      PD(IPROC)=G1*G2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP0_MATRIX2(PP,DSIGUU)
      IF (DSIGUU.LT.1D199) THEN
        P0_DSIG2=PD(0)*CONV*DSIGUU
      ELSE
