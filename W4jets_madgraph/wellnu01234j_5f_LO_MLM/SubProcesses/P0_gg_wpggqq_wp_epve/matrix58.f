...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX58(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX58(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV1_1(W(1,3),W(1,10),GC_11,ZERO,ZERO,W(1,16))
...
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,18),W(1,3),W(1,17),GC_11,AMP(9))
...
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,18),W(1,3),W(1,21),GC_11,AMP(14))
...
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,20),W(1,4),W(1,17),GC_11,AMP(20))
...
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,12),W(1,3),W(1,17),GC_11,AMP(23))
...
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,20),W(1,4),W(1,21),GC_11,AMP(31))
C     Amplitude(s) for diagram number 32
     ...
     $ -1D0/9D0*AMP(30)-1D0/3D0*AMP(31)-1D0/3D0*AMP(32))
      JAMP(2)=+1D0/4D0*(+1D0/3D0*AMP(1)+1D0/3D0*AMP(2)+1D0/3D0*AMP(6)
     ...
     $ +1D0/3D0*AMP(29)+1D0/3D0*AMP(30)+AMP(32))
      JAMP(3)=+1D0/4D0*(+1D0/3D0*AMP(3)+1D0/3D0*AMP(4)+1D0/3D0*AMP(6)
     ...
     $ +1D0/3D0*AMP(30)+1D0/9D0*AMP(31)+1D0/9D0*AMP(32))
      JAMP(4)=+1D0/4D0*(-AMP(2)-AMP(4)+IMAG1*AMP(5)-AMP(7)-1D0/3D0
     ...
     $ -AMP(28)-AMP(30)-1D0/3D0*AMP(31)-1D0/3D0*AMP(32))
      JAMP(5)=+1D0/4D0*(-AMP(1)-AMP(3)-IMAG1*AMP(5)-AMP(6)-1D0/3D0
     ...
     $ *AMP(28)+AMP(31))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX58 = P0_MATRIX58+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
