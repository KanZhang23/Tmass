      DOUBLE PRECISION FUNCTION P0_DSIG18(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! u u > e+ ve u u d u~
      PD(IPROC)=U1*U2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! c c > e+ ve c c s c~
      PD(IPROC)=C1*C2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP0_MATRIX18(PP,DSIGUU)
      IF (DSIGUU.LT.1D199) THEN
        P0_DSIG18=PD(0)*CONV*DSIGUU
      ELSE
