...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX36(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX36(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 14
      ...
      CALL FFV1P0_3(W(1,7),W(1,4),GC_11,ZERO,ZERO,W(1,24))
...
C     Amplitude(s) for diagram number 30
      ...
      CALL FFV1_2(W(1,2),W(1,24),GC_11,ZERO,ZERO,W(1,17))
...
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,2),W(1,29),W(1,10),GC_11,AMP(32))
...
C     Amplitude(s) for diagram number 34
      CALL FFV1_0(W(1,2),W(1,26),W(1,13),GC_11,AMP(34))
      CALL FFV1_2(W(1,2),W(1,15),GC_11,ZERO,ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 36
      CALL FFV1_0(W(1,2),W(1,30),W(1,20),GC_11,AMP(36))
...
C     Amplitude(s) for diagram number 38
      CALL FFV1_0(W(1,2),W(1,31),W(1,13),GC_11,AMP(38))
      CALL FFV1_2(W(1,2),W(1,18),GC_11,ZERO,ZERO,W(1,13))
...
C     Amplitude(s) for diagram number 40
      CALL FFV1_0(W(1,2),W(1,32),W(1,20),GC_11,AMP(40))
...
C     Amplitude(s) for diagram number 42
      CALL FFV1_0(W(1,2),W(1,20),W(1,10),GC_11,AMP(42))
...
C     Amplitude(s) for diagram number 96
     ...
     $ *AMP(93)-1D0/9D0*AMP(94)-1D0/3D0*AMP(95)-1D0/3D0*AMP(96))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX36 = P0_MATRIX36+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
