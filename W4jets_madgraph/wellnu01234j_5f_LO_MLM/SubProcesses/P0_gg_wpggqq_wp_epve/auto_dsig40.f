      DOUBLE PRECISION FUNCTION P0_DSIG40(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! u u~ > e+ ve u d u~ u~
      PD(IPROC)=U1*UX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! c c~ > e+ ve c s c~ c~
      PD(IPROC)=C1*CX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP0_MATRIX40(PP,DSIGUU)
      IF (DSIGUU.LT.1D199) THEN
        P0_DSIG40=PD(0)*CONV*DSIGUU
      ELSE
