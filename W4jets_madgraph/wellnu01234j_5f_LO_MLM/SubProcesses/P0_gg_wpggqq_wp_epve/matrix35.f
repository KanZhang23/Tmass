...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX35(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX35(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,2),W(1,11),W(1,19),GC_11,AMP(15))
...
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,2),W(1,14),W(1,22),GC_11,AMP(20))
...
C     Amplitude(s) for diagram number 32
     ...
     $ -1D0/3D0*AMP(28)-1D0/9D0*AMP(31)-1D0/9D0*AMP(32))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX35 = P0_MATRIX35+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
