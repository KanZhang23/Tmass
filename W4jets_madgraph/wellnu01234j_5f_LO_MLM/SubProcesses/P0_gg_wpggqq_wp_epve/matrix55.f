...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX55(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX55(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 42
      CALL FFV1_0(W(1,21),W(1,6),W(1,26),GC_11,AMP(42))
...
C     Amplitude(s) for diagram number 50
      ...
      CALL FFV1P0_3(W(1,27),W(1,6),GC_11,ZERO,ZERO,W(1,30))
...
C     Amplitude(s) for diagram number 55
      CALL FFV1_0(W(1,10),W(1,6),W(1,11),GC_11,AMP(55))
...
C     Amplitude(s) for diagram number 58
      CALL FFV1_0(W(1,10),W(1,6),W(1,17),GC_11,AMP(58))
...
C     Amplitude(s) for diagram number 79
      CALL FFV1_0(W(1,20),W(1,6),W(1,11),GC_11,AMP(79))
...
C     Amplitude(s) for diagram number 82
      CALL FFV1_0(W(1,20),W(1,6),W(1,17),GC_11,AMP(82))
...
C     Amplitude(s) for diagram number 98
     ...
     $ *AMP(63)-AMP(64)-AMP(65)-IMAG1*AMP(66)+AMP(90)-AMP(93)
     $ +AMP(91)-IMAG1*AMP(94)-AMP(95)+AMP(99)-AMP(102)+AMP(100))
      JAMP(5)=+1D0/2D0*(+1D0/3D0*AMP(25)+1D0/3D0*AMP(26)+1D0/3D0
     ...
     $ *AMP(65)+1D0/3D0*AMP(80)+1D0/3D0*AMP(83))
      JAMP(6)=+1D0/2D0*(-AMP(25)-AMP(26)-AMP(27)-AMP(28)-IMAG1*AMP(32)
     ...
     $ +AMP(90)-AMP(93)+AMP(91)+AMP(99)-AMP(102)+AMP(100))
      JAMP(9)=+1D0/2D0*(-AMP(13)-AMP(14)-AMP(17)-AMP(18)-AMP(20)
     ...
     $ -AMP(88)-AMP(89)+AMP(93)+AMP(92)-AMP(97)+AMP(102)+AMP(101))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX55 = P0_MATRIX55+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
