...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX74(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX74(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 14
      ...
      CALL FFV1P0_3(W(1,6),W(1,2),GC_11,ZERO,ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 64
      ...
      JAMP(1)=+1D0/4D0*(-1D0/3D0*AMP(1)-1D0/3D0*AMP(2)-AMP(4)-AMP(6)
     ...
     $ *AMP(63)-1D0/3D0*AMP(64))
      JAMP(2)=+1D0/4D0*(+AMP(2)+1D0/3D0*AMP(3)+1D0/3D0*AMP(4)
     ...
     $ +1D0/3D0*AMP(62)+AMP(64))
      JAMP(3)=+1D0/4D0*(+AMP(1)+1D0/3D0*AMP(5)+1D0/3D0*AMP(6)+AMP(8)
     ...
     $ *AMP(64))
      JAMP(6)=+1D0/4D0*(+1D0/9D0*AMP(1)+1D0/9D0*AMP(2)+1D0/3D0*AMP(3)
     ...
     $ +AMP(63))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX74 = P0_MATRIX74+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
