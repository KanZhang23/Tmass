      DOUBLE PRECISION FUNCTION P0_DSIG3(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! g g > e+ ve u s u~ c~
      PD(IPROC)=G1*G2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g g > e+ ve c d c~ u~
      PD(IPROC)=G1*G2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g g > e+ ve s d s~ u~
      PD(IPROC)=G1*G2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g g > e+ ve d s d~ c~
      PD(IPROC)=G1*G2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g g > e+ ve b d b~ u~
      PD(IPROC)=G1*G2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g g > e+ ve b s b~ c~
      PD(IPROC)=G1*G2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP0_MATRIX3(PP,DSIGUU)
      IF (DSIGUU.LT.1D199) THEN
        P0_DSIG3=PD(0)*CONV*DSIGUU
      ELSE
