...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX89(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX89(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 98
     ...
     $ *AMP(32)-AMP(33)-IMAG1*AMP(35)-AMP(37)-AMP(38)-AMP(41)-AMP(42)
     ...
     $ *AMP(65)+1D0/3D0*AMP(74)+1D0/3D0*AMP(77))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX89 = P0_MATRIX89+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
