      DOUBLE PRECISION FUNCTION P0_DSIG100(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! d~ s~ > e+ ve c u~ c~ s~
      PD(IPROC)=DX1*SX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! d~ s~ > e+ ve b u~ b~ s~
      PD(IPROC)=DX1*SX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP0_MATRIX100(PP,DSIGUU)
      IF (DSIGUU.LT.1D199) THEN
        P0_DSIG100=PD(0)*CONV*DSIGUU
      ELSE
