...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX91(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX91(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,9),W(1,2),W(1,14),GC_11,AMP(4))
      CALL FFV1_1(W(1,2),W(1,8),GC_11,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,9),W(1,15),W(1,13),GC_11,AMP(5))
      CALL FFV1P0_3(W(1,6),W(1,4),GC_11,ZERO,ZERO,W(1,9))
      CALL FFV1_2(W(1,7),W(1,9),GC_11,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,16),W(1,15),W(1,5),GC_100,AMP(6))
...
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,19),W(1,15),W(1,9),GC_11,AMP(13))
...
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,6),W(1,16),W(1,14),GC_11,AMP(20))
...
C     Amplitude(s) for diagram number 24
      CALL FFV2_0(W(1,10),W(1,15),W(1,5),GC_100,AMP(24))
...
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,3),W(1,15),W(1,11),GC_11,AMP(26))
...
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,3),W(1,15),W(1,20),GC_11,AMP(32))
      JAMP(1)=+1D0/4D0*(+1D0/9D0*AMP(1)+1D0/9D0*AMP(2)+1D0/9D0*AMP(3)
     $ +1D0/9D0*AMP(5)+1D0/3D0*AMP(6)+1D0/3D0*AMP(7)+1D0/3D0*AMP(9)
     ...
     $ -1D0/3D0*AMP(5)-1D0/9D0*AMP(6)-1D0/9D0*AMP(7)-1D0/9D0*AMP(9)
     ...
     $ -1D0/9D0*AMP(28)-1D0/9D0*AMP(29)-1D0/9D0*AMP(30))
      JAMP(3)=+1D0/4D0*(-1D0/3D0*AMP(3)-1D0/3D0*AMP(5)-AMP(6)
     ...
     $ -1D0/3D0*AMP(31)-1D0/3D0*AMP(32))
      JAMP(4)=+1D0/4D0*(+AMP(1)+AMP(3)+IMAG1*AMP(4)+1D0/3D0*AMP(14)
     ...
     $ *AMP(26)-AMP(27)-AMP(29)-1D0/3D0*AMP(31)-1D0/3D0*AMP(32))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX91 = P0_MATRIX91+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
