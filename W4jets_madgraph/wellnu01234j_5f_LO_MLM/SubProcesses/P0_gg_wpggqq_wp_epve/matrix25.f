...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX25(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX25(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,7),W(1,8),W(1,10),GC_11,AMP(7))
      CALL FFV1P0_3(W(1,1),W(1,4),GC_11,ZERO,ZERO,W(1,10))
      CALL FFV2_2(W(1,7),W(1,5),GC_100,ZERO,ZERO,W(1,15))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV1P0_3(W(1,7),W(1,15),GC_11,ZERO,ZERO,W(1,21))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,2),W(1,16),W(1,21),GC_11,AMP(13))
...
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,7),W(1,16),W(1,13),GC_11,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,7),W(1,15),W(1,19),GC_11,AMP(17))
...
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,2),W(1,11),W(1,17),GC_11,AMP(22))
...
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,7),W(1,8),W(1,17),GC_11,AMP(30))
...
C     Amplitude(s) for diagram number 32
     ...
     $ -IMAG1*AMP(25)-AMP(27)-AMP(29))
      JAMP(3)=+1D0/4D0*(-AMP(2)-AMP(4)+IMAG1*AMP(5)-AMP(7)-1D0/3D0
     ...
     $ -1D0/9D0*AMP(30)-1D0/3D0*AMP(31)-1D0/3D0*AMP(32))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX25 = P0_MATRIX25+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
