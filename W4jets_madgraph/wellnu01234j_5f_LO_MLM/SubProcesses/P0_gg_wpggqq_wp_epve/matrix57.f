...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX57(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX57(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 35
      CALL FFV1_0(W(1,29),W(1,3),W(1,25),GC_11,AMP(35))
...
C     Amplitude(s) for diagram number 38
      ...
      CALL FFV1P0_3(W(1,1),W(1,3),GC_11,ZERO,ZERO,W(1,26))
      CALL FFV1_1(W(1,4),W(1,26),GC_11,ZERO,ZERO,W(1,29))
...
C     Amplitude(s) for diagram number 59
      CALL FFV1_0(W(1,31),W(1,4),W(1,25),GC_11,AMP(59))
...
C     Amplitude(s) for diagram number 62
      ...
      CALL FFV1_2(W(1,1),W(1,17),GC_11,ZERO,ZERO,W(1,33))
C     Amplitude(s) for diagram number 63
      CALL FFV1_0(W(1,33),W(1,3),W(1,23),GC_11,AMP(63))
...
C     Amplitude(s) for diagram number 74
      CALL FFV1_0(W(1,23),W(1,3),W(1,25),GC_11,AMP(74))
C     Amplitude(s) for diagram number 75
      CALL FFV1_0(W(1,1),W(1,11),W(1,25),GC_11,AMP(75))
...
C     Amplitude(s) for diagram number 85
      CALL FFV1_0(W(1,21),W(1,4),W(1,25),GC_11,AMP(85))
C     Amplitude(s) for diagram number 86
      CALL FFV1_0(W(1,1),W(1,15),W(1,25),GC_11,AMP(86))
...
C     Amplitude(s) for diagram number 91
      CALL FFV1_0(W(1,33),W(1,3),W(1,32),GC_11,AMP(91))
...
C     Amplitude(s) for diagram number 96
     ...
     $ *AMP(92)+1D0/3D0*AMP(93)+1D0/3D0*AMP(94)+AMP(96))
      JAMP(3)=+1D0/4D0*(+1D0/3D0*AMP(3)+1D0/3D0*AMP(4)+AMP(7)
     ...
     $ *AMP(93)+1D0/3D0*AMP(94)+1D0/9D0*AMP(95)+1D0/9D0*AMP(96))
      JAMP(4)=+1D0/4D0*(-AMP(2)-AMP(4)+IMAG1*AMP(5)-1D0/3D0*AMP(8)
     ...
     $ *AMP(92)-AMP(94)-1D0/3D0*AMP(95)-1D0/3D0*AMP(96))
      JAMP(5)=+1D0/4D0*(-AMP(1)-AMP(3)-IMAG1*AMP(5)-1D0/3D0*AMP(6)
     ...
     $ +1D0/3D0*AMP(86)+AMP(87)+AMP(89)+AMP(95))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX57 = P0_MATRIX57+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
