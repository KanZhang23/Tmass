...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX44(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX44(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1_1(W(1,4),W(1,9),GC_11,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,7),W(1,14),W(1,13),GC_11,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,12),W(1,4),W(1,13),GC_11,AMP(4))
      CALL FFV1P0_3(W(1,7),W(1,4),GC_11,ZERO,ZERO,W(1,15))
...
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,16),W(1,4),W(1,17),GC_11,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL VVV1_0(W(1,9),W(1,17),W(1,10),GC_10,AMP(9))
      CALL FFV1_2(W(1,8),W(1,17),GC_11,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,16),W(1,4),W(1,9),GC_11,AMP(10))
      CALL FFV1_2(W(1,6),W(1,15),GC_11,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,16),W(1,2),W(1,13),GC_11,AMP(11))
      CALL FFV1_1(W(1,2),W(1,15),GC_11,ZERO,ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 14
      ...
      CALL FFV1_1(W(1,4),W(1,10),GC_11,ZERO,ZERO,W(1,20))
...
C     Amplitude(s) for diagram number 15
      ...
      CALL FFV1P0_3(W(1,19),W(1,4),GC_11,ZERO,ZERO,W(1,23))
...
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,24),W(1,4),W(1,21),GC_11,AMP(18))
...
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,24),W(1,4),W(1,29),GC_11,AMP(31))
...
C     Amplitude(s) for diagram number 36
      ...
      CALL FFV1_1(W(1,4),W(1,17),GC_11,ZERO,ZERO,W(1,22))
...
C     Amplitude(s) for diagram number 39
      CALL FFV1_0(W(1,20),W(1,2),W(1,21),GC_11,AMP(39))
...
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,21),W(1,2),W(1,23),GC_11,AMP(41))
...
C     Amplitude(s) for diagram number 49
      CALL FFV1_0(W(1,12),W(1,4),W(1,19),GC_11,AMP(49))
...
C     Amplitude(s) for diagram number 64
     ...
     $ *AMP(64))
      JAMP(5)=+1D0/4D0*(-1D0/3D0*AMP(1)-1D0/3D0*AMP(2)-AMP(4)-AMP(6)
     $ +IMAG1*AMP(7)-AMP(12)-1D0/3D0*AMP(13)-1D0/3D0*AMP(14)-1D0/3D0
     $ *AMP(15)-AMP(17)-1D0/3D0*AMP(18)-AMP(23)+IMAG1*AMP(24)-AMP(26)
     $ -AMP(28)+IMAG1*AMP(29)-1D0/3D0*AMP(30)-1D0/3D0*AMP(31)-AMP(38)
     $ -1D0/3D0*AMP(39)-1D0/3D0*AMP(40)-AMP(42)-1D0/3D0*AMP(43)
     $ -1D0/3D0*AMP(44)-AMP(49)+IMAG1*AMP(51)-AMP(52)-AMP(54)
     ...
     $ +1D0/3D0*AMP(62)+AMP(64))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX44 = P0_MATRIX44+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
