      DOUBLE PRECISION FUNCTION P0_DSIG16(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! g d~ > e+ ve g d u~ d~
      PD(IPROC)=G1*DX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g s~ > e+ ve g s c~ s~
      PD(IPROC)=G1*SX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP0_MATRIX16(PP,DSIGUU)
      IF (DSIGUU.LT.1D199) THEN
        P0_DSIG16=PD(0)*CONV*DSIGUU
      ELSE
