      DOUBLE PRECISION FUNCTION P0_DSIG11(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! g u~ > e+ ve g d u~ u~
      PD(IPROC)=G1*UX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g c~ > e+ ve g s c~ c~
      PD(IPROC)=G1*CX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP0_MATRIX11(PP,DSIGUU)
      IF (DSIGUU.LT.1D199) THEN
        P0_DSIG11=PD(0)*CONV*DSIGUU
      ELSE
