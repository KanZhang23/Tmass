...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX23(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX23(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV1P0_3(W(1,2),W(1,15),GC_11,ZERO,ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,2),W(1,22),W(1,17),GC_11,AMP(22))
...
C     Amplitude(s) for diagram number 24
      ...
      CALL FFV1P0_3(W(1,2),W(1,23),GC_11,ZERO,ZERO,W(1,25))
...
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,2),W(1,23),W(1,26),GC_11,AMP(26))
...
C     Amplitude(s) for diagram number 37
      CALL FFV1_0(W(1,27),W(1,7),W(1,25),GC_11,AMP(37))
      CALL FFV1P0_3(W(1,24),W(1,9),GC_11,ZERO,ZERO,W(1,26))
C     Amplitude(s) for diagram number 38
      CALL FFV1_0(W(1,2),W(1,23),W(1,26),GC_11,AMP(38))
...
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,27),W(1,7),W(1,28),GC_11,AMP(41))
...
C     Amplitude(s) for diagram number 47
      CALL FFV1_0(W(1,27),W(1,7),W(1,29),GC_11,AMP(47))
...
C     Amplitude(s) for diagram number 50
      CALL FFV1_0(W(1,16),W(1,7),W(1,30),GC_11,AMP(50))
...
C     Amplitude(s) for diagram number 53
      CALL FFV1_0(W(1,20),W(1,7),W(1,30),GC_11,AMP(53))
...
C     Amplitude(s) for diagram number 59
      CALL FFV1_0(W(1,22),W(1,7),W(1,30),GC_11,AMP(59))
...
C     Amplitude(s) for diagram number 61
      CALL FFV1_0(W(1,2),W(1,30),W(1,11),GC_11,AMP(61))
...
C     Amplitude(s) for diagram number 64
      CALL FFV1_0(W(1,2),W(1,30),W(1,17),GC_11,AMP(64))
      CALL FFV1_2(W(1,16),W(1,4),GC_11,ZERO,ZERO,W(1,30))
C     Amplitude(s) for diagram number 65
      CALL FFV1_0(W(1,30),W(1,7),W(1,25),GC_11,AMP(65))
...
C     Amplitude(s) for diagram number 83
      CALL FFV1_0(W(1,30),W(1,7),W(1,28),GC_11,AMP(83))
...
C     Amplitude(s) for diagram number 87
      CALL FFV1_0(W(1,1),W(1,15),W(1,2),GC_11,AMP(87))
C     Amplitude(s) for diagram number 88
      CALL VVV1_0(W(1,2),W(1,3),W(1,11),GC_10,AMP(88))
...
C     Amplitude(s) for diagram number 98
     ...
     $ +AMP(88)+AMP(89)-AMP(93)-AMP(92)+AMP(97)-AMP(102)-AMP(101))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX23 = P0_MATRIX23+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
