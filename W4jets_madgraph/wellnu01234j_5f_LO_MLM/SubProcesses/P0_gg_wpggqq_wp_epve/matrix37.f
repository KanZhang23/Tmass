...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX37(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX37(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL FFV2_2(W(1,7),W(1,5),GC_100,ZERO,ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,2),W(1,12),W(1,13),GC_11,AMP(2))
...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFV1P0_3(W(1,7),W(1,9),GC_11,ZERO,ZERO,W(1,19))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,2),W(1,12),W(1,19),GC_11,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,14),W(1,6),W(1,19),GC_11,AMP(12))
      CALL FFV1_2(W(1,7),W(1,8),GC_11,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,20),W(1,9),W(1,18),GC_11,AMP(13))
      CALL FFV1_1(W(1,9),W(1,8),GC_11,ZERO,ZERO,W(1,21))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,7),W(1,21),W(1,18),GC_11,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,7),W(1,9),W(1,16),GC_11,AMP(15))
      CALL FFV2_1(W(1,6),W(1,5),GC_100,ZERO,ZERO,W(1,9))
      CALL FFV1P0_3(W(1,7),W(1,9),GC_11,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,2),W(1,10),W(1,16),GC_11,AMP(16))
...
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,7),W(1,14),W(1,15),GC_11,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,7),W(1,9),W(1,17),GC_11,AMP(20))
      CALL FFV1_1(W(1,6),W(1,15),GC_11,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 21
      CALL FFV2_0(W(1,20),W(1,9),W(1,5),GC_100,AMP(21))
      CALL FFV1_2(W(1,7),W(1,15),GC_11,ZERO,ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 23
      ...
      CALL FFV1_2(W(1,7),W(1,18),GC_11,ZERO,ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 32
      ...
      JAMP(1)=+1D0/4D0*(+1D0/9D0*AMP(1)+1D0/3D0*AMP(2)+1D0/3D0*AMP(3)
     ...
     $ *AMP(26)+1D0/9D0*AMP(31)+1D0/9D0*AMP(32))
      JAMP(2)=+1D0/4D0*(-1D0/3D0*AMP(1)-1D0/9D0*AMP(2)-1D0/9D0*AMP(3)
     ...
     $ *AMP(28)-1D0/9D0*AMP(29)-1D0/9D0*AMP(30))
      JAMP(3)=+1D0/4D0*(-1D0/3D0*AMP(1)-AMP(3)-1D0/3D0*AMP(4)-AMP(9)
     ...
     $ +1D0/3D0*AMP(28)+1D0/3D0*AMP(29)+1D0/3D0*AMP(30)+AMP(32))
      JAMP(5)=+1D0/4D0*(+AMP(1)+AMP(5)+IMAG1*AMP(6)+1D0/3D0*AMP(8)
     ...
     $ *AMP(31)-1D0/3D0*AMP(32))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX37 = P0_MATRIX37+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
