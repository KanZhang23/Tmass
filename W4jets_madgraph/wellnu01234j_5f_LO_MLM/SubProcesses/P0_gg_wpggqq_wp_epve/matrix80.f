...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX80(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX80(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,14),W(1,4),W(1,9),GC_11,AMP(4))
...
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,18),W(1,4),W(1,14),GC_11,AMP(9))
...
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,21),W(1,4),W(1,25),GC_11,AMP(18))
      CALL FFV1_1(W(1,4),W(1,10),GC_11,ZERO,ZERO,W(1,26))
...
C     Amplitude(s) for diagram number 34
      ...
      CALL FFV1P0_3(W(1,31),W(1,4),GC_11,ZERO,ZERO,W(1,25))
C     Amplitude(s) for diagram number 35
      CALL FFV1_0(W(1,29),W(1,2),W(1,25),GC_11,AMP(35))
...
C     Amplitude(s) for diagram number 38
      ...
      CALL FFV1P0_3(W(1,3),W(1,2),GC_11,ZERO,ZERO,W(1,26))
...
C     Amplitude(s) for diagram number 42
      CALL FFV1_0(W(1,21),W(1,4),W(1,24),GC_11,AMP(42))
      CALL FFV1_1(W(1,4),W(1,26),GC_11,ZERO,ZERO,W(1,33))
...
C     Amplitude(s) for diagram number 63
      CALL FFV1_0(W(1,33),W(1,2),W(1,23),GC_11,AMP(63))
...
C     Amplitude(s) for diagram number 74
      CALL FFV1_0(W(1,23),W(1,2),W(1,25),GC_11,AMP(74))
...
C     Amplitude(s) for diagram number 91
      CALL FFV1_0(W(1,33),W(1,2),W(1,32),GC_11,AMP(91))
...
C     Amplitude(s) for diagram number 96
      ...
      JAMP(1)=+1D0/4D0*(+AMP(1)+AMP(3)+IMAG1*AMP(5)+1D0/3D0*AMP(6)
     ...
     $ +1D0/3D0*AMP(87)+1D0/3D0*AMP(88)+AMP(91)+AMP(93))
      JAMP(2)=+1D0/4D0*(-1D0/3D0*AMP(3)-1D0/3D0*AMP(4)-AMP(7)-AMP(9)
     $ +IMAG1*AMP(10)-AMP(12)-1D0/3D0*AMP(13)-1D0/3D0*AMP(14)
     ...
     $ +1D0/9D0*AMP(94)+1D0/3D0*AMP(95)+1D0/3D0*AMP(96))
      JAMP(5)=+1D0/4D0*(+AMP(2)+AMP(4)-IMAG1*AMP(5)+1D0/3D0*AMP(8)
     ...
     $ *AMP(92)-1D0/3D0*AMP(93)-1D0/3D0*AMP(94)-AMP(96))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX80 = P0_MATRIX80+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
