...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX69(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX69(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,6),W(1,3),W(1,13),GC_11,AMP(9))
...
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,9),W(1,4),W(1,11),GC_11,AMP(13))
      CALL FFV1_1(W(1,4),W(1,13),GC_11,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,1),W(1,15),W(1,11),GC_11,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,9),W(1,4),W(1,16),GC_11,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,1),W(1,15),W(1,16),GC_11,AMP(16))
      JAMP(1)=+1D0/4D0*(-1D0/3D0*AMP(3)-1D0/3D0*AMP(5)-1D0/3D0*AMP(8)
     $ -1D0/3D0*AMP(9)-1D0/3D0*AMP(11)-1D0/3D0*AMP(12)-1D0/3D0*AMP(13)
     $ -1D0/3D0*AMP(14)-1D0/3D0*AMP(15)-1D0/3D0*AMP(16))
      JAMP(2)=+1D0/4D0*(+AMP(2)-IMAG1*AMP(4)+AMP(5)+AMP(7)+AMP(9)
     ...
     $ -1D0/3D0*AMP(9)-1D0/3D0*AMP(11)-1D0/3D0*AMP(12))
      JAMP(6)=+1D0/4D0*(+AMP(1)+AMP(3)+IMAG1*AMP(4)+AMP(6)+AMP(8)
     $ +IMAG1*AMP(10)+AMP(11)+AMP(13)+AMP(15))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX69 = P0_MATRIX69+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
