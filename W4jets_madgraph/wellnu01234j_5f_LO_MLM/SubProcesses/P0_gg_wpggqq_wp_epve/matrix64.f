...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX64(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX64(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,16),W(1,4),W(1,18),GC_11,AMP(8))
...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFV1P0_3(W(1,8),W(1,2),GC_11,ZERO,ZERO,W(1,20))
      CALL FFV1_1(W(1,3),W(1,19),GC_11,ZERO,ZERO,W(1,21))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,7),W(1,21),W(1,20),GC_11,AMP(11))
      CALL FFV1_2(W(1,7),W(1,19),GC_11,ZERO,ZERO,W(1,22))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,22),W(1,3),W(1,20),GC_11,AMP(12))
      CALL FFV1_1(W(1,2),W(1,19),GC_11,ZERO,ZERO,W(1,23))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,7),W(1,23),W(1,13),GC_11,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,22),W(1,2),W(1,13),GC_11,AMP(14))
      CALL FFV1P0_3(W(1,7),W(1,2),GC_11,ZERO,ZERO,W(1,24))
      CALL FFV1_2(W(1,8),W(1,19),GC_11,ZERO,ZERO,W(1,25))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,25),W(1,3),W(1,24),GC_11,AMP(15))
      CALL FFV1_2(W(1,8),W(1,24),GC_11,ZERO,ZERO,W(1,26))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,26),W(1,3),W(1,19),GC_11,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL VVV1_0(W(1,19),W(1,24),W(1,13),GC_10,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,25),W(1,2),W(1,18),GC_11,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL VVV1_0(W(1,19),W(1,18),W(1,20),GC_10,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,16),W(1,2),W(1,19),GC_11,AMP(20))
      CALL FFV1P0_3(W(1,6),W(1,3),GC_11,ZERO,ZERO,W(1,16))
      CALL FFV1_1(W(1,4),W(1,16),GC_11,ZERO,ZERO,W(1,25))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,7),W(1,25),W(1,20),GC_11,AMP(21))
      CALL FFV1_2(W(1,7),W(1,16),GC_11,ZERO,ZERO,W(1,27))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,27),W(1,4),W(1,20),GC_11,AMP(22))
      CALL FFV1_1(W(1,2),W(1,16),GC_11,ZERO,ZERO,W(1,28))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,7),W(1,28),W(1,10),GC_11,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,27),W(1,2),W(1,10),GC_11,AMP(24))
      CALL FFV1_2(W(1,8),W(1,16),GC_11,ZERO,ZERO,W(1,29))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,29),W(1,4),W(1,24),GC_11,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,26),W(1,4),W(1,16),GC_11,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL VVV1_0(W(1,16),W(1,24),W(1,10),GC_10,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,29),W(1,2),W(1,15),GC_11,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL VVV1_0(W(1,16),W(1,15),W(1,20),GC_10,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,17),W(1,2),W(1,16),GC_11,AMP(30))
      CALL FFV1_2(W(1,6),W(1,24),GC_11,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,17),W(1,3),W(1,10),GC_11,AMP(31))
      CALL FFV1_1(W(1,3),W(1,24),GC_11,ZERO,ZERO,W(1,29))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,6),W(1,29),W(1,10),GC_11,AMP(32))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,17),W(1,4),W(1,13),GC_11,AMP(33))
      CALL FFV1_1(W(1,4),W(1,24),GC_11,ZERO,ZERO,W(1,26))
C     Amplitude(s) for diagram number 34
      CALL FFV1_0(W(1,6),W(1,26),W(1,13),GC_11,AMP(34))
      CALL FFV1_2(W(1,6),W(1,15),GC_11,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 35
      CALL FFV1_0(W(1,8),W(1,3),W(1,20),GC_11,AMP(35))
      CALL FFV1_1(W(1,3),W(1,15),GC_11,ZERO,ZERO,W(1,30))
C     Amplitude(s) for diagram number 36
      CALL FFV1_0(W(1,6),W(1,30),W(1,20),GC_11,AMP(36))
C     Amplitude(s) for diagram number 37
      CALL FFV1_0(W(1,8),W(1,2),W(1,13),GC_11,AMP(37))
      CALL FFV1_1(W(1,2),W(1,15),GC_11,ZERO,ZERO,W(1,31))
C     Amplitude(s) for diagram number 38
      CALL FFV1_0(W(1,6),W(1,31),W(1,13),GC_11,AMP(38))
      CALL FFV1_2(W(1,6),W(1,18),GC_11,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 39
      CALL FFV1_0(W(1,13),W(1,4),W(1,20),GC_11,AMP(39))
      CALL FFV1_1(W(1,4),W(1,18),GC_11,ZERO,ZERO,W(1,32))
C     Amplitude(s) for diagram number 40
      CALL FFV1_0(W(1,6),W(1,32),W(1,20),GC_11,AMP(40))
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,13),W(1,2),W(1,10),GC_11,AMP(41))
      CALL FFV1_1(W(1,2),W(1,18),GC_11,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 42
      CALL FFV1_0(W(1,6),W(1,20),W(1,10),GC_11,AMP(42))
      CALL FFV2_1(W(1,4),W(1,5),GC_100,ZERO,ZERO,W(1,10))
      CALL FFV1P0_3(W(1,1),W(1,10),GC_11,ZERO,ZERO,W(1,33))
C     Amplitude(s) for diagram number 43
      CALL FFV1_0(W(1,7),W(1,11),W(1,33),GC_11,AMP(43))
C     Amplitude(s) for diagram number 44
      CALL FFV1_0(W(1,12),W(1,3),W(1,33),GC_11,AMP(44))
      CALL FFV1_2(W(1,1),W(1,9),GC_11,ZERO,ZERO,W(1,34))
...
C     Amplitude(s) for diagram number 46
      ...
      CALL FFV1_2(W(1,1),W(1,18),GC_11,ZERO,ZERO,W(1,35))
C     Amplitude(s) for diagram number 47
      CALL FFV1_0(W(1,35),W(1,10),W(1,9),GC_11,AMP(47))
      CALL FFV2_1(W(1,3),W(1,5),GC_100,ZERO,ZERO,W(1,36))
      CALL FFV1P0_3(W(1,1),W(1,36),GC_11,ZERO,ZERO,W(1,37))
C     Amplitude(s) for diagram number 48
      CALL FFV1_0(W(1,7),W(1,14),W(1,37),GC_11,AMP(48))
C     Amplitude(s) for diagram number 49
      CALL FFV1_0(W(1,12),W(1,4),W(1,37),GC_11,AMP(49))
...
C     Amplitude(s) for diagram number 51
      ...
      CALL FFV1_2(W(1,1),W(1,15),GC_11,ZERO,ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 56
      ...
      CALL FFV2_1(W(1,2),W(1,5),GC_100,ZERO,ZERO,W(1,14))
      CALL FFV1P0_3(W(1,1),W(1,14),GC_11,ZERO,ZERO,W(1,34))
C     Amplitude(s) for diagram number 57
      CALL FFV1_0(W(1,7),W(1,21),W(1,34),GC_11,AMP(57))
C     Amplitude(s) for diagram number 58
      CALL FFV1_0(W(1,22),W(1,3),W(1,34),GC_11,AMP(58))
      CALL FFV1_2(W(1,1),W(1,19),GC_11,ZERO,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 62
      CALL FFV1_0(W(1,7),W(1,23),W(1,37),GC_11,AMP(62))
C     Amplitude(s) for diagram number 63
      CALL FFV1_0(W(1,22),W(1,2),W(1,37),GC_11,AMP(63))
...
C     Amplitude(s) for diagram number 65
      ...
      CALL FFV1_2(W(1,1),W(1,24),GC_11,ZERO,ZERO,W(1,22))
...
C     Amplitude(s) for diagram number 71
      CALL FFV1_0(W(1,7),W(1,25),W(1,34),GC_11,AMP(71))
C     Amplitude(s) for diagram number 72
      CALL FFV1_0(W(1,27),W(1,4),W(1,34),GC_11,AMP(72))
      CALL FFV1_2(W(1,1),W(1,16),GC_11,ZERO,ZERO,W(1,35))
...
C     Amplitude(s) for diagram number 76
      CALL FFV1_0(W(1,7),W(1,28),W(1,33),GC_11,AMP(76))
C     Amplitude(s) for diagram number 77
      CALL FFV1_0(W(1,27),W(1,2),W(1,33),GC_11,AMP(77))
...
C     Amplitude(s) for diagram number 85
      CALL FFV1_0(W(1,8),W(1,3),W(1,34),GC_11,AMP(85))
C     Amplitude(s) for diagram number 86
      CALL FFV1_0(W(1,6),W(1,30),W(1,34),GC_11,AMP(86))
C     Amplitude(s) for diagram number 87
      CALL FFV1_0(W(1,13),W(1,4),W(1,34),GC_11,AMP(87))
C     Amplitude(s) for diagram number 88
      CALL FFV1_0(W(1,6),W(1,32),W(1,34),GC_11,AMP(88))
C     Amplitude(s) for diagram number 89
      CALL FFV1_0(W(1,17),W(1,3),W(1,33),GC_11,AMP(89))
C     Amplitude(s) for diagram number 90
      CALL FFV1_0(W(1,6),W(1,29),W(1,33),GC_11,AMP(90))
C     Amplitude(s) for diagram number 91
      CALL FFV1_0(W(1,13),W(1,2),W(1,33),GC_11,AMP(91))
C     Amplitude(s) for diagram number 92
      CALL FFV1_0(W(1,6),W(1,20),W(1,33),GC_11,AMP(92))
C     Amplitude(s) for diagram number 93
      CALL FFV1_0(W(1,17),W(1,4),W(1,37),GC_11,AMP(93))
C     Amplitude(s) for diagram number 94
      CALL FFV1_0(W(1,6),W(1,26),W(1,37),GC_11,AMP(94))
C     Amplitude(s) for diagram number 95
      CALL FFV1_0(W(1,8),W(1,2),W(1,37),GC_11,AMP(95))
C     Amplitude(s) for diagram number 96
      CALL FFV1_0(W(1,6),W(1,31),W(1,37),GC_11,AMP(96))
     ...
     $ +IMAG1*AMP(7)-AMP(11)-1D0/3D0*AMP(15)-1D0/3D0*AMP(16)-AMP(18)
     $ -IMAG1*AMP(19)-1D0/3D0*AMP(21)-1D0/3D0*AMP(22)-1D0/9D0*AMP(23)
     $ -1D0/9D0*AMP(24)-1D0/9D0*AMP(25)-1D0/9D0*AMP(26)-1D0/3D0
     $ *AMP(28)-1D0/3D0*AMP(30)-1D0/9D0*AMP(31)-1D0/9D0*AMP(32)
     $ -1D0/3D0*AMP(33)-1D0/3D0*AMP(34)-AMP(38)-AMP(39)-1D0/3D0
     $ *AMP(41)-1D0/3D0*AMP(42)-1D0/3D0*AMP(43)-1D0/3D0*AMP(44)
     $ -AMP(49)+IMAG1*AMP(51)-AMP(52)-AMP(54)-AMP(57)-AMP(59)
     $ -IMAG1*AMP(60)-1D0/3D0*AMP(64)-1D0/3D0*AMP(66)-1D0/3D0*AMP(67)
     $ -1D0/3D0*AMP(68)-AMP(69)-1D0/3D0*AMP(71)-1D0/3D0*AMP(72)
     $ -1D0/3D0*AMP(73)-1D0/3D0*AMP(75)-1D0/9D0*AMP(76)-1D0/9D0
     $ *AMP(77)-1D0/9D0*AMP(78)-1D0/9D0*AMP(80)-1D0/9D0*AMP(81)
     $ -1D0/9D0*AMP(82)-1D0/3D0*AMP(83)-1D0/3D0*AMP(84)-AMP(87)
     ...
     $ *AMP(93)+1D0/9D0*AMP(94)+1D0/3D0*AMP(95)+1D0/3D0*AMP(96))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX64 = P0_MATRIX64+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
