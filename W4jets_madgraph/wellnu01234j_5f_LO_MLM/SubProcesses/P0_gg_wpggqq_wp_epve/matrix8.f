...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX8(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX8(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,16),W(1,6),W(1,14),GC_11,AMP(9))
      CALL FFV1_1(W(1,6),W(1,8),GC_11,ZERO,ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 14
      ...
      CALL FFV1_2(W(1,2),W(1,4),GC_11,ZERO,ZERO,W(1,19))
      CALL FFV2_2(W(1,19),W(1,5),GC_100,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,20),W(1,6),W(1,10),GC_11,AMP(15))
...
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,2),W(1,9),W(1,22),GC_11,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,16),W(1,6),W(1,22),GC_11,AMP(18))
...
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,22),W(1,6),W(1,10),GC_11,AMP(23))
...
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,2),W(1,24),W(1,28),GC_11,AMP(29))
...
C     Amplitude(s) for diagram number 36
      ...
      CALL FFV1_2(W(1,2),W(1,1),GC_11,ZERO,ZERO,W(1,24))
      CALL FFV2_2(W(1,24),W(1,5),GC_100,ZERO,ZERO,W(1,27))
C     Amplitude(s) for diagram number 37
      CALL FFV1_0(W(1,27),W(1,6),W(1,25),GC_11,AMP(37))
...
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,27),W(1,6),W(1,28),GC_11,AMP(41))
...
C     Amplitude(s) for diagram number 47
      CALL FFV1_0(W(1,27),W(1,6),W(1,29),GC_11,AMP(47))
...
C     Amplitude(s) for diagram number 56
      CALL FFV1_0(W(1,2),W(1,15),W(1,30),GC_11,AMP(56))
...
C     Amplitude(s) for diagram number 59
      CALL FFV1_0(W(1,22),W(1,6),W(1,30),GC_11,AMP(59))
...
C     Amplitude(s) for diagram number 65
      CALL FFV1_0(W(1,30),W(1,6),W(1,25),GC_11,AMP(65))
...
C     Amplitude(s) for diagram number 71
      CALL FFV1_0(W(1,2),W(1,18),W(1,7),GC_11,AMP(71))
...
C     Amplitude(s) for diagram number 77
      CALL FFV1_0(W(1,20),W(1,6),W(1,7),GC_11,AMP(77))
...
C     Amplitude(s) for diagram number 80
      CALL FFV1_0(W(1,2),W(1,23),W(1,28),GC_11,AMP(80))
...
C     Amplitude(s) for diagram number 83
      CALL FFV1_0(W(1,30),W(1,6),W(1,28),GC_11,AMP(83))
...
C     Amplitude(s) for diagram number 87
      CALL FFV1_0(W(1,2),W(1,15),W(1,7),GC_11,AMP(87))
...
C     Amplitude(s) for diagram number 98
      ...
      CALL FFV1_0(W(1,16),W(1,6),W(1,15),GC_11,AMP(101))
      CALL FFV1_0(W(1,16),W(1,6),W(1,8),GC_11,AMP(102))
     ...
     $ -AMP(90)+AMP(93)-AMP(91)-AMP(99)+AMP(102)-AMP(100))
      JAMP(5)=+1D0/2D0*(+AMP(13)+AMP(14)+AMP(17)+AMP(18)+AMP(20)
     ...
     $ +AMP(99)+AMP(100)+AMP(101))
      JAMP(6)=+1D0/2D0*(-1D0/3D0*AMP(13)-1D0/3D0*AMP(14)-1D0/3D0
     ...
     $ *AMP(65)-1D0/3D0*AMP(80)-1D0/3D0*AMP(83))
      JAMP(8)=+1D0/2D0*(+AMP(25)+AMP(26)+AMP(27)+AMP(28)+IMAG1*AMP(32)
     ...
     $ +IMAG1*AMP(8)-AMP(9)+IMAG1*AMP(12)+AMP(37)+AMP(38)+AMP(43)
     $ +IMAG1*AMP(44)+AMP(46)+IMAG1*AMP(47)+AMP(48)+AMP(61)+IMAG1
     ...
     $ +AMP(88)+AMP(89)-AMP(93)-AMP(92)+AMP(97)-AMP(102)-AMP(101))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX8 = P0_MATRIX8+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
