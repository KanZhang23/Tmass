...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX43(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX43(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 32
     ...
     $ +1D0/9D0*AMP(26)+1D0/9D0*AMP(31)+1D0/9D0*AMP(32))
      JAMP(3)=+1D0/4D0*(+AMP(1)+AMP(3)+IMAG1*AMP(4)+1D0/3D0*AMP(14)
     ...
     $ *AMP(28)+1D0/3D0*AMP(29)+1D0/3D0*AMP(30)+AMP(31))
      JAMP(4)=+1D0/4D0*(-1D0/3D0*AMP(3)-1D0/3D0*AMP(5)-AMP(6)
     ...
     $ *AMP(30)+AMP(32))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX43 = P0_MATRIX43+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
