...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX29(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX29(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 14
      ...
      CALL FFV2_1(W(1,6),W(1,5),GC_100,ZERO,ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 20
      ...
      CALL FFV1_1(W(1,6),W(1,9),GC_11,ZERO,ZERO,W(1,22))
...
C     Amplitude(s) for diagram number 26
      ...
      CALL FFV1_1(W(1,6),W(1,17),GC_11,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 27
      CALL FFV2_0(W(1,16),W(1,10),W(1,5),GC_100,AMP(27))
      CALL FFV1_1(W(1,6),W(1,14),GC_11,ZERO,ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 32
     ...
     $ -1D0/3D0*AMP(32))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX29 = P0_MATRIX29+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
