      DOUBLE PRECISION FUNCTION P0_DSIG59(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! u d~ > e+ ve u d u~ d~
      PD(IPROC)=U1*DX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! c s~ > e+ ve c s c~ s~
      PD(IPROC)=C1*SX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP0_MATRIX59(PP,DSIGUU)
      IF (DSIGUU.LT.1D199) THEN
        P0_DSIG59=PD(0)*CONV*DSIGUU
      ELSE
