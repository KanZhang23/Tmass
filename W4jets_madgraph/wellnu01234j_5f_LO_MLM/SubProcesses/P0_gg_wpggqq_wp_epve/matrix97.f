...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX97(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX97(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,16),W(1,2),W(1,18),GC_11,AMP(8))
...
C     Amplitude(s) for diagram number 35
      CALL FFV1_0(W(1,8),W(1,4),W(1,20),GC_11,AMP(35))
      CALL FFV1_1(W(1,4),W(1,15),GC_11,ZERO,ZERO,W(1,30))
C     Amplitude(s) for diagram number 36
      CALL FFV1_0(W(1,6),W(1,30),W(1,20),GC_11,AMP(36))
C     Amplitude(s) for diagram number 37
      CALL FFV1_0(W(1,8),W(1,1),W(1,13),GC_11,AMP(37))
      CALL FFV1_1(W(1,1),W(1,15),GC_11,ZERO,ZERO,W(1,31))
...
C     Amplitude(s) for diagram number 39
      CALL FFV1_0(W(1,13),W(1,2),W(1,20),GC_11,AMP(39))
      CALL FFV1_1(W(1,2),W(1,18),GC_11,ZERO,ZERO,W(1,32))
...
C     Amplitude(s) for diagram number 41
      ...
      CALL FFV1_1(W(1,1),W(1,18),GC_11,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 42
      ...
      CALL FFV1P0_3(W(1,3),W(1,10),GC_11,ZERO,ZERO,W(1,33))
C     Amplitude(s) for diagram number 43
      CALL FFV1_0(W(1,7),W(1,11),W(1,33),GC_11,AMP(43))
C     Amplitude(s) for diagram number 44
      CALL FFV1_0(W(1,12),W(1,4),W(1,33),GC_11,AMP(44))
      CALL FFV1_2(W(1,3),W(1,9),GC_11,ZERO,ZERO,W(1,34))
...
C     Amplitude(s) for diagram number 51
      ...
      CALL FFV1_2(W(1,3),W(1,15),GC_11,ZERO,ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 56
      ...
      CALL FFV2_1(W(1,1),W(1,5),GC_100,ZERO,ZERO,W(1,14))
      CALL FFV1P0_3(W(1,3),W(1,14),GC_11,ZERO,ZERO,W(1,34))
C     Amplitude(s) for diagram number 57
      CALL FFV1_0(W(1,7),W(1,21),W(1,34),GC_11,AMP(57))
C     Amplitude(s) for diagram number 58
      CALL FFV1_0(W(1,22),W(1,4),W(1,34),GC_11,AMP(58))
      CALL FFV1_2(W(1,3),W(1,19),GC_11,ZERO,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 63
      CALL FFV1_0(W(1,22),W(1,1),W(1,37),GC_11,AMP(63))
...
C     Amplitude(s) for diagram number 65
      ...
      CALL FFV1_2(W(1,3),W(1,24),GC_11,ZERO,ZERO,W(1,22))
...
C     Amplitude(s) for diagram number 72
      CALL FFV1_0(W(1,27),W(1,2),W(1,34),GC_11,AMP(72))
      CALL FFV1_2(W(1,3),W(1,16),GC_11,ZERO,ZERO,W(1,35))
...
C     Amplitude(s) for diagram number 77
      CALL FFV1_0(W(1,27),W(1,1),W(1,33),GC_11,AMP(77))
...
C     Amplitude(s) for diagram number 96
     ...
     $ *AMP(93)-1D0/9D0*AMP(94)-1D0/3D0*AMP(95)-1D0/3D0*AMP(96))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX97 = P0_MATRIX97+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
