      DOUBLE PRECISION FUNCTION P0_DSIG37(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! u s > e+ ve u s s c~
      PD(IPROC)=U1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! c d > e+ ve c d d u~
      PD(IPROC)=C1*D2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! d s > e+ ve d s s c~
      PD(IPROC)=D1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP0_MATRIX37(PP,DSIGUU)
      IF (DSIGUU.LT.1D199) THEN
        P0_DSIG37=PD(0)*CONV*DSIGUU
      ELSE
