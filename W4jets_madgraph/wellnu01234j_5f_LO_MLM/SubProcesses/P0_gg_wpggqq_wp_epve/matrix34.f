...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX34(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX34(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,2),W(1,10),W(1,16),GC_11,AMP(6))
...
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,7),W(1,3),W(1,13),GC_11,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,7),W(1,9),W(1,14),GC_11,AMP(10))
      CALL FFV1_1(W(1,6),W(1,13),GC_11,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 11
      CALL FFV2_0(W(1,12),W(1,9),W(1,5),GC_100,AMP(11))
      CALL FFV1_2(W(1,7),W(1,13),GC_11,ZERO,ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 16
     ...
     $ -1D0/3D0*AMP(14)-1D0/3D0*AMP(15)-1D0/3D0*AMP(16))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX34 = P0_MATRIX34+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
