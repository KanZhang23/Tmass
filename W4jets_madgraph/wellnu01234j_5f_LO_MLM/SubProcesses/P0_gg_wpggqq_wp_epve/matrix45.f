...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX45(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX45(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 16
     ...
     $ +1D0/9D0*AMP(14)+1D0/9D0*AMP(15)+1D0/9D0*AMP(16))
      JAMP(3)=+1D0/4D0*(+AMP(1)+AMP(3)+IMAG1*AMP(4)+AMP(6)+AMP(8)
     $ +IMAG1*AMP(10)+AMP(11)+AMP(13)+AMP(15))
      JAMP(4)=+1D0/4D0*(-1D0/3D0*AMP(3)-1D0/3D0*AMP(5)-1D0/3D0*AMP(8)
     ...
     $ -IMAG1*AMP(10)+AMP(12)+AMP(14)+AMP(16))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX45 = P0_MATRIX45+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
