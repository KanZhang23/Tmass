...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX21(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX21(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV1P0_3(W(1,7),W(1,3),GC_11,ZERO,ZERO,W(1,15))
...
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,16),W(1,3),W(1,17),GC_11,AMP(8))
...
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,2),W(1,29),W(1,17),GC_11,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,2),W(1,19),W(1,25),GC_11,AMP(29))
      CALL FFV2_1(W(1,6),W(1,5),GC_100,ZERO,ZERO,W(1,25))
      CALL FFV1P0_3(W(1,2),W(1,25),GC_11,ZERO,ZERO,W(1,29))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,7),W(1,20),W(1,29),GC_11,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,24),W(1,3),W(1,29),GC_11,AMP(31))
...
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,2),W(1,24),W(1,15),GC_11,AMP(33))
C     Amplitude(s) for diagram number 34
      CALL FFV1_0(W(1,2),W(1,25),W(1,26),GC_11,AMP(34))
      CALL FFV1_1(W(1,6),W(1,15),GC_11,ZERO,ZERO,W(1,26))
...
C     Amplitude(s) for diagram number 36
      ...
      CALL FFV1_1(W(1,3),W(1,17),GC_11,ZERO,ZERO,W(1,22))
...
C     Amplitude(s) for diagram number 44
      CALL FFV1_0(W(1,12),W(1,6),W(1,23),GC_11,AMP(44))
      CALL FFV1_2(W(1,1),W(1,9),GC_11,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 45
      CALL FFV1_0(W(1,6),W(1,19),W(1,17),GC_11,AMP(45))
...
C     Amplitude(s) for diagram number 49
      CALL FFV1_0(W(1,12),W(1,3),W(1,19),GC_11,AMP(49))
C     Amplitude(s) for diagram number 50
      CALL FFV1_0(W(1,6),W(1,25),W(1,15),GC_11,AMP(50))
...
C     Amplitude(s) for diagram number 58
      CALL FFV1_0(W(1,2),W(1,18),W(1,23),GC_11,AMP(58))
...
C     Amplitude(s) for diagram number 62
      CALL FFV1_0(W(1,2),W(1,8),W(1,19),GC_11,AMP(62))
...
C     Amplitude(s) for diagram number 64
     ...
     $ -1D0/3D0*AMP(62)-AMP(64))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX21 = P0_MATRIX21+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
