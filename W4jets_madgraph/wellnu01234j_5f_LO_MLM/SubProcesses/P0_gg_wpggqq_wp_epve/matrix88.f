...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX88(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX88(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,12),W(1,2),W(1,16),GC_11,AMP(7))
      CALL FFV1_2(W(1,6),W(1,8),GC_11,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,12),W(1,9),W(1,13),GC_11,AMP(8))
      CALL FFV1_1(W(1,9),W(1,8),GC_11,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,6),W(1,2),W(1,13),GC_11,AMP(9))
...
C     Amplitude(s) for diagram number 16
     ...
     $ +IMAG1*AMP(10)-AMP(12)-AMP(14)-AMP(16))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX88 = P0_MATRIX88+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
