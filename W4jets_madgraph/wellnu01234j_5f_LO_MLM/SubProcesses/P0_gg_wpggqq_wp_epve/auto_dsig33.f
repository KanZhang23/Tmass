      DOUBLE PRECISION FUNCTION P0_DSIG33(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! u d > e+ ve u d d u~
      PD(IPROC)=U1*D2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! c s > e+ ve c s s c~
      PD(IPROC)=C1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP0_MATRIX33(PP,DSIGUU)
      IF (DSIGUU.LT.1D199) THEN
        P0_DSIG33=PD(0)*CONV*DSIGUU
      ELSE
