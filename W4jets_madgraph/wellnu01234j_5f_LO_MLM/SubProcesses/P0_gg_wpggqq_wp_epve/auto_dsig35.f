      DOUBLE PRECISION FUNCTION P0_DSIG35(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! u d > e+ ve c d d c~
      PD(IPROC)=U1*D2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! u d > e+ ve s d d s~
      PD(IPROC)=U1*D2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! u d > e+ ve b d d b~
      PD(IPROC)=U1*D2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! c s > e+ ve u s s u~
      PD(IPROC)=C1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! c s > e+ ve d s s d~
      PD(IPROC)=C1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! c s > e+ ve b s s b~
      PD(IPROC)=C1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP0_MATRIX35(PP,DSIGUU)
      IF (DSIGUU.LT.1D199) THEN
        P0_DSIG35=PD(0)*CONV*DSIGUU
      ELSE
