      DOUBLE PRECISION FUNCTION P0_DSIG27(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! u c > e+ ve u d s d~
      PD(IPROC)=U1*C2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! u c > e+ ve u b s b~
      PD(IPROC)=U1*C2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP0_MATRIX27(PP,DSIGUU)
      IF (DSIGUU.LT.1D199) THEN
        P0_DSIG27=PD(0)*CONV*DSIGUU
      ELSE
