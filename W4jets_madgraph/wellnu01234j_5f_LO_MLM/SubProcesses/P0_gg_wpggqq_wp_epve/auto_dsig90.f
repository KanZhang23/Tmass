      DOUBLE PRECISION FUNCTION P0_DSIG90(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      IPROC=IPROC+1  ! c~ d~ > e+ ve c c~ u~ c~
      PD(IPROC)=CX1*DX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! d~ s~ > e+ ve d d~ c~ d~
      PD(IPROC)=DX1*SX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP0_MATRIX90(PP,DSIGUU)
      IF (DSIGUU.LT.1D199) THEN
        P0_DSIG90=PD(0)*CONV*DSIGUU
      ELSE
