...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX65(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX65(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV1P0_3(W(1,8),W(1,2),GC_11,ZERO,ZERO,W(1,16))
      CALL FFV1_1(W(1,3),W(1,15),GC_11,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,7),W(1,17),W(1,16),GC_11,AMP(6))
      CALL FFV1_2(W(1,7),W(1,15),GC_11,ZERO,ZERO,W(1,18))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,18),W(1,3),W(1,16),GC_11,AMP(7))
      CALL FFV1_2(W(1,8),W(1,15),GC_11,ZERO,ZERO,W(1,19))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,19),W(1,2),W(1,13),GC_11,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL VVV1_0(W(1,15),W(1,13),W(1,16),GC_10,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,14),W(1,2),W(1,15),GC_11,AMP(10))
...
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,14),W(1,2),W(1,10),GC_11,AMP(13))
      CALL FFV1_1(W(1,2),W(1,13),GC_11,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,6),W(1,16),W(1,10),GC_11,AMP(14))
      CALL FFV2_1(W(1,4),W(1,5),GC_100,ZERO,ZERO,W(1,10))
      CALL FFV1P0_3(W(1,1),W(1,10),GC_11,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,7),W(1,11),W(1,8),GC_11,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,12),W(1,3),W(1,8),GC_11,AMP(16))
...
C     Amplitude(s) for diagram number 21
      ...
      CALL FFV1P0_3(W(1,1),W(1,12),GC_11,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,7),W(1,17),W(1,9),GC_11,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,18),W(1,3),W(1,9),GC_11,AMP(23))
      CALL FFV1_2(W(1,1),W(1,15),GC_11,ZERO,ZERO,W(1,18))
...
C     Amplitude(s) for diagram number 27
      ...
      CALL FFV1_1(W(1,2),W(1,15),GC_11,ZERO,ZERO,W(1,18))
...
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,14),W(1,2),W(1,8),GC_11,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,6),W(1,16),W(1,8),GC_11,AMP(32))
      JAMP(1)=+1D0/4D0*(-1D0/3D0*AMP(3)-1D0/3D0*AMP(5)-1D0/9D0*AMP(6)
     ...
     $ -AMP(28)-AMP(30))
      JAMP(5)=+1D0/4D0*(-1D0/3D0*AMP(1)-1D0/3D0*AMP(2)-AMP(6)-AMP(8)
     ...
     $ -AMP(29)-1D0/3D0*AMP(31)-1D0/3D0*AMP(32))
      JAMP(6)=+1D0/4D0*(+AMP(2)-IMAG1*AMP(4)+AMP(5)+1D0/3D0*AMP(6)
     ...
     $ *AMP(27)+1D0/3D0*AMP(28)+AMP(32))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX65 = P0_MATRIX65+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
