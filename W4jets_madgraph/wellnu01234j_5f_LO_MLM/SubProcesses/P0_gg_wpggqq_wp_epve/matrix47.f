...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX47(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX47(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFV1_2(W(1,1),W(1,13),GC_11,ZERO,ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 16
      ...
      CALL FFV1_2(W(1,7),W(1,3),GC_11,ZERO,ZERO,W(1,21))
      CALL FFV1P0_3(W(1,21),W(1,15),GC_11,ZERO,ZERO,W(1,22))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,1),W(1,9),W(1,22),GC_11,AMP(17))
...
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,1),W(1,15),W(1,10),GC_11,AMP(20))
...
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,1),W(1,24),W(1,25),GC_11,AMP(25))
...
C     Amplitude(s) for diagram number 28
      ...
      CALL FFV1P0_3(W(1,21),W(1,2),GC_11,ZERO,ZERO,W(1,28))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,1),W(1,24),W(1,28),GC_11,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,21),W(1,2),W(1,26),GC_11,AMP(30))
...
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,16),W(1,27),W(1,3),GC_11,AMP(33))
...
C     Amplitude(s) for diagram number 35
      CALL FFV1_0(W(1,1),W(1,24),W(1,29),GC_11,AMP(35))
...
C     Amplitude(s) for diagram number 42
      CALL FFV1_0(W(1,21),W(1,2),W(1,26),GC_11,AMP(42))
      CALL FFV1_2(W(1,24),W(1,3),GC_11,ZERO,ZERO,W(1,30))
C     Amplitude(s) for diagram number 43
      CALL FFV1_0(W(1,30),W(1,9),W(1,13),GC_11,AMP(43))
C     Amplitude(s) for diagram number 44
      CALL VVV1_0(W(1,3),W(1,13),W(1,26),GC_10,AMP(44))
C     Amplitude(s) for diagram number 45
      CALL FFV1_0(W(1,10),W(1,9),W(1,3),GC_11,AMP(45))
...
C     Amplitude(s) for diagram number 48
      CALL FFV1_0(W(1,27),W(1,14),W(1,3),GC_11,AMP(48))
...
C     Amplitude(s) for diagram number 49
      CALL FFV1_0(W(1,1),W(1,9),W(1,30),GC_11,AMP(49))
...
C     Amplitude(s) for diagram number 51
      CALL FFV1_0(W(1,1),W(1,18),W(1,30),GC_11,AMP(51))
...
C     Amplitude(s) for diagram number 60
      ...
      CALL FFV1_1(W(1,23),W(1,4),GC_11,ZERO,ZERO,W(1,30))
...
C     Amplitude(s) for diagram number 62
      CALL FFV1_0(W(1,1),W(1,23),W(1,25),GC_11,AMP(62))
...
C     Amplitude(s) for diagram number 68
      ...
      CALL VVV1P0_1(W(1,4),W(1,13),GC_10,ZERO,ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 71
      CALL FFV1_0(W(1,1),W(1,18),W(1,7),GC_11,AMP(71))
...
C     Amplitude(s) for diagram number 78
      CALL FFV1_0(W(1,20),W(1,14),W(1,4),GC_11,AMP(78))
      CALL FFV1_2(W(1,21),W(1,4),GC_11,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 79
      CALL FFV1_0(W(1,20),W(1,2),W(1,11),GC_11,AMP(79))
C     Amplitude(s) for diagram number 80
      CALL FFV1_0(W(1,1),W(1,23),W(1,28),GC_11,AMP(80))
C     Amplitude(s) for diagram number 81
      CALL VVV1_0(W(1,4),W(1,28),W(1,11),GC_10,AMP(81))
C     Amplitude(s) for diagram number 82
      CALL FFV1_0(W(1,20),W(1,2),W(1,17),GC_11,AMP(82))
C     Amplitude(s) for diagram number 83
      CALL FFV1_0(W(1,30),W(1,6),W(1,28),GC_11,AMP(83))
C     Amplitude(s) for diagram number 84
      CALL VVV1_0(W(1,4),W(1,28),W(1,17),GC_10,AMP(84))
C     Amplitude(s) for diagram number 85
      CALL FFV1_0(W(1,1),W(1,23),W(1,29),GC_11,AMP(85))
C     Amplitude(s) for diagram number 86
      CALL FFV1_0(W(1,8),W(1,23),W(1,3),GC_11,AMP(86))
C     Amplitude(s) for diagram number 87
      CALL FFV1_0(W(1,1),W(1,15),W(1,7),GC_11,AMP(87))
C     Amplitude(s) for diagram number 88
      CALL VVV1_0(W(1,7),W(1,3),W(1,11),GC_10,AMP(88))
...
C     Amplitude(s) for diagram number 98
     ...
     $ +AMP(9)+IMAG1*AMP(10)+IMAG1*AMP(11)+AMP(51)+AMP(52)+AMP(55)
     $ +AMP(56)+IMAG1*AMP(57)+AMP(58)+IMAG1*AMP(60)+AMP(67)-IMAG1
     $ *AMP(69)+AMP(70)-IMAG1*AMP(71)+AMP(72)-IMAG1*AMP(87)+AMP(88)
     ...
     $ *AMP(79)-1D0/3D0*AMP(82))
      JAMP(9)=+1D0/2D0*(-1D0/3D0*AMP(25)-1D0/3D0*AMP(26)-1D0/3D0
     ...
     $ *AMP(65)-1D0/3D0*AMP(80)-1D0/3D0*AMP(83))
      JAMP(10)=+1D0/2D0*(+AMP(25)+AMP(26)+AMP(27)+AMP(28)+IMAG1
     $ *AMP(32)+AMP(33)+IMAG1*AMP(35)+AMP(49)+AMP(50)+AMP(53)
     $ +AMP(54)-IMAG1*AMP(57)+AMP(59)-IMAG1*AMP(60)+AMP(62)-IMAG1
     $ *AMP(63)-IMAG1*AMP(66)+AMP(74)-IMAG1*AMP(75)-IMAG1*AMP(77)
     $ +IMAG1*AMP(85)-AMP(88)+AMP(90)+AMP(91)+AMP(92)-IMAG1*AMP(96)
     ...
     $ *AMP(61)-1D0/3D0*AMP(64))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX47 = P0_MATRIX47+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
