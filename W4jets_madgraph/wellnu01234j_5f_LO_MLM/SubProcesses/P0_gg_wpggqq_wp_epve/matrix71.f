...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX71(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX71(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,1),W(1,16),W(1,14),GC_11,AMP(20))
...
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,6),W(1,15),W(1,11),GC_11,AMP(26))
...
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,6),W(1,15),W(1,20),GC_11,AMP(32))
     ...
     $ *AMP(30)-AMP(32))
      JAMP(5)=+1D0/4D0*(-AMP(1)-AMP(3)-IMAG1*AMP(4)-1D0/3D0*AMP(14)
     ...
     $ +1D0/9D0*AMP(28)+1D0/9D0*AMP(29)+1D0/9D0*AMP(30))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX71 = P0_MATRIX71+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
