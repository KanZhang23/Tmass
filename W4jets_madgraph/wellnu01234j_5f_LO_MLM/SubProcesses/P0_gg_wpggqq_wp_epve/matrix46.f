...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX46(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX46(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV1P0_3(W(1,9),W(1,4),GC_11,ZERO,ZERO,W(1,13))
...
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,9),W(1,3),W(1,17),GC_11,AMP(6))
...
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,9),W(1,4),W(1,16),GC_11,AMP(10))
...
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,14),W(1,3),W(1,19),GC_11,AMP(12))
...
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,14),W(1,4),W(1,16),GC_11,AMP(17))
...
C     Amplitude(s) for diagram number 20
      ...
      CALL FFV1_1(W(1,3),W(1,15),GC_11,ZERO,ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 22
      ...
      CALL FFV1_1(W(1,4),W(1,18),GC_11,ZERO,ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 24
      ...
      CALL FFV1_2(W(1,1),W(1,15),GC_11,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,9),W(1,2),W(1,11),GC_11,AMP(25))
      CALL FFV1_1(W(1,2),W(1,15),GC_11,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,1),W(1,10),W(1,11),GC_11,AMP(26))
      CALL FFV1_2(W(1,1),W(1,18),GC_11,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,11),W(1,2),W(1,13),GC_11,AMP(27))
      CALL FFV1_1(W(1,2),W(1,18),GC_11,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,1),W(1,15),W(1,13),GC_11,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,11),W(1,2),W(1,19),GC_11,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,1),W(1,15),W(1,19),GC_11,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,9),W(1,2),W(1,16),GC_11,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,1),W(1,10),W(1,16),GC_11,AMP(32))
     ...
     $ *AMP(31)-1D0/3D0*AMP(32))
      JAMP(5)=+1D0/4D0*(-1D0/3D0*AMP(1)-AMP(3)-1D0/3D0*AMP(4)-AMP(9)
     $ +IMAG1*AMP(10)-AMP(12)-AMP(14)+IMAG1*AMP(15)-1D0/3D0*AMP(16)
     $ -1D0/3D0*AMP(17)-AMP(24)-1D0/3D0*AMP(25)-1D0/3D0*AMP(26)
     ...
     $ +1D0/3D0*AMP(28)+1D0/3D0*AMP(29)+1D0/3D0*AMP(30)+AMP(32))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX46 = P0_MATRIX46+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
