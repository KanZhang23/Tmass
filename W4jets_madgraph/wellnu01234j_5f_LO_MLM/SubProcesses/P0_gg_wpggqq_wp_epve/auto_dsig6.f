      DOUBLE PRECISION FUNCTION P0_DSIG6(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! g u > e+ ve g u d u~
      PD(IPROC)=G1*U2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g c > e+ ve g c s c~
      PD(IPROC)=G1*C2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP0_MATRIX6(PP,DSIGUU)
      IF (DSIGUU.LT.1D199) THEN
        P0_DSIG6=PD(0)*CONV*DSIGUU
      ELSE
