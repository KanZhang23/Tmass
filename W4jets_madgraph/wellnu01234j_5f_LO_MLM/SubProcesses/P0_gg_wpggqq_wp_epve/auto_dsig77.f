      DOUBLE PRECISION FUNCTION P0_DSIG77(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! d d~ > e+ ve u d u~ u~
      PD(IPROC)=D1*DX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! s s~ > e+ ve c s c~ c~
      PD(IPROC)=S1*SX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP0_MATRIX77(PP,DSIGUU)
      IF (DSIGUU.LT.1D199) THEN
        P0_DSIG77=PD(0)*CONV*DSIGUU
      ELSE
