...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX26(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX26(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,9),W(1,6),GC_11,ZERO,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,9),W(1,6),W(1,14),GC_11,AMP(4))
      CALL FFV1_1(W(1,6),W(1,8),GC_11,ZERO,ZERO,W(1,15))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1_1(W(1,6),W(1,9),GC_11,ZERO,ZERO,W(1,16))
...
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,2),W(1,18),W(1,13),GC_11,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,2),W(1,16),W(1,14),GC_11,AMP(20))
      CALL FFV1P0_3(W(1,19),W(1,6),GC_11,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,17),W(1,3),W(1,16),GC_11,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,2),W(1,10),W(1,16),GC_11,AMP(22))
      CALL FFV1_1(W(1,6),W(1,13),GC_11,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 23
      CALL FFV2_0(W(1,17),W(1,10),W(1,5),GC_100,AMP(23))
      CALL FFV1_2(W(1,2),W(1,13),GC_11,ZERO,ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 32
     ...
     $ *AMP(30)-AMP(32))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX26 = P0_MATRIX26+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
