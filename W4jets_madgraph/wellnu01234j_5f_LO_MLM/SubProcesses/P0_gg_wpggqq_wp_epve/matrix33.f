...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX33(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX33(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,2),W(1,20),W(1,21),GC_11,AMP(15))
      CALL FFV1_1(W(1,6),W(1,10),GC_11,ZERO,ZERO,W(1,22))
      CALL FFV1P0_3(W(1,19),W(1,3),GC_11,ZERO,ZERO,W(1,23))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,2),W(1,22),W(1,23),GC_11,AMP(16))
      CALL FFV1_2(W(1,2),W(1,10),GC_11,ZERO,ZERO,W(1,24))
...
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,2),W(1,22),W(1,27),GC_11,AMP(25))
...
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,2),W(1,20),W(1,29),GC_11,AMP(30))
...
C     Amplitude(s) for diagram number 43
      CALL FFV1_0(W(1,2),W(1,11),W(1,23),GC_11,AMP(43))
...
C     Amplitude(s) for diagram number 48
      CALL FFV1_0(W(1,2),W(1,14),W(1,19),GC_11,AMP(48))
...
C     Amplitude(s) for diagram number 64
     ...
     $ +1D0/9D0*AMP(64))
      JAMP(2)=+1D0/4D0*(-AMP(3)-AMP(5)-IMAG1*AMP(7)-1D0/3D0*AMP(8)
     ...
     $ *AMP(60)-AMP(61))
      JAMP(3)=+1D0/4D0*(-1D0/3D0*AMP(1)-1D0/3D0*AMP(2)-AMP(4)-AMP(6)
     ...
     $ +1D0/3D0*AMP(62)+AMP(64))
      JAMP(5)=+1D0/4D0*(+1D0/9D0*AMP(1)+1D0/9D0*AMP(2)+1D0/3D0*AMP(3)
     ...
     $ *AMP(64))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX33 = P0_MATRIX33+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
