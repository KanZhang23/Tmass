      DOUBLE PRECISION FUNCTION P0_DSIG34(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! u d > e+ ve u d s c~
      PD(IPROC)=U1*D2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! c s > e+ ve c s d u~
      PD(IPROC)=C1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP0_MATRIX34(PP,DSIGUU)
      IF (DSIGUU.LT.1D199) THEN
        P0_DSIG34=PD(0)*CONV*DSIGUU
      ELSE
