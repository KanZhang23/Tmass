      DOUBLE PRECISION FUNCTION P0_DSIG7(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! g u > e+ ve g u s c~
      PD(IPROC)=G1*U2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g c > e+ ve g c d u~
      PD(IPROC)=G1*C2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g d > e+ ve g d s c~
      PD(IPROC)=G1*D2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g s > e+ ve g s d u~
      PD(IPROC)=G1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP0_MATRIX7(PP,DSIGUU)
      IF (DSIGUU.LT.1D199) THEN
        P0_DSIG7=PD(0)*CONV*DSIGUU
      ELSE
