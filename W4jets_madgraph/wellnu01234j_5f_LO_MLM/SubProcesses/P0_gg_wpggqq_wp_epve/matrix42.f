...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX42(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX42(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1_1(W(1,2),W(1,13),GC_11,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV1P0_3(W(1,15),W(1,3),GC_11,ZERO,ZERO,W(1,17))
...
C     Amplitude(s) for diagram number 17
      ...
      CALL FFV1_1(W(1,3),W(1,13),GC_11,ZERO,ZERO,W(1,19))
...
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,20),W(1,2),W(1,17),GC_11,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,1),W(1,8),W(1,17),GC_11,AMP(21))
      CALL FFV1P0_3(W(1,1),W(1,15),GC_11,ZERO,ZERO,W(1,17))
...
C     Amplitude(s) for diagram number 32
     ...
     $ +1D0/3D0*AMP(29)+1D0/3D0*AMP(30)+AMP(32))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX42 = P0_MATRIX42+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
