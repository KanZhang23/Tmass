...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX61(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX61(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 14
      ...
      CALL FFV1P0_3(W(1,1),W(1,10),GC_11,ZERO,ZERO,W(1,21))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,7),W(1,11),W(1,21),GC_11,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,12),W(1,3),W(1,21),GC_11,AMP(16))
      CALL FFV1_2(W(1,1),W(1,9),GC_11,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,12),W(1,10),W(1,13),GC_11,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL VVV1_0(W(1,9),W(1,13),W(1,21),GC_10,AMP(18))
      CALL FFV1_2(W(1,1),W(1,13),GC_11,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,11),W(1,10),W(1,9),GC_11,AMP(19))
      CALL FFV1_1(W(1,2),W(1,13),GC_11,ZERO,ZERO,W(1,22))
C     Amplitude(s) for diagram number 20
      CALL FFV2_0(W(1,12),W(1,22),W(1,5),GC_100,AMP(20))
      CALL FFV1_1(W(1,2),W(1,9),GC_11,ZERO,ZERO,W(1,22))
C     Amplitude(s) for diagram number 21
      CALL FFV2_0(W(1,11),W(1,22),W(1,5),GC_100,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,7),W(1,15),W(1,21),GC_11,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,16),W(1,4),W(1,21),GC_11,AMP(23))
      CALL FFV1_2(W(1,1),W(1,14),GC_11,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,16),W(1,10),W(1,17),GC_11,AMP(24))
C     Amplitude(s) for diagram number 25
      CALL VVV1_0(W(1,14),W(1,17),W(1,21),GC_10,AMP(25))
      CALL FFV1_2(W(1,1),W(1,17),GC_11,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,15),W(1,10),W(1,14),GC_11,AMP(26))
      CALL FFV1_1(W(1,2),W(1,17),GC_11,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 27
      CALL FFV2_0(W(1,16),W(1,10),W(1,5),GC_100,AMP(27))
      CALL FFV1_1(W(1,2),W(1,14),GC_11,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 28
      CALL FFV2_0(W(1,15),W(1,10),W(1,5),GC_100,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,18),W(1,3),W(1,21),GC_11,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,6),W(1,8),W(1,21),GC_11,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,19),W(1,4),W(1,21),GC_11,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,6),W(1,20),W(1,21),GC_11,AMP(32))
      JAMP(1)=+1D0/4D0*(-1D0/9D0*AMP(1)-1D0/9D0*AMP(2)-1D0/9D0*AMP(3)
     $ -1D0/9D0*AMP(4)-1D0/3D0*AMP(6)-1D0/3D0*AMP(7)-1D0/3D0*AMP(11)
     $ -1D0/3D0*AMP(12)-1D0/9D0*AMP(13)-1D0/9D0*AMP(14)-1D0/9D0
     $ *AMP(15)-1D0/9D0*AMP(16)-1D0/9D0*AMP(17)-1D0/9D0*AMP(19)
     $ -1D0/9D0*AMP(20)-1D0/9D0*AMP(21)-1D0/3D0*AMP(22)-1D0/3D0
     $ *AMP(23)-1D0/3D0*AMP(29)-1D0/3D0*AMP(30)-1D0/9D0*AMP(31)
     $ -1D0/9D0*AMP(32))
      JAMP(2)=+1D0/4D0*(+1D0/3D0*AMP(1)+1D0/3D0*AMP(2)+1D0/9D0*AMP(6)
     $ +1D0/9D0*AMP(7)+1D0/9D0*AMP(8)+1D0/9D0*AMP(9)+1D0/9D0*AMP(11)
     $ +1D0/9D0*AMP(12)+1D0/3D0*AMP(13)+1D0/3D0*AMP(14)+1D0/3D0
     $ *AMP(15)+1D0/3D0*AMP(16)+1D0/9D0*AMP(22)+1D0/9D0*AMP(23)
     $ +1D0/9D0*AMP(24)+1D0/9D0*AMP(26)+1D0/9D0*AMP(27)+1D0/9D0
     $ *AMP(28)+1D0/9D0*AMP(29)+1D0/9D0*AMP(30)+1D0/3D0*AMP(31)
     $ +1D0/3D0*AMP(32))
      JAMP(3)=+1D0/4D0*(+1D0/3D0*AMP(3)+1D0/3D0*AMP(4)+AMP(7)
     $ +AMP(9)-IMAG1*AMP(10)+AMP(12)+1D0/3D0*AMP(13)+1D0/3D0*AMP(14)
     $ +1D0/3D0*AMP(17)+1D0/3D0*AMP(19)+1D0/3D0*AMP(20)+1D0/3D0
     $ *AMP(21)+AMP(23)-IMAG1*AMP(25)+AMP(26)+AMP(28)+AMP(30)
     $ +1D0/3D0*AMP(31)+1D0/3D0*AMP(32))
      JAMP(4)=+1D0/4D0*(-AMP(2)-AMP(4)+IMAG1*AMP(5)-1D0/3D0*AMP(8)
     $ -1D0/3D0*AMP(9)-1D0/3D0*AMP(11)-1D0/3D0*AMP(12)-AMP(14)-AMP(16)
     $ +IMAG1*AMP(18)-AMP(19)-AMP(21)-1D0/3D0*AMP(24)-1D0/3D0*AMP(26)
     $ -1D0/3D0*AMP(27)-1D0/3D0*AMP(28)-1D0/3D0*AMP(29)-1D0/3D0
     $ *AMP(30)-AMP(32))
      JAMP(5)=+1D0/4D0*(-AMP(1)-AMP(3)-IMAG1*AMP(5)-1D0/3D0*AMP(6)
     $ -1D0/3D0*AMP(7)-1D0/3D0*AMP(8)-1D0/3D0*AMP(9)-AMP(13)-AMP(15)
     $ -AMP(17)-IMAG1*AMP(18)-AMP(20)-1D0/3D0*AMP(22)-1D0/3D0*AMP(23)
     $ -1D0/3D0*AMP(24)-1D0/3D0*AMP(26)-1D0/3D0*AMP(27)-1D0/3D0
     $ *AMP(28)-AMP(31))
      JAMP(6)=+1D0/4D0*(+1D0/3D0*AMP(1)+1D0/3D0*AMP(2)+1D0/3D0*AMP(3)
     $ +1D0/3D0*AMP(4)+AMP(6)+AMP(8)+IMAG1*AMP(10)+AMP(11)+1D0/3D0
     $ *AMP(15)+1D0/3D0*AMP(16)+1D0/3D0*AMP(17)+1D0/3D0*AMP(19)
     $ +1D0/3D0*AMP(20)+1D0/3D0*AMP(21)+AMP(22)+AMP(24)+IMAG1*AMP(25)
     $ +AMP(27)+AMP(29))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX61 = P0_MATRIX61+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
