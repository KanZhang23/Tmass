...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P0_MATRIX99(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P0_MATRIX99(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1_1(W(1,4),W(1,13),GC_11,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV1P0_3(W(1,15),W(1,1),GC_11,ZERO,ZERO,W(1,17))
...
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,19),W(1,1),W(1,13),GC_11,AMP(10))
      CALL FFV1_1(W(1,1),W(1,10),GC_11,ZERO,ZERO,W(1,19))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,15),W(1,19),W(1,13),GC_11,AMP(11))
      CALL VVV1P0_1(W(1,10),W(1,13),GC_10,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,15),W(1,1),W(1,20),GC_11,AMP(12))
      CALL FFV2_1(W(1,1),W(1,5),GC_100,ZERO,ZERO,W(1,15))
...
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,19),W(1,4),W(1,17),GC_11,AMP(20))
...
C     Amplitude(s) for diagram number 32
      ...
      JAMP(1)=+1D0/4D0*(+1D0/3D0*AMP(1)+1D0/3D0*AMP(2)+1D0/3D0*AMP(6)
     ...
     $ -1D0/9D0*AMP(30)-1D0/3D0*AMP(31)-1D0/3D0*AMP(32))
      JAMP(3)=+1D0/4D0*(-AMP(2)+IMAG1*AMP(4)-AMP(5)-AMP(7)-1D0/3D0
     ...
     $ -AMP(28)-AMP(30)-1D0/3D0*AMP(31)-1D0/3D0*AMP(32))
      JAMP(4)=+1D0/4D0*(+1D0/3D0*AMP(3)+1D0/3D0*AMP(5)+1D0/3D0*AMP(6)
     ...
     $ *AMP(28)+AMP(31))
      JAMP(6)=+1D0/4D0*(-AMP(1)-AMP(3)-IMAG1*AMP(4)-AMP(6)-1D0/3D0
     ...
     $ -IMAG1*AMP(25)-AMP(27)-AMP(29))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P0_MATRIX99 = P0_MATRIX99+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
