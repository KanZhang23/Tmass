...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX92(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX92(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,11),W(1,1),W(1,13),GC_11,AMP(6))
      CALL FFV1_2(W(1,11),W(1,8),GC_11,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,13),W(1,1),W(1,9),GC_11,AMP(7))
...
C     Amplitude(s) for diagram number 13
      ...
      CALL FFV1_1(W(1,1),W(1,10),GC_11,ZERO,ZERO,W(1,17))
...
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,11),W(1,1),W(1,17),GC_11,AMP(18))
      CALL FFV1_2(W(1,11),W(1,14),GC_11,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,17),W(1,1),W(1,10),GC_11,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,11),W(1,15),W(1,10),GC_11,AMP(20))
      CALL FFV1_2(W(1,6),W(1,14),GC_11,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,15),W(1,2),W(1,13),GC_11,AMP(21))
      CALL FFV1_1(W(1,2),W(1,14),GC_11,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,6),W(1,11),W(1,13),GC_11,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,15),W(1,2),W(1,8),GC_11,AMP(23))
...
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,11),W(1,4),W(1,13),GC_11,AMP(25))
      CALL FFV1_1(W(1,4),W(1,10),GC_11,ZERO,ZERO,W(1,6))
...
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,6),W(1,2),W(1,13),GC_11,AMP(29))
...
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,6),W(1,2),W(1,8),GC_11,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,3),W(1,11),W(1,8),GC_11,AMP(32))
      JAMP(1)=+1D0/4D0*(-AMP(1)+IMAG1*AMP(3)-AMP(4)+IMAG1*AMP(6)
     ...
     $ +AMP(25)+AMP(27))
      JAMP(4)=+1D0/4D0*(-AMP(2)-IMAG1*AMP(3)-AMP(5)-IMAG1*AMP(6)
     ...
     $ -1D0/3D0*AMP(24)-AMP(29)-AMP(31))
      JAMP(5)=+1D0/4D0*(-1D0/9D0*AMP(1)-1D0/9D0*AMP(2)-1D0/9D0*AMP(4)
     ...
     $ -1D0/9D0*AMP(32))
      JAMP(6)=+1D0/4D0*(+1D0/3D0*AMP(9)+1D0/3D0*AMP(10)+1D0/3D0
     ...
     $ +1D0/3D0*AMP(31)+1D0/3D0*AMP(32))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX92 = P1_MATRIX92+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
