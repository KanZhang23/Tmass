      SUBROUTINE SP1_MATRIX104(P,ANS)
C     
...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX104(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX104(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFV1_1(W(1,4),W(1,10),GC_11,ZERO,ZERO,W(1,19))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,15),W(1,19),W(1,13),GC_11,AMP(11))
      CALL VVV1P0_1(W(1,10),W(1,13),GC_10,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,15),W(1,4),W(1,20),GC_11,AMP(12))
...
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,6),W(1,15),W(1,20),GC_11,AMP(17))
      CALL FFV1_1(W(1,4),W(1,13),GC_11,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 18
      CALL FFV2_0(W(1,18),W(1,20),W(1,5),GC_100,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV2_0(W(1,14),W(1,19),W(1,5),GC_100,AMP(19))
      CALL FFV1_2(W(1,3),W(1,13),GC_11,ZERO,ZERO,W(1,19))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,19),W(1,1),W(1,17),GC_11,AMP(20))
...
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,19),W(1,15),W(1,9),GC_11,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL FFV2_0(W(1,12),W(1,20),W(1,5),GC_100,AMP(27))
      CALL FFV1_1(W(1,4),W(1,9),GC_11,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 28
      CALL FFV2_0(W(1,19),W(1,12),W(1,5),GC_100,AMP(28))
...
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,19),W(1,1),W(1,21),GC_11,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,3),W(1,8),W(1,21),GC_11,AMP(32))
      JAMP(1)=+1D0/4D0*(-AMP(1)-AMP(3)-IMAG1*AMP(4)-AMP(6)-1D0/3D0
     $ *AMP(8)-1D0/3D0*AMP(9)-1D0/3D0*AMP(10)-1D0/3D0*AMP(11)
     ...
     $ -IMAG1*AMP(25)-AMP(27)-AMP(29))
      JAMP(2)=+1D0/4D0*(+1D0/3D0*AMP(3)+1D0/3D0*AMP(5)+1D0/3D0*AMP(6)
     $ +1D0/3D0*AMP(7)+1D0/9D0*AMP(8)+1D0/9D0*AMP(9)+1D0/9D0*AMP(10)
     $ +1D0/9D0*AMP(11)+1D0/9D0*AMP(13)+1D0/9D0*AMP(14)+1D0/9D0
     ...
     $ +1D0/3D0*AMP(5)+AMP(8)+AMP(10)+IMAG1*AMP(12)+AMP(13)+AMP(15)
     ...
     $ -1D0/9D0*AMP(5)-1D0/9D0*AMP(6)-1D0/9D0*AMP(7)-1D0/3D0*AMP(10)
     $ -1D0/3D0*AMP(11)-1D0/3D0*AMP(15)-1D0/3D0*AMP(16)-1D0/3D0
     ...
     $ -1D0/9D0*AMP(30)-1D0/3D0*AMP(31)-1D0/3D0*AMP(32))
      JAMP(5)=+1D0/4D0*(-AMP(2)+IMAG1*AMP(4)-AMP(5)-AMP(7)-1D0/3D0
     ...
     $ +1D0/3D0*AMP(7)+AMP(9)+AMP(11)-IMAG1*AMP(12)+AMP(14)+AMP(16)
     ...
     $ +1D0/3D0*AMP(29)+1D0/3D0*AMP(30)+AMP(32))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX104 = P1_MATRIX104+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
