      DOUBLE PRECISION FUNCTION P1_DSIG7(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! g d > e- ve~ g g g u
      PD(IPROC)=G1*D2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g s > e- ve~ g g g c
      PD(IPROC)=G1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP1_MATRIX7(PP,P1_DSIGUU)
      IF (P1_DSIGUU.LT.1D199) THEN
        P1_DSIG7=PD(0)*CONV*P1_DSIGUU
      ELSE
