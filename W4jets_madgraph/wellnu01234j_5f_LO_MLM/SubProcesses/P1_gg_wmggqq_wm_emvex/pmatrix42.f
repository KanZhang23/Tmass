...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX42(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX42(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,12),W(1,3),W(1,15),GC_11,AMP(6))
...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFV1P0_3(W(1,12),W(1,3),GC_11,ZERO,ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV1_1(W(1,4),W(1,14),GC_11,ZERO,ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 14
      ...
      CALL FFV2_1(W(1,4),W(1,5),GC_100,ZERO,ZERO,W(1,17))
...
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,12),W(1,4),W(1,5),GC_11,AMP(18))
      CALL FFV1_2(W(1,12),W(1,14),GC_11,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,5),W(1,4),W(1,9),GC_11,AMP(19))
...
C     Amplitude(s) for diagram number 22
      ...
      CALL FFV1P0_3(W(1,12),W(1,4),GC_11,ZERO,ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 32
      ...
      JAMP(1)=+1D0/4D0*(+1D0/3D0*AMP(9)+1D0/3D0*AMP(10)+1D0/3D0
     ...
     $ +1D0/3D0*AMP(28)+AMP(29)+1D0/3D0*AMP(30)+1D0/3D0*AMP(31))
      JAMP(2)=+1D0/4D0*(-AMP(2)-IMAG1*AMP(3)-AMP(5)-IMAG1*AMP(6)
     ...
     $ *AMP(26)-AMP(27)-1D0/3D0*AMP(29)-AMP(30)-1D0/3D0*AMP(32))
      JAMP(3)=+1D0/4D0*(-1D0/9D0*AMP(1)-1D0/9D0*AMP(2)-1D0/9D0*AMP(4)
     ...
     $ -1D0/3D0*AMP(24)-AMP(28)-AMP(31))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX42 = P1_MATRIX42+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
