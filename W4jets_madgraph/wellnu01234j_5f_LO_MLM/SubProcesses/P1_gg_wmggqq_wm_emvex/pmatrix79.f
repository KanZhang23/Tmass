...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX79(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX79(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 80
      CALL FFV1_0(W(1,16),W(1,2),W(1,4),GC_11,AMP(80))
...
C     Amplitude(s) for diagram number 89
      CALL FFV1_0(W(1,18),W(1,3),W(1,4),GC_11,AMP(89))
...
C     Amplitude(s) for diagram number 93
      CALL FFV1_0(W(1,19),W(1,2),W(1,4),GC_11,AMP(93))
...
C     Amplitude(s) for diagram number 96
      ...
      JAMP(1)=+1D0/4D0*(+1D0/3D0*AMP(3)+1D0/3D0*AMP(5)+AMP(7)
     ...
     $ *AMP(93)+1D0/3D0*AMP(94)+1D0/9D0*AMP(95)+1D0/9D0*AMP(96))
      JAMP(2)=+1D0/4D0*(-AMP(1)-AMP(3)-IMAG1*AMP(4)-1D0/3D0*AMP(6)
     ...
     $ *AMP(92)+1D0/3D0*AMP(93)+1D0/3D0*AMP(94)+AMP(96))
      JAMP(6)=+1D0/4D0*(-AMP(2)+IMAG1*AMP(4)-AMP(5)-1D0/3D0*AMP(8)
     ...
     $ *AMP(92)-AMP(94)-1D0/3D0*AMP(95)-1D0/3D0*AMP(96))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX79 = P1_MATRIX79+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
