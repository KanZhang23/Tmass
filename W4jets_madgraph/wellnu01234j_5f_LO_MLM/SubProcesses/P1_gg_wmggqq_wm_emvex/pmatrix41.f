...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX41(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX41(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 25
      ...
      CALL FFV1_1(W(1,3),W(1,10),GC_11,ZERO,ZERO,W(1,6))
...
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,6),W(1,4),W(1,13),GC_11,AMP(29))
...
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,6),W(1,4),W(1,8),GC_11,AMP(31))
C     Amplitude(s) for diagram number 32
     ...
     $ -1D0/3D0*AMP(31)-1D0/3D0*AMP(32))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX41 = P1_MATRIX41+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
