...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX73(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX73(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,7),W(1,2),W(1,13),GC_11,AMP(29))
...
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,7),W(1,2),W(1,8),GC_11,AMP(31))
C     Amplitude(s) for diagram number 32
     ...
     $ +AMP(25)+AMP(27))
      JAMP(5)=+1D0/4D0*(+1D0/3D0*AMP(9)+1D0/3D0*AMP(10)+1D0/3D0
     ...
     $ -1D0/3D0*AMP(28)-AMP(30)-AMP(32))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX73 = P1_MATRIX73+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
