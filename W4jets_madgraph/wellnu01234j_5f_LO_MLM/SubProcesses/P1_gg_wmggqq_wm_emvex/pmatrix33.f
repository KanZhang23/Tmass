...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX33(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX33(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1P0_3(W(1,6),W(1,3),GC_11,ZERO,ZERO,W(1,17))
...
C     Amplitude(s) for diagram number 24
      ...
      CALL FFV1P0_3(W(1,6),W(1,2),GC_11,ZERO,ZERO,W(1,18))
...
C     Amplitude(s) for diagram number 95
      CALL FFV1_0(W(1,1),W(1,19),W(1,12),GC_11,AMP(95))
C     Amplitude(s) for diagram number 96
      CALL FFV1_0(W(1,1),W(1,20),W(1,29),GC_11,AMP(96))
     ...
     $ -AMP(91)-1D0/3D0*AMP(93)-AMP(94)-1D0/3D0*AMP(96))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX33 = P1_MATRIX33+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
