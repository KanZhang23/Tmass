...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX98(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX98(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,9),W(1,4),GC_11,ZERO,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1_1(W(1,4),W(1,16),GC_11,ZERO,ZERO,W(1,18))
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,12),W(1,18),W(1,5),GC_100,AMP(7))
      CALL FFV2_1(W(1,4),W(1,5),GC_100,ZERO,ZERO,W(1,19))
...
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,22),W(1,4),W(1,20),GC_11,AMP(11))
      CALL FFV1_2(W(1,22),W(1,8),GC_11,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,20),W(1,4),W(1,16),GC_11,AMP(12))
...
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,20),W(1,2),W(1,8),GC_11,AMP(14))
...
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,12),W(1,2),W(1,23),GC_11,AMP(17))
...
C     Amplitude(s) for diagram number 20
      ...
      CALL FFV1P0_3(W(1,22),W(1,4),GC_11,ZERO,ZERO,W(1,19))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,20),W(1,2),W(1,19),GC_11,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,6),W(1,10),W(1,19),GC_11,AMP(22))
      CALL FFV1_1(W(1,4),W(1,13),GC_11,ZERO,ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 24
      ...
      CALL FFV1P0_3(W(1,3),W(1,4),GC_11,ZERO,ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,12),W(1,2),W(1,21),GC_11,AMP(26))
...
C     Amplitude(s) for diagram number 38
      CALL FFV1_0(W(1,26),W(1,2),W(1,14),GC_11,AMP(38))
...
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,12),W(1,2),W(1,28),GC_11,AMP(41))
...
C     Amplitude(s) for diagram number 45
      CALL FFV1_0(W(1,26),W(1,2),W(1,9),GC_11,AMP(45))
...
C     Amplitude(s) for diagram number 49
      CALL FFV1_0(W(1,24),W(1,4),W(1,21),GC_11,AMP(49))
...
C     Amplitude(s) for diagram number 53
      CALL FFV1_0(W(1,11),W(1,4),W(1,14),GC_11,AMP(53))
...
C     Amplitude(s) for diagram number 57
      CALL FFV1_0(W(1,11),W(1,4),W(1,9),GC_11,AMP(57))
...
C     Amplitude(s) for diagram number 61
      CALL FFV1_0(W(1,24),W(1,4),W(1,28),GC_11,AMP(61))
...
C     Amplitude(s) for diagram number 64
      ...
      JAMP(1)=+1D0/4D0*(-1D0/3D0*AMP(1)-1D0/3D0*AMP(2)-1D0/3D0*AMP(3)
     ...
     $ -AMP(62))
      JAMP(2)=+1D0/4D0*(+1D0/9D0*AMP(1)+1D0/9D0*AMP(2)+1D0/9D0*AMP(3)
     ...
     $ *AMP(64))
      JAMP(3)=+1D0/4D0*(+AMP(1)+AMP(3)+IMAG1*AMP(5)+1D0/3D0*AMP(14)
     ...
     $ *AMP(61)+1D0/3D0*AMP(62)+AMP(63))
      JAMP(4)=+1D0/4D0*(-1D0/3D0*AMP(3)-1D0/3D0*AMP(4)-AMP(6)
     ...
     $ *AMP(63)-1D0/3D0*AMP(64))
      JAMP(5)=+1D0/4D0*(-1D0/3D0*AMP(1)-1D0/3D0*AMP(2)-AMP(7)
     ...
     $ -1D0/3D0*AMP(63)-1D0/3D0*AMP(64))
      JAMP(6)=+1D0/4D0*(+AMP(2)+AMP(4)-IMAG1*AMP(5)+1D0/3D0*AMP(6)
     ...
     $ *AMP(60)+AMP(64))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX98 = P1_MATRIX98+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
