...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX77(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX77(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,6),W(1,4),GC_11,ZERO,ZERO,W(1,8))
      CALL FFV2_2(W(1,1),W(1,5),GC_100,ZERO,ZERO,W(1,9))
      CALL FFV1_1(W(1,2),W(1,8),GC_11,ZERO,ZERO,W(1,10))
      CALL FFV1P0_3(W(1,9),W(1,3),GC_11,ZERO,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,22),W(1,3),W(1,20),GC_11,AMP(11))
      CALL FFV1_2(W(1,22),W(1,8),GC_11,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,20),W(1,3),W(1,16),GC_11,AMP(12))
...
C     Amplitude(s) for diagram number 24
      ...
      CALL FFV1P0_3(W(1,9),W(1,4),GC_11,ZERO,ZERO,W(1,21))
...
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,24),W(1,4),W(1,13),GC_11,AMP(27))
      CALL FFV1_1(W(1,4),W(1,14),GC_11,ZERO,ZERO,W(1,24))
...
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,9),W(1,4),W(1,25),GC_11,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV2_0(W(1,17),W(1,24),W(1,5),GC_100,AMP(30))
      CALL FFV1_1(W(1,4),W(1,16),GC_11,ZERO,ZERO,W(1,17))
...
C     Amplitude(s) for diagram number 35
      CALL FFV1_0(W(1,22),W(1,4),W(1,26),GC_11,AMP(35))
      CALL FFV1_2(W(1,22),W(1,14),GC_11,ZERO,ZERO,W(1,26))
C     Amplitude(s) for diagram number 36
      CALL FFV1_0(W(1,26),W(1,4),W(1,16),GC_11,AMP(36))
...
C     Amplitude(s) for diagram number 44
      ...
      CALL FFV1P0_3(W(1,22),W(1,4),GC_11,ZERO,ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 46
      ...
      CALL FFV1_1(W(1,4),W(1,13),GC_11,ZERO,ZERO,W(1,15))
...
C     Amplitude(s) for diagram number 49
      CALL FFV1_0(W(1,24),W(1,3),W(1,21),GC_11,AMP(49))
C     Amplitude(s) for diagram number 50
      CALL FFV1_0(W(1,24),W(1,4),W(1,11),GC_11,AMP(50))
...
C     Amplitude(s) for diagram number 61
      CALL FFV1_0(W(1,24),W(1,3),W(1,28),GC_11,AMP(61))
...
C     Amplitude(s) for diagram number 64
     ...
     $ +AMP(62))
      JAMP(2)=+1D0/4D0*(-AMP(2)-AMP(4)+IMAG1*AMP(5)-1D0/3D0*AMP(6)
     ...
     $ *AMP(61)-1D0/3D0*AMP(62)-AMP(63))
      JAMP(4)=+1D0/4D0*(+1D0/3D0*AMP(1)+1D0/3D0*AMP(2)+AMP(7)
     ...
     $ +1D0/3D0*AMP(63)+1D0/3D0*AMP(64))
      JAMP(5)=+1D0/4D0*(+1D0/3D0*AMP(3)+1D0/3D0*AMP(4)+AMP(6)
     ...
     $ *AMP(63)+1D0/3D0*AMP(64))
      JAMP(6)=+1D0/4D0*(-1D0/9D0*AMP(1)-1D0/9D0*AMP(2)-1D0/9D0*AMP(3)
     ...
     $ *AMP(64))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX77 = P1_MATRIX77+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
