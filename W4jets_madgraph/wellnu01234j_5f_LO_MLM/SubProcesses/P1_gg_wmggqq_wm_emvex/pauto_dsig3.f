      DOUBLE PRECISION FUNCTION P1_DSIG3(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! g g > e- ve~ u c u~ s~
      PD(IPROC)=G1*G2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g g > e- ve~ c u c~ d~
      PD(IPROC)=G1*G2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g g > e- ve~ s u s~ d~
      PD(IPROC)=G1*G2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g g > e- ve~ b u b~ d~
      PD(IPROC)=G1*G2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g g > e- ve~ d c d~ s~
      PD(IPROC)=G1*G2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g g > e- ve~ b c b~ s~
      PD(IPROC)=G1*G2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP1_MATRIX3(PP,P1_DSIGUU)
      IF (P1_DSIGUU.LT.1D199) THEN
        P1_DSIG3=PD(0)*CONV*P1_DSIGUU
      ELSE
