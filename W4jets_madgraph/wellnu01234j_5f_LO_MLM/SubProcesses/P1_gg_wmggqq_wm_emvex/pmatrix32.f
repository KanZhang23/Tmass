...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX32(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX32(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 83
      CALL FFV1_0(W(1,21),W(1,6),W(1,1),GC_11,AMP(83))
...
C     Amplitude(s) for diagram number 94
      CALL FFV1_0(W(1,22),W(1,6),W(1,1),GC_11,AMP(96))
...
C     Amplitude(s) for diagram number 98
     ...
     $ *AMP(73)-1D0/3D0*AMP(76))
      JAMP(8)=+1D0/2D0*(-IMAG1*AMP(1)+AMP(4)-IMAG1*AMP(5)-IMAG1*AMP(6)
     ...
     $ +IMAG1*AMP(96)+AMP(97)+AMP(98)-AMP(102)-AMP(101))
      JAMP(9)=+1D0/2D0*(+AMP(25)+AMP(26)+AMP(29)+AMP(30)+IMAG1*AMP(32)
     ...
     $ -AMP(91)+IMAG1*AMP(94)+AMP(95)-AMP(99)+AMP(102)-AMP(100))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX32 = P1_MATRIX32+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
