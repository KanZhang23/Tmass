...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX87(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX87(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,12),W(1,1),W(1,11),GC_11,AMP(2))
      CALL FFV1P0_3(W(1,6),W(1,1),GC_11,ZERO,ZERO,W(1,13))
...
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,12),W(1,1),W(1,17),GC_11,AMP(7))
...
C     Amplitude(s) for diagram number 14
      ...
      CALL FFV1_2(W(1,6),W(1,3),GC_11,ZERO,ZERO,W(1,19))
...
C     Amplitude(s) for diagram number 36
      ...
      CALL FFV1_2(W(1,6),W(1,4),GC_11,ZERO,ZERO,W(1,24))
...
C     Amplitude(s) for diagram number 38
      ...
      CALL FFV1P0_3(W(1,24),W(1,1),GC_11,ZERO,ZERO,W(1,28))
...
C     Amplitude(s) for diagram number 43
      CALL FFV1_0(W(1,26),W(1,1),W(1,11),GC_11,AMP(43))
...
C     Amplitude(s) for diagram number 46
      CALL FFV1_0(W(1,26),W(1,1),W(1,17),GC_11,AMP(46))
...
C     Amplitude(s) for diagram number 54
      CALL FFV1_0(W(1,19),W(1,1),W(1,24),GC_11,AMP(54))
...
C     Amplitude(s) for diagram number 68
      ...
      CALL VVV1P0_1(W(1,4),W(1,13),GC_10,ZERO,ZERO,W(1,6))
...
C     Amplitude(s) for diagram number 73
      CALL FFV1_0(W(1,18),W(1,1),W(1,11),GC_11,AMP(73))
...
C     Amplitude(s) for diagram number 76
      CALL FFV1_0(W(1,18),W(1,1),W(1,17),GC_11,AMP(76))
...
C     Amplitude(s) for diagram number 83
      CALL FFV1_0(W(1,21),W(1,2),W(1,6),GC_11,AMP(83))
...
C     Amplitude(s) for diagram number 88
      CALL VVV1_0(W(1,6),W(1,3),W(1,11),GC_10,AMP(88))
...
C     Amplitude(s) for diagram number 94
      CALL FFV1_0(W(1,22),W(1,2),W(1,6),GC_11,AMP(96))
C     Amplitude(s) for diagram number 95
      CALL VVV1_0(W(1,6),W(1,3),W(1,17),GC_10,AMP(97))
...
C     Amplitude(s) for diagram number 98
     ...
     $ +AMP(9)+IMAG1*AMP(10)+IMAG1*AMP(11)+AMP(39)+AMP(40)+AMP(43)
     $ +AMP(44)+IMAG1*AMP(45)+AMP(46)+IMAG1*AMP(48)+AMP(67)-IMAG1
     ...
     $ +IMAG1*AMP(94)+AMP(95)-AMP(99)+AMP(102)-AMP(100))
      JAMP(7)=+1D0/2D0*(+1D0/3D0*IMAG1*AMP(1)+1D0/3D0*IMAG1*AMP(2)
     ...
     $ +AMP(99)+AMP(100)+AMP(101))
      JAMP(11)=+1D0/2D0*(+AMP(25)+AMP(26)+AMP(29)+AMP(30)+IMAG1
     $ *AMP(32)+AMP(33)+IMAG1*AMP(35)+AMP(37)+AMP(38)+AMP(41)
     $ +AMP(42)-IMAG1*AMP(45)+AMP(47)-IMAG1*AMP(48)+AMP(62)-IMAG1
     $ *AMP(63)-IMAG1*AMP(66)+AMP(80)-IMAG1*AMP(81)-IMAG1*AMP(83)
     ...
     $ *AMP(65)-1D0/3D0*AMP(74)-1D0/3D0*AMP(77))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX87 = P1_MATRIX87+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
