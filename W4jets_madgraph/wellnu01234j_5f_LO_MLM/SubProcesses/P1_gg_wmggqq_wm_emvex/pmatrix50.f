...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX50(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX50(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,7),W(1,4),GC_11,ZERO,ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV1_2(W(1,2),W(1,16),GC_11,ZERO,ZERO,W(1,17))
...
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,2),W(1,19),W(1,20),GC_11,AMP(8))
      CALL FFV1_1(W(1,19),W(1,8),GC_11,ZERO,ZERO,W(1,21))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,2),W(1,21),W(1,16),GC_11,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,12),W(1,19),W(1,16),GC_11,AMP(10))
      CALL FFV2_2(W(1,2),W(1,5),GC_100,ZERO,ZERO,W(1,22))
...
C     Amplitude(s) for diagram number 24
      ...
      CALL FFV1P0_3(W(1,7),W(1,3),GC_11,ZERO,ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,2),W(1,15),W(1,21),GC_11,AMP(25))
      CALL FFV1_2(W(1,2),W(1,14),GC_11,ZERO,ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,2),W(1,9),W(1,26),GC_11,AMP(32))
      CALL FFV1_1(W(1,9),W(1,14),GC_11,ZERO,ZERO,W(1,27))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,2),W(1,27),W(1,16),GC_11,AMP(33))
...
C     Amplitude(s) for diagram number 37
      ...
      CALL FFV1P0_3(W(1,2),W(1,9),GC_11,ZERO,ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 39
      CALL FFV1_0(W(1,2),W(1,15),W(1,28),GC_11,AMP(39))
...
C     Amplitude(s) for diagram number 48
      ...
      CALL FFV1_2(W(1,7),W(1,13),GC_11,ZERO,ZERO,W(1,24))
...
C     Amplitude(s) for diagram number 64
     ...
     $ *AMP(61)-1D0/3D0*AMP(62)-AMP(63))
      JAMP(2)=+1D0/4D0*(+1D0/3D0*AMP(3)+1D0/3D0*AMP(4)+AMP(6)
     ...
     $ *AMP(63)+1D0/3D0*AMP(64))
      JAMP(3)=+1D0/4D0*(+1D0/3D0*AMP(1)+1D0/3D0*AMP(2)+AMP(7)
     ...
     $ +AMP(62))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX50 = P1_MATRIX50+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
