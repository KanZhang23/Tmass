...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX72(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX72(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV2_2(W(1,1),W(1,5),GC_100,ZERO,ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 13
      ...
      CALL FFV1_2(W(1,1),W(1,14),GC_11,ZERO,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,1),W(1,17),W(1,5),GC_11,AMP(15))
      CALL FFV1_1(W(1,17),W(1,14),GC_11,ZERO,ZERO,W(1,18))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,1),W(1,18),W(1,9),GC_11,AMP(16))
...
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,6),W(1,16),W(1,8),GC_11,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,6),W(1,13),W(1,14),GC_11,AMP(32))
     ...
     $ +AMP(26)+AMP(32))
      JAMP(2)=+1D0/4D0*(-AMP(1)+IMAG1*AMP(3)-AMP(4)+IMAG1*AMP(6)
     ...
     $ +1D0/3D0*AMP(30)+1D0/3D0*AMP(31)+1D0/9D0*AMP(32))
      JAMP(6)=+1D0/4D0*(-1D0/9D0*AMP(1)-1D0/9D0*AMP(2)-1D0/9D0*AMP(4)
     ...
     $ -1D0/9D0*AMP(30)-1D0/9D0*AMP(31)-1D0/3D0*AMP(32))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX72 = P1_MATRIX72+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
