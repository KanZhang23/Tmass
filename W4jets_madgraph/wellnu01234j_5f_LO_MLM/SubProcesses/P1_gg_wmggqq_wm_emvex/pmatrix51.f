...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX51(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX51(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,7),W(1,3),GC_11,ZERO,ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV1P0_3(W(1,1),W(1,6),GC_11,ZERO,ZERO,W(1,9))
      CALL FFV1_2(W(1,2),W(1,9),GC_11,ZERO,ZERO,W(1,16))
...
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,2),W(1,16),W(1,17),GC_11,AMP(8))
      CALL FFV1_1(W(1,16),W(1,8),GC_11,ZERO,ZERO,W(1,18))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,2),W(1,18),W(1,9),GC_11,AMP(9))
...
C     Amplitude(s) for diagram number 13
      ...
      CALL FFV1P0_3(W(1,2),W(1,16),GC_11,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,17),W(1,6),W(1,8),GC_11,AMP(14))
      CALL FFV1P0_3(W(1,1),W(1,16),GC_11,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,2),W(1,10),W(1,20),GC_11,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,1),W(1,10),W(1,8),GC_11,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,12),W(1,6),W(1,20),GC_11,AMP(17))
...
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,17),W(1,6),W(1,16),GC_11,AMP(21))
...
C     Amplitude(s) for diagram number 24
      ...
      CALL FFV1_2(W(1,7),W(1,13),GC_11,ZERO,ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,7),W(1,14),W(1,11),GC_11,AMP(26))
...
C     Amplitude(s) for diagram number 32
     ...
     $ *AMP(30)+AMP(32))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX51 = P1_MATRIX51+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
