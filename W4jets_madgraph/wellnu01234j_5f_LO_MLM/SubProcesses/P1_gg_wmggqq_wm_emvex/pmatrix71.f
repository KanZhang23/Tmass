...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX71(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX71(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,16),W(1,6),W(1,25),GC_11,AMP(28))
      CALL FFV2_2(W(1,22),W(1,5),GC_100,ZERO,ZERO,W(1,25))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,25),W(1,6),W(1,19),GC_11,AMP(29))
...
C     Amplitude(s) for diagram number 40
      CALL FFV1_0(W(1,16),W(1,6),W(1,28),GC_11,AMP(40))
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,25),W(1,6),W(1,27),GC_11,AMP(41))
...
C     Amplitude(s) for diagram number 47
      CALL FFV1_0(W(1,26),W(1,6),W(1,27),GC_11,AMP(47))
...
C     Amplitude(s) for diagram number 51
      CALL FFV1_0(W(1,28),W(1,6),W(1,18),GC_11,AMP(51))
...
C     Amplitude(s) for diagram number 53
      CALL FFV1_0(W(1,28),W(1,6),W(1,21),GC_11,AMP(53))
...
C     Amplitude(s) for diagram number 59
      CALL FFV1_0(W(1,28),W(1,6),W(1,24),GC_11,AMP(59))
...
C     Amplitude(s) for diagram number 71
      CALL FFV1_0(W(1,30),W(1,6),W(1,18),GC_11,AMP(71))
...
C     Amplitude(s) for diagram number 77
      CALL FFV1_0(W(1,30),W(1,6),W(1,21),GC_11,AMP(77))
...
C     Amplitude(s) for diagram number 83
      CALL FFV1_0(W(1,25),W(1,6),W(1,19),GC_11,AMP(83))
...
C     Amplitude(s) for diagram number 98
      ...
      JAMP(1)=+1D0/2D0*(+IMAG1*AMP(2)+IMAG1*AMP(3)+AMP(4)+IMAG1*AMP(7)
     ...
     $ +1D0/3D0*AMP(66)+1D0/3D0*AMP(89)+1D0/3D0*AMP(95))
      JAMP(5)=+1D0/2D0*(-AMP(25)-AMP(26)-AMP(27)-AMP(28)-AMP(32)
     ...
     $ *AMP(42)+1D0/3D0*AMP(44)+1D0/3D0*AMP(47))
      JAMP(7)=+1D0/2D0*(+IMAG1*AMP(1)-AMP(4)+IMAG1*AMP(5)+IMAG1*AMP(6)
     ...
     $ +AMP(92)-IMAG1*AMP(96)-AMP(97)-AMP(98)+AMP(102)+AMP(101))
      JAMP(8)=+1D0/2D0*(-1D0/3D0*IMAG1*AMP(1)-1D0/3D0*IMAG1*AMP(2)
     ...
     $ *AMP(71)+1D0/3D0*AMP(74)+1D0/3D0*AMP(77))
      JAMP(10)=+1D0/2D0*(-AMP(13)-AMP(14)-AMP(17)-AMP(18)-IMAG1
     $ *AMP(20)-AMP(21)-IMAG1*AMP(23)-AMP(39)-AMP(40)-AMP(41)-AMP(42)
     ...
     $ *AMP(6)-IMAG1*AMP(8)+AMP(10)-IMAG1*AMP(12)-AMP(51)-AMP(52)
     $ -AMP(55)-IMAG1*AMP(56)-AMP(58)-IMAG1*AMP(59)-AMP(60)-AMP(67)
     ...
     $ *AMP(67)+1D0/3D0*AMP(70))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX71 = P1_MATRIX71+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
