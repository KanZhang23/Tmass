      SUBROUTINE SP1_MATRIX102(P,ANS)
C     
...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX102(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX102(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1_1(W(1,4),W(1,9),GC_11,ZERO,ZERO,W(1,16))
...
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,19),W(1,4),W(1,17),GC_11,AMP(11))
      CALL FFV1_2(W(1,19),W(1,8),GC_11,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,17),W(1,4),W(1,9),GC_11,AMP(12))
...
C     Amplitude(s) for diagram number 20
      ...
      CALL FFV1P0_3(W(1,19),W(1,4),GC_11,ZERO,ZERO,W(1,16))
...
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,10),W(1,1),W(1,11),GC_11,AMP(25))
      CALL FFV1_1(W(1,1),W(1,13),GC_11,ZERO,ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 32
     ...
     $ *AMP(30)+AMP(32))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX102 = P1_MATRIX102+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
