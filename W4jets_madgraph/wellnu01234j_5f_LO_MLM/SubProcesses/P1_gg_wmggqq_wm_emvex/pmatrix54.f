...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX54(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX54(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFV1_1(W(1,3),W(1,13),GC_11,ZERO,ZERO,W(1,16))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV1P0_3(W(1,9),W(1,4),GC_11,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,2),W(1,15),W(1,10),GC_11,AMP(13))
      CALL FFV1_2(W(1,2),W(1,14),GC_11,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,8),W(1,6),W(1,10),GC_11,AMP(14))
      CALL FFV1_2(W(1,9),W(1,14),GC_11,ZERO,ZERO,W(1,18))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,18),W(1,4),W(1,13),GC_11,AMP(15))
      CALL FFV1_1(W(1,4),W(1,14),GC_11,ZERO,ZERO,W(1,18))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,9),W(1,18),W(1,13),GC_11,AMP(16))
      CALL VVV1P0_1(W(1,14),W(1,13),GC_10,ZERO,ZERO,W(1,19))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,9),W(1,4),W(1,19),GC_11,AMP(17))
      CALL FFV2_1(W(1,4),W(1,5),GC_100,ZERO,ZERO,W(1,9))
      CALL FFV1P0_3(W(1,1),W(1,9),GC_11,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,2),W(1,15),W(1,20),GC_11,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,8),W(1,6),W(1,20),GC_11,AMP(19))
      CALL FFV1_2(W(1,1),W(1,14),GC_11,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,8),W(1,9),W(1,13),GC_11,AMP(20))
      CALL FFV1_1(W(1,9),W(1,14),GC_11,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,1),W(1,6),W(1,13),GC_11,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,1),W(1,9),W(1,19),GC_11,AMP(22))
      CALL FFV1_1(W(1,4),W(1,13),GC_11,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 23
      CALL FFV2_0(W(1,8),W(1,9),W(1,5),GC_100,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV2_0(W(1,12),W(1,18),W(1,5),GC_100,AMP(24))
      CALL FFV1_2(W(1,7),W(1,13),GC_11,ZERO,ZERO,W(1,18))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,18),W(1,3),W(1,10),GC_11,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,18),W(1,4),W(1,11),GC_11,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,7),W(1,16),W(1,10),GC_11,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,7),W(1,9),W(1,11),GC_11,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,18),W(1,3),W(1,20),GC_11,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,7),W(1,16),W(1,20),GC_11,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,18),W(1,4),W(1,17),GC_11,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,7),W(1,9),W(1,17),GC_11,AMP(32))
      JAMP(1)=+1D0/4D0*(-AMP(1)-AMP(3)-IMAG1*AMP(5)-AMP(6)-AMP(8)
     ...
     $ -1D0/3D0*AMP(27)-1D0/3D0*AMP(29)-1D0/3D0*AMP(30)-AMP(31))
      JAMP(2)=+1D0/4D0*(+1D0/3D0*AMP(3)+1D0/3D0*AMP(4)+1D0/3D0*AMP(8)
     ...
     $ +1D0/9D0*AMP(30)+1D0/3D0*AMP(31)+1D0/3D0*AMP(32))
      JAMP(3)=+1D0/4D0*(+1D0/3D0*AMP(1)+1D0/3D0*AMP(2)+1D0/3D0*AMP(6)
     ...
     $ +AMP(29)+1D0/3D0*AMP(31)+1D0/3D0*AMP(32))
      JAMP(4)=+1D0/4D0*(-AMP(2)-AMP(4)+IMAG1*AMP(5)-AMP(7)-AMP(9)
     ...
     $ +AMP(27)+AMP(30))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX54 = P1_MATRIX54+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
