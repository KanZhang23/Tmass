      DOUBLE PRECISION FUNCTION P1_DSIG21(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! u d > e- ve~ g g u u
      PD(IPROC)=U1*D2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! c s > e- ve~ g g c c
      PD(IPROC)=C1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP1_MATRIX21(PP,P1_DSIGUU)
      IF (P1_DSIGUU.LT.1D199) THEN
        P1_DSIG21=PD(0)*CONV*P1_DSIGUU
      ELSE
