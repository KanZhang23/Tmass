      DOUBLE PRECISION FUNCTION P1_DSIG28(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      IPROC=IPROC+1  ! c d > e- ve~ u c u u~
      PD(IPROC)=C1*D2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! d s > e- ve~ c d c c~
      PD(IPROC)=D1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP1_MATRIX28(PP,P1_DSIGUU)
      IF (P1_DSIGUU.LT.1D199) THEN
        P1_DSIG28=PD(0)*CONV*P1_DSIGUU
      ELSE
