...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX17(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX17(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1P0_3(W(1,2),W(1,6),GC_11,ZERO,ZERO,W(1,17))
...
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,2),W(1,18),W(1,23),GC_11,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,2),W(1,10),W(1,12),GC_11,AMP(24))
...
C     Amplitude(s) for diagram number 40
      ...
      CALL FFV1_2(W(1,2),W(1,10),GC_11,ZERO,ZERO,W(1,27))
...
C     Amplitude(s) for diagram number 47
      CALL FFV1_0(W(1,2),W(1,14),W(1,23),GC_11,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL FFV1_0(W(1,2),W(1,15),W(1,29),GC_11,AMP(48))
...
C     Amplitude(s) for diagram number 71
      CALL FFV1_0(W(1,2),W(1,21),W(1,12),GC_11,AMP(71))
C     Amplitude(s) for diagram number 72
      CALL FFV1_0(W(1,2),W(1,14),W(1,29),GC_11,AMP(72))
...
C     Amplitude(s) for diagram number 96
     ...
     $ *AMP(90)+AMP(91)+1D0/3D0*AMP(93)+AMP(94)+1D0/3D0*AMP(96))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX17 = P1_MATRIX17+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
