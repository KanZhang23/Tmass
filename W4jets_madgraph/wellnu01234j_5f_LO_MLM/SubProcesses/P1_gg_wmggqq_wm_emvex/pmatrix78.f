...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX78(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX78(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,6),W(1,3),GC_11,ZERO,ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,10),W(1,3),W(1,11),GC_11,AMP(25))
      CALL FFV1_1(W(1,3),W(1,13),GC_11,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,6),W(1,14),W(1,11),GC_11,AMP(26))
      CALL FFV1_2(W(1,6),W(1,9),GC_11,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,11),W(1,3),W(1,8),GC_11,AMP(27))
      CALL FFV1_1(W(1,3),W(1,9),GC_11,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,6),W(1,13),W(1,8),GC_11,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,11),W(1,3),W(1,16),GC_11,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,6),W(1,13),W(1,16),GC_11,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,10),W(1,3),W(1,20),GC_11,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,6),W(1,14),W(1,20),GC_11,AMP(32))
     ...
     $ -1D0/3D0*AMP(31)-1D0/3D0*AMP(32))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX78 = P1_MATRIX78+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
