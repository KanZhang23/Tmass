...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX60(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX60(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 14
      ...
      CALL FFV1P0_3(W(1,20),W(1,6),GC_11,ZERO,ZERO,W(1,21))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,1),W(1,10),W(1,21),GC_11,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,20),W(1,6),W(1,19),GC_11,AMP(16))
      CALL FFV1_2(W(1,1),W(1,3),GC_11,ZERO,ZERO,W(1,22))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,22),W(1,10),W(1,13),GC_11,AMP(17))
      CALL FFV1_1(W(1,15),W(1,13),GC_11,ZERO,ZERO,W(1,23))
C     Amplitude(s) for diagram number 18
      CALL FFV2_0(W(1,22),W(1,23),W(1,5),GC_100,AMP(18))
...
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,16),W(1,23),W(1,3),GC_11,AMP(21))
...
C     Amplitude(s) for diagram number 24
      ...
      CALL FFV1_1(W(1,6),W(1,4),GC_11,ZERO,ZERO,W(1,10))
      CALL FFV1_1(W(1,2),W(1,3),GC_11,ZERO,ZERO,W(1,23))
      CALL FFV1P0_3(W(1,7),W(1,10),GC_11,ZERO,ZERO,W(1,19))
      CALL FFV2_1(W(1,23),W(1,5),GC_100,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,1),W(1,15),W(1,19),GC_11,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,16),W(1,23),W(1,19),GC_11,AMP(26))
      CALL FFV1P0_3(W(1,20),W(1,10),GC_11,ZERO,ZERO,W(1,25))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,1),W(1,9),W(1,25),GC_11,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,16),W(1,2),W(1,25),GC_11,AMP(28))
      CALL FFV2_2(W(1,22),W(1,5),GC_100,ZERO,ZERO,W(1,25))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,25),W(1,2),W(1,19),GC_11,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,22),W(1,9),W(1,19),GC_11,AMP(30))
...
C     Amplitude(s) for diagram number 35
      CALL FFV1_0(W(1,26),W(1,2),W(1,19),GC_11,AMP(35))
C     Amplitude(s) for diagram number 36
      CALL VVV1_0(W(1,19),W(1,3),W(1,17),GC_10,AMP(36))
      CALL FFV1_2(W(1,7),W(1,4),GC_11,ZERO,ZERO,W(1,19))
      CALL FFV1P0_3(W(1,19),W(1,6),GC_11,ZERO,ZERO,W(1,27))
C     Amplitude(s) for diagram number 37
      CALL FFV1_0(W(1,1),W(1,15),W(1,27),GC_11,AMP(37))
C     Amplitude(s) for diagram number 38
      CALL FFV1_0(W(1,16),W(1,23),W(1,27),GC_11,AMP(38))
      CALL FFV1P0_3(W(1,19),W(1,8),GC_11,ZERO,ZERO,W(1,28))
C     Amplitude(s) for diagram number 39
      CALL FFV1_0(W(1,1),W(1,9),W(1,28),GC_11,AMP(39))
C     Amplitude(s) for diagram number 40
      CALL FFV1_0(W(1,16),W(1,2),W(1,28),GC_11,AMP(40))
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,25),W(1,2),W(1,27),GC_11,AMP(41))
C     Amplitude(s) for diagram number 42
      CALL FFV1_0(W(1,22),W(1,9),W(1,27),GC_11,AMP(42))
      CALL FFV1_2(W(1,19),W(1,3),GC_11,ZERO,ZERO,W(1,28))
C     Amplitude(s) for diagram number 43
      CALL FFV1_0(W(1,28),W(1,6),W(1,11),GC_11,AMP(43))
C     Amplitude(s) for diagram number 44
      CALL FFV1_0(W(1,1),W(1,10),W(1,27),GC_11,AMP(44))
C     Amplitude(s) for diagram number 45
      CALL VVV1_0(W(1,27),W(1,3),W(1,11),GC_10,AMP(45))
C     Amplitude(s) for diagram number 46
      CALL FFV1_0(W(1,28),W(1,6),W(1,17),GC_11,AMP(46))
C     Amplitude(s) for diagram number 47
      CALL FFV1_0(W(1,26),W(1,2),W(1,27),GC_11,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL VVV1_0(W(1,27),W(1,3),W(1,17),GC_10,AMP(48))
      CALL FFV1_2(W(1,1),W(1,4),GC_11,ZERO,ZERO,W(1,27))
      CALL FFV2_2(W(1,27),W(1,5),GC_100,ZERO,ZERO,W(1,28))
C     Amplitude(s) for diagram number 49
      CALL FFV1_0(W(1,28),W(1,23),W(1,13),GC_11,AMP(49))
      CALL FFV1_2(W(1,27),W(1,13),GC_11,ZERO,ZERO,W(1,19))
C     Amplitude(s) for diagram number 50
      CALL FFV2_0(W(1,19),W(1,23),W(1,5),GC_100,AMP(50))
C     Amplitude(s) for diagram number 51
      CALL FFV1_0(W(1,28),W(1,2),W(1,18),GC_11,AMP(51))
      CALL FFV1P0_3(W(1,27),W(1,9),GC_11,ZERO,ZERO,W(1,29))
C     Amplitude(s) for diagram number 52
      CALL FFV1_0(W(1,7),W(1,8),W(1,29),GC_11,AMP(52))
C     Amplitude(s) for diagram number 53
      CALL FFV1_0(W(1,28),W(1,2),W(1,21),GC_11,AMP(53))
C     Amplitude(s) for diagram number 54
      CALL FFV1_0(W(1,20),W(1,6),W(1,29),GC_11,AMP(54))
      CALL FFV1_2(W(1,27),W(1,3),GC_11,ZERO,ZERO,W(1,30))
C     Amplitude(s) for diagram number 55
      CALL FFV1_0(W(1,30),W(1,9),W(1,13),GC_11,AMP(55))
C     Amplitude(s) for diagram number 56
      CALL VVV1_0(W(1,3),W(1,13),W(1,29),GC_10,AMP(56))
C     Amplitude(s) for diagram number 57
      CALL FFV1_0(W(1,19),W(1,9),W(1,3),GC_11,AMP(57))
C     Amplitude(s) for diagram number 58
      CALL FFV2_0(W(1,30),W(1,12),W(1,5),GC_100,AMP(58))
C     Amplitude(s) for diagram number 59
      CALL FFV1_0(W(1,28),W(1,2),W(1,24),GC_11,AMP(59))
C     Amplitude(s) for diagram number 60
      CALL FFV1_0(W(1,28),W(1,12),W(1,3),GC_11,AMP(60))
      CALL FFV1_1(W(1,23),W(1,4),GC_11,ZERO,ZERO,W(1,28))
C     Amplitude(s) for diagram number 61
      CALL FFV1_0(W(1,16),W(1,28),W(1,13),GC_11,AMP(61))
      CALL FFV1_2(W(1,16),W(1,4),GC_11,ZERO,ZERO,W(1,30))
C     Amplitude(s) for diagram number 62
      CALL FFV1_0(W(1,30),W(1,23),W(1,13),GC_11,AMP(62))
      CALL VVV1P0_1(W(1,4),W(1,13),GC_10,ZERO,ZERO,W(1,19))
C     Amplitude(s) for diagram number 63
      CALL FFV1_0(W(1,16),W(1,23),W(1,19),GC_11,AMP(63))
C     Amplitude(s) for diagram number 64
      CALL FFV2_0(W(1,14),W(1,28),W(1,5),GC_100,AMP(64))
C     Amplitude(s) for diagram number 65
      CALL FFV1_0(W(1,1),W(1,15),W(1,19),GC_11,AMP(65))
...
C     Amplitude(s) for diagram number 71
      CALL FFV1_0(W(1,30),W(1,2),W(1,18),GC_11,AMP(71))
...
C     Amplitude(s) for diagram number 74
      CALL FFV1_0(W(1,1),W(1,8),W(1,21),GC_11,AMP(74))
C     Amplitude(s) for diagram number 75
      CALL VVV1_0(W(1,4),W(1,21),W(1,11),GC_10,AMP(75))
C     Amplitude(s) for diagram number 76
      CALL FFV1_0(W(1,18),W(1,6),W(1,17),GC_11,AMP(76))
C     Amplitude(s) for diagram number 77
      CALL FFV1_0(W(1,30),W(1,2),W(1,21),GC_11,AMP(77))
C     Amplitude(s) for diagram number 78
      CALL VVV1_0(W(1,4),W(1,21),W(1,17),GC_10,AMP(78))
      CALL FFV1_2(W(1,22),W(1,4),GC_11,ZERO,ZERO,W(1,21))
C     Amplitude(s) for diagram number 79
      CALL FFV1_0(W(1,21),W(1,9),W(1,13),GC_11,AMP(79))
C     Amplitude(s) for diagram number 80
      CALL FFV1_0(W(1,22),W(1,8),W(1,13),GC_11,AMP(80))
C     Amplitude(s) for diagram number 81
      CALL FFV1_0(W(1,22),W(1,9),W(1,19),GC_11,AMP(81))
C     Amplitude(s) for diagram number 82
      CALL FFV2_0(W(1,21),W(1,12),W(1,5),GC_100,AMP(82))
C     Amplitude(s) for diagram number 83
      CALL FFV1_0(W(1,25),W(1,2),W(1,19),GC_11,AMP(83))
C     Amplitude(s) for diagram number 84
      CALL FFV1_0(W(1,25),W(1,12),W(1,4),GC_11,AMP(84))
...
C     Amplitude(s) for diagram number 87
      CALL FFV1_0(W(1,1),W(1,10),W(1,19),GC_11,AMP(87))
C     Amplitude(s) for diagram number 88
      CALL VVV1_0(W(1,19),W(1,3),W(1,11),GC_10,AMP(88))
...
C     Amplitude(s) for diagram number 92
      CALL FFV1_0(W(1,30),W(1,2),W(1,24),GC_11,AMP(94))
C     Amplitude(s) for diagram number 93
      CALL FFV1_0(W(1,30),W(1,12),W(1,3),GC_11,AMP(95))
C     Amplitude(s) for diagram number 94
      CALL FFV1_0(W(1,26),W(1,2),W(1,19),GC_11,AMP(96))
C     Amplitude(s) for diagram number 95
      CALL VVV1_0(W(1,19),W(1,3),W(1,17),GC_10,AMP(97))
...
C     Amplitude(s) for diagram number 98
      ...
      CALL FFV1_0(W(1,16),W(1,2),W(1,10),GC_11,AMP(101))
      CALL FFV1_0(W(1,16),W(1,2),W(1,14),GC_11,AMP(102))
      JAMP(1)=+1D0/2D0*(+1D0/3D0*IMAG1*AMP(1)+1D0/3D0*IMAG1*AMP(2)
     $ +1D0/3D0*IMAG1*AMP(6)+1D0/3D0*IMAG1*AMP(7)-1D0/3D0*AMP(27)
     $ -1D0/3D0*AMP(28)-1D0/3D0*AMP(31)-1D0/3D0*AMP(34)-1D0/3D0
     $ *AMP(73)-1D0/3D0*AMP(76))
      JAMP(2)=+1D0/2D0*(-1D0/3D0*IMAG1*AMP(1)-1D0/3D0*IMAG1*AMP(2)
     $ -1D0/3D0*IMAG1*AMP(6)-1D0/3D0*IMAG1*AMP(7)-1D0/3D0*AMP(39)
     $ -1D0/3D0*AMP(40)-1D0/3D0*AMP(43)-1D0/3D0*AMP(46)-1D0/3D0
     $ *AMP(67)-1D0/3D0*AMP(70))
      JAMP(3)=+1D0/2D0*(-IMAG1*AMP(1)+AMP(4)-IMAG1*AMP(5)-IMAG1*AMP(6)
     $ -IMAG1*AMP(8)+AMP(10)-IMAG1*AMP(12)+AMP(29)+AMP(30)+AMP(31)
     $ -IMAG1*AMP(33)+AMP(34)+AMP(35)-IMAG1*AMP(36)+AMP(79)+IMAG1
     ...
     $ +IMAG1*AMP(8)-AMP(10)+IMAG1*AMP(12)+AMP(51)+AMP(52)+AMP(55)
     $ +IMAG1*AMP(56)+AMP(58)+IMAG1*AMP(59)+AMP(60)+AMP(67)+IMAG1
     $ *AMP(69)+AMP(70)+AMP(71)+IMAG1*AMP(72)-AMP(90)+AMP(93)-AMP(91)
     $ +IMAG1*AMP(94)+AMP(95)-AMP(99)+AMP(102)-AMP(100))
      JAMP(5)=+1D0/2D0*(-1D0/3D0*AMP(13)-1D0/3D0*AMP(14)-1D0/3D0
     $ *AMP(15)-1D0/3D0*AMP(16)-1D0/3D0*AMP(51)-1D0/3D0*AMP(52)
     $ -1D0/3D0*AMP(53)-1D0/3D0*AMP(54)-1D0/3D0*AMP(68)-1D0/3D0
     $ *AMP(71)-1D0/3D0*AMP(74)-1D0/3D0*AMP(77))
      JAMP(6)=+1D0/2D0*(+AMP(13)+AMP(14)+AMP(17)+AMP(18)+IMAG1*AMP(20)
     $ +AMP(21)+IMAG1*AMP(23)+AMP(39)+AMP(40)+AMP(41)+AMP(42)
     $ -IMAG1*AMP(45)+AMP(47)-IMAG1*AMP(48)+AMP(68)-IMAG1*AMP(69)
     $ -IMAG1*AMP(72)+AMP(80)-IMAG1*AMP(81)-IMAG1*AMP(83)+IMAG1
     ...
     $ *AMP(11)+1D0/3D0*IMAG1*AMP(12)-1D0/3D0*AMP(17)-1D0/3D0*AMP(18)
     $ -1D0/3D0*AMP(19)-1D0/3D0*AMP(21)-1D0/3D0*AMP(22)-1D0/3D0
     $ *AMP(24)-1D0/3D0*AMP(79)-1D0/3D0*AMP(80)-1D0/3D0*AMP(82)
     $ -1D0/3D0*AMP(84)-1D0/3D0*AMP(86)-1D0/3D0*AMP(98))
      JAMP(8)=+1D0/2D0*(-IMAG1*AMP(2)-IMAG1*AMP(3)-AMP(4)-IMAG1*AMP(7)
     $ -IMAG1*AMP(9)-AMP(10)-IMAG1*AMP(11)+AMP(15)+AMP(16)+AMP(19)
     $ -IMAG1*AMP(20)+AMP(22)-IMAG1*AMP(23)+AMP(24)+AMP(73)+AMP(74)
     $ -IMAG1*AMP(75)+AMP(76)-IMAG1*AMP(78)-IMAG1*AMP(85)+AMP(86)
     $ -AMP(90)+AMP(93)-AMP(91)-AMP(99)+AMP(102)-AMP(100))
      JAMP(9)=+1D0/2D0*(+AMP(25)+AMP(26)+AMP(27)+AMP(28)+AMP(32)
     $ +IMAG1*AMP(33)+IMAG1*AMP(36)+AMP(49)+AMP(50)+AMP(53)+AMP(54)
     $ -IMAG1*AMP(56)+AMP(57)-IMAG1*AMP(59)+AMP(62)+IMAG1*AMP(63)
     $ +IMAG1*AMP(65)+IMAG1*AMP(75)+AMP(77)+IMAG1*AMP(78)+IMAG1
     $ *AMP(87)-AMP(88)+AMP(90)+AMP(91)+AMP(92)-IMAG1*AMP(94)-AMP(97)
     $ +AMP(99)+AMP(100)+AMP(101))
      JAMP(10)=+1D0/2D0*(-1D0/3D0*AMP(25)-1D0/3D0*AMP(26)-1D0/3D0
     $ *AMP(29)-1D0/3D0*AMP(30)-1D0/3D0*AMP(32)-1D0/3D0*AMP(35)
     $ -1D0/3D0*AMP(37)-1D0/3D0*AMP(38)-1D0/3D0*AMP(41)-1D0/3D0
     $ *AMP(42)-1D0/3D0*AMP(44)-1D0/3D0*AMP(47))
      JAMP(11)=+1D0/2D0*(-1D0/3D0*IMAG1*AMP(3)-1D0/3D0*IMAG1*AMP(5)
     $ -1D0/3D0*IMAG1*AMP(8)-1D0/3D0*IMAG1*AMP(9)-1D0/3D0*IMAG1
     $ *AMP(11)-1D0/3D0*IMAG1*AMP(12)-1D0/3D0*AMP(49)-1D0/3D0*AMP(50)
     $ -1D0/3D0*AMP(55)-1D0/3D0*AMP(57)-1D0/3D0*AMP(58)-1D0/3D0
     $ *AMP(60)-1D0/3D0*AMP(61)-1D0/3D0*AMP(62)-1D0/3D0*AMP(64)
     $ -1D0/3D0*AMP(66)-1D0/3D0*AMP(89)-1D0/3D0*AMP(95))
      JAMP(12)=+1D0/2D0*(+IMAG1*AMP(2)+IMAG1*AMP(3)+AMP(4)+IMAG1
     $ *AMP(7)+IMAG1*AMP(9)+AMP(10)+IMAG1*AMP(11)+AMP(37)+AMP(38)
     $ +AMP(43)+AMP(44)+IMAG1*AMP(45)+AMP(46)+IMAG1*AMP(48)+AMP(61)
     ...
     $ +AMP(88)+AMP(89)-AMP(93)-AMP(92)+AMP(97)-AMP(102)-AMP(101))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX60 = P1_MATRIX60+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
