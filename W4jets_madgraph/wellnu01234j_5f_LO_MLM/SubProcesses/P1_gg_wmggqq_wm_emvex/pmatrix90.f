...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX90(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX90(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,12),W(1,4),W(1,15),GC_11,AMP(6))
...
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,10),W(1,2),W(1,5),GC_11,AMP(21))
      CALL FFV1_1(W(1,2),W(1,14),GC_11,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,6),W(1,17),W(1,5),GC_11,AMP(22))
      CALL FFV1P0_3(W(1,12),W(1,1),GC_11,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,10),W(1,2),W(1,14),GC_11,AMP(23))
...
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,17),W(1,4),W(1,5),GC_11,AMP(25))
...
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,17),W(1,4),W(1,14),GC_11,AMP(29))
...
C     Amplitude(s) for diagram number 32
     ...
     $ +1D0/3D0*AMP(30)+1D0/3D0*AMP(31)+1D0/9D0*AMP(32))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX90 = P1_MATRIX90+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
