...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX53(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX53(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV1P0_3(W(1,16),W(1,6),GC_11,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,2),W(1,10),W(1,17),GC_11,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,12),W(1,7),W(1,17),GC_11,AMP(7))
      CALL FFV1_2(W(1,16),W(1,8),GC_11,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,12),W(1,6),W(1,13),GC_11,AMP(8))
      CALL FFV1_1(W(1,6),W(1,8),GC_11,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,16),W(1,12),W(1,13),GC_11,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,16),W(1,6),W(1,14),GC_11,AMP(10))
      CALL FFV1_2(W(1,1),W(1,13),GC_11,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 11
      CALL FFV2_0(W(1,14),W(1,12),W(1,5),GC_100,AMP(11))
      CALL FFV1_1(W(1,6),W(1,13),GC_11,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV1P0_3(W(1,2),W(1,8),GC_11,ZERO,ZERO,W(1,18))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,1),W(1,10),W(1,18),GC_11,AMP(13))
      CALL FFV1P0_3(W(1,16),W(1,15),GC_11,ZERO,ZERO,W(1,19))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,2),W(1,8),W(1,19),GC_11,AMP(14))
      CALL FFV1_2(W(1,1),W(1,3),GC_11,ZERO,ZERO,W(1,20))
...
C     Amplitude(s) for diagram number 16
      ...
      CALL FFV1P0_3(W(1,22),W(1,7),GC_11,ZERO,ZERO,W(1,23))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,1),W(1,10),W(1,23),GC_11,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,22),W(1,7),W(1,19),GC_11,AMP(18))
...
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,1),W(1,15),W(1,19),GC_11,AMP(25))
...
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,25),W(1,6),W(1,19),GC_11,AMP(27))
...
C     Amplitude(s) for diagram number 39
      CALL FFV1_0(W(1,27),W(1,6),W(1,18),GC_11,AMP(39))
      CALL FFV1P0_3(W(1,19),W(1,9),GC_11,ZERO,ZERO,W(1,29))
C     Amplitude(s) for diagram number 40
      CALL FFV1_0(W(1,2),W(1,8),W(1,29),GC_11,AMP(40))
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,27),W(1,6),W(1,23),GC_11,AMP(41))
C     Amplitude(s) for diagram number 42
      CALL FFV1_0(W(1,22),W(1,7),W(1,29),GC_11,AMP(42))
...
C     Amplitude(s) for diagram number 47
      CALL FFV1_0(W(1,27),W(1,6),W(1,24),GC_11,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL FFV1_0(W(1,27),W(1,12),W(1,3),GC_11,AMP(48))
      CALL FFV1_2(W(1,2),W(1,4),GC_11,ZERO,ZERO,W(1,27))
      CALL FFV1P0_3(W(1,27),W(1,7),GC_11,ZERO,ZERO,W(1,30))
C     Amplitude(s) for diagram number 49
      CALL FFV1_0(W(1,1),W(1,15),W(1,30),GC_11,AMP(49))
...
C     Amplitude(s) for diagram number 51
      CALL FFV1_0(W(1,1),W(1,9),W(1,28),GC_11,AMP(51))
C     Amplitude(s) for diagram number 52
      CALL FFV1_0(W(1,16),W(1,6),W(1,28),GC_11,AMP(52))
C     Amplitude(s) for diagram number 53
      CALL FFV1_0(W(1,25),W(1,6),W(1,30),GC_11,AMP(53))
...
C     Amplitude(s) for diagram number 65
      CALL FFV1_0(W(1,1),W(1,15),W(1,27),GC_11,AMP(65))
...
C     Amplitude(s) for diagram number 77
      CALL FFV1_0(W(1,25),W(1,6),W(1,27),GC_11,AMP(77))
...
C     Amplitude(s) for diagram number 91
      CALL FFV1_0(W(1,1),W(1,9),W(1,11),GC_11,AMP(91))
      CALL FFV1_0(W(1,1),W(1,9),W(1,10),GC_11,AMP(92))
      CALL FFV1_0(W(1,1),W(1,9),W(1,14),GC_11,AMP(93))
C     Amplitude(s) for diagram number 92
      CALL FFV1_0(W(1,28),W(1,6),W(1,24),GC_11,AMP(94))
C     Amplitude(s) for diagram number 93
      CALL FFV1_0(W(1,28),W(1,12),W(1,3),GC_11,AMP(95))
C     Amplitude(s) for diagram number 94
      CALL FFV1_0(W(1,26),W(1,6),W(1,27),GC_11,AMP(96))
...
C     Amplitude(s) for diagram number 98
      CALL FFV1_0(W(1,16),W(1,6),W(1,11),GC_11,AMP(100))
      CALL FFV1_0(W(1,16),W(1,6),W(1,10),GC_11,AMP(101))
      CALL FFV1_0(W(1,16),W(1,6),W(1,14),GC_11,AMP(102))
     ...
     $ -1D0/3D0*AMP(78)-1D0/3D0*AMP(86)-1D0/3D0*AMP(98))
      JAMP(2)=+1D0/2D0*(-IMAG1*AMP(2)-IMAG1*AMP(3)-AMP(4)-IMAG1*AMP(7)
     ...
     $ *AMP(75)+AMP(76)+IMAG1*AMP(77)+AMP(78)+AMP(88)-AMP(93)-AMP(92)
     ...
     $ *AMP(71)-1D0/3D0*AMP(80)-1D0/3D0*AMP(83))
      JAMP(6)=+1D0/2D0*(+AMP(13)+AMP(14)+AMP(15)+AMP(16)+IMAG1*AMP(20)
     $ +AMP(21)+IMAG1*AMP(23)+AMP(51)+AMP(52)+AMP(53)+AMP(54)
     ...
     $ +AMP(99)+AMP(100)+AMP(101))
      JAMP(7)=+1D0/2D0*(+AMP(25)+AMP(26)+AMP(29)+AMP(30)+AMP(32)
     ...
     $ -1D0/3D0*AMP(66)-1D0/3D0*AMP(89)-1D0/3D0*AMP(95))
      JAMP(10)=+1D0/2D0*(+IMAG1*AMP(2)+IMAG1*AMP(3)+AMP(4)+IMAG1
     $ *AMP(7)+IMAG1*AMP(9)+AMP(10)+IMAG1*AMP(11)+AMP(49)+AMP(50)
     $ +AMP(55)+AMP(56)+IMAG1*AMP(57)+AMP(58)+IMAG1*AMP(60)+AMP(61)
     $ -IMAG1*AMP(63)+AMP(64)-IMAG1*AMP(65)+AMP(66)-IMAG1*AMP(87)
     $ +AMP(88)+AMP(89)-AMP(93)-AMP(92)+AMP(97)-AMP(102)-AMP(101))
      JAMP(11)=+1D0/2D0*(+IMAG1*AMP(1)-AMP(4)+IMAG1*AMP(5)+IMAG1
     $ *AMP(6)+IMAG1*AMP(8)-AMP(10)+IMAG1*AMP(12)+AMP(39)+AMP(40)
     $ +AMP(43)+IMAG1*AMP(44)+AMP(46)+IMAG1*AMP(47)+AMP(48)+AMP(67)
     $ +IMAG1*AMP(69)+AMP(70)+AMP(71)+IMAG1*AMP(72)-AMP(90)+AMP(93)
     ...
     $ *AMP(67)-1D0/3D0*AMP(70))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX53 = P1_MATRIX53+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
