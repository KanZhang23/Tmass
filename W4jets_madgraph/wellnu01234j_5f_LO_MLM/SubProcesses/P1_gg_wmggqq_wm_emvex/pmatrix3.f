...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX3(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX3(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1P0_3(W(1,6),W(1,4),GC_11,ZERO,ZERO,W(1,13))
...
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,12),W(1,4),W(1,17),GC_11,AMP(7))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV1_1(W(1,3),W(1,2),GC_11,ZERO,ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 14
      ...
      CALL FFV1_2(W(1,6),W(1,2),GC_11,ZERO,ZERO,W(1,19))
...
C     Amplitude(s) for diagram number 16
      ...
      CALL FFV1_2(W(1,7),W(1,2),GC_11,ZERO,ZERO,W(1,20))
...
C     Amplitude(s) for diagram number 18
      ...
      CALL FFV1_1(W(1,15),W(1,2),GC_11,ZERO,ZERO,W(1,22))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,6),W(1,22),W(1,11),GC_11,AMP(19))
      CALL FFV1_1(W(1,9),W(1,2),GC_11,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,7),W(1,15),W(1,10),GC_11,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL VVV1_0(W(1,10),W(1,2),W(1,11),GC_10,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,6),W(1,22),W(1,17),GC_11,AMP(22))
      CALL FFV1_2(W(1,16),W(1,2),GC_11,ZERO,ZERO,W(1,22))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,22),W(1,3),W(1,10),GC_11,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL VVV1_0(W(1,10),W(1,2),W(1,17),GC_10,AMP(24))
      CALL FFV1_1(W(1,3),W(1,1),GC_11,ZERO,ZERO,W(1,10))
      CALL FFV1_1(W(1,4),W(1,2),GC_11,ZERO,ZERO,W(1,23))
...
C     Amplitude(s) for diagram number 38
      ...
      CALL FFV1P0_3(W(1,24),W(1,4),GC_11,ZERO,ZERO,W(1,28))
...
C     Amplitude(s) for diagram number 54
      CALL FFV1_0(W(1,19),W(1,4),W(1,24),GC_11,AMP(54))
      CALL FFV1_2(W(1,28),W(1,2),GC_11,ZERO,ZERO,W(1,30))
C     Amplitude(s) for diagram number 55
      CALL FFV1_0(W(1,30),W(1,9),W(1,13),GC_11,AMP(55))
C     Amplitude(s) for diagram number 56
      CALL VVV1_0(W(1,2),W(1,13),W(1,24),GC_10,AMP(56))
C     Amplitude(s) for diagram number 57
      CALL FFV1_0(W(1,10),W(1,9),W(1,2),GC_11,AMP(57))
...
C     Amplitude(s) for diagram number 60
      CALL FFV1_0(W(1,26),W(1,14),W(1,2),GC_11,AMP(60))
...
C     Amplitude(s) for diagram number 73
      CALL FFV1_0(W(1,18),W(1,4),W(1,11),GC_11,AMP(73))
...
C     Amplitude(s) for diagram number 76
      CALL FFV1_0(W(1,18),W(1,4),W(1,17),GC_11,AMP(76))
...
C     Amplitude(s) for diagram number 90
      ...
      CALL VVVV3P0_1(W(1,1),W(1,2),W(1,13),GC_12,ZERO,ZERO,W(1,15))
      CALL VVVV4P0_1(W(1,1),W(1,2),W(1,13),GC_12,ZERO,ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 98
     ...
     $ -1D0/3D0*AMP(72)-1D0/3D0*AMP(89)-1D0/3D0*AMP(95))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX3 = P1_MATRIX3+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
