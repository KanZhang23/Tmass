...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX13(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX13(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,16),W(1,3),W(1,14),GC_11,AMP(9))
...
C     Amplitude(s) for diagram number 11
      ...
      CALL FFV1_1(W(1,3),W(1,13),GC_11,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 12
      CALL FFV2_0(W(1,15),W(1,14),W(1,5),GC_100,AMP(12))
      CALL FFV1_1(W(1,2),W(1,1),GC_11,ZERO,ZERO,W(1,15))
      CALL FFV1_1(W(1,3),W(1,4),GC_11,ZERO,ZERO,W(1,12))
      CALL FFV1P0_3(W(1,6),W(1,15),GC_11,ZERO,ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,6),W(1,22),W(1,17),GC_11,AMP(22))
      CALL FFV1_2(W(1,16),W(1,4),GC_11,ZERO,ZERO,W(1,22))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,22),W(1,3),W(1,10),GC_11,AMP(23))
C     Amplitude(s) for diagram number 24
      ...
      CALL FFV1P0_3(W(1,6),W(1,23),GC_11,ZERO,ZERO,W(1,25))
...
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,6),W(1,23),W(1,26),GC_11,AMP(26))
...
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,19),W(1,2),W(1,26),GC_11,AMP(28))
...
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,16),W(1,28),W(1,4),GC_11,AMP(33))
...
C     Amplitude(s) for diagram number 38
      CALL FFV1_0(W(1,16),W(1,3),W(1,28),GC_11,AMP(38))
      CALL FFV1P0_3(W(1,24),W(1,2),GC_11,ZERO,ZERO,W(1,28))
...
C     Amplitude(s) for diagram number 53
      CALL FFV1_0(W(1,26),W(1,3),W(1,27),GC_11,AMP(53))
C     Amplitude(s) for diagram number 54
      CALL FFV1_0(W(1,19),W(1,2),W(1,24),GC_11,AMP(54))
      CALL FFV1_2(W(1,28),W(1,4),GC_11,ZERO,ZERO,W(1,30))
C     Amplitude(s) for diagram number 55
      CALL FFV1_0(W(1,30),W(1,9),W(1,13),GC_11,AMP(55))
C     Amplitude(s) for diagram number 56
      CALL VVV1_0(W(1,4),W(1,13),W(1,24),GC_10,AMP(56))
C     Amplitude(s) for diagram number 57
      CALL FFV1_0(W(1,10),W(1,9),W(1,4),GC_11,AMP(57))
C     Amplitude(s) for diagram number 58
      CALL FFV2_0(W(1,30),W(1,14),W(1,5),GC_100,AMP(58))
C     Amplitude(s) for diagram number 59
      CALL FFV1_0(W(1,26),W(1,3),W(1,29),GC_11,AMP(59))
C     Amplitude(s) for diagram number 60
      CALL FFV1_0(W(1,26),W(1,14),W(1,4),GC_11,AMP(60))
      CALL FFV1_1(W(1,23),W(1,1),GC_11,ZERO,ZERO,W(1,26))
C     Amplitude(s) for diagram number 61
      CALL FFV1_0(W(1,6),W(1,26),W(1,11),GC_11,AMP(61))
...
C     Amplitude(s) for diagram number 64
      CALL FFV1_0(W(1,6),W(1,26),W(1,17),GC_11,AMP(64))
      CALL FFV1_2(W(1,16),W(1,1),GC_11,ZERO,ZERO,W(1,26))
C     Amplitude(s) for diagram number 65
      CALL FFV1_0(W(1,26),W(1,3),W(1,25),GC_11,AMP(65))
...
C     Amplitude(s) for diagram number 75
      CALL VVV1_0(W(1,1),W(1,27),W(1,11),GC_10,AMP(75))
C     Amplitude(s) for diagram number 76
      CALL FFV1_0(W(1,18),W(1,2),W(1,17),GC_11,AMP(76))
C     Amplitude(s) for diagram number 77
      CALL FFV1_0(W(1,26),W(1,3),W(1,27),GC_11,AMP(77))
C     Amplitude(s) for diagram number 78
      CALL VVV1_0(W(1,1),W(1,27),W(1,17),GC_10,AMP(78))
      CALL FFV1_2(W(1,20),W(1,1),GC_11,ZERO,ZERO,W(1,27))
...
C     Amplitude(s) for diagram number 87
      CALL FFV1_0(W(1,7),W(1,15),W(1,6),GC_11,AMP(87))
C     Amplitude(s) for diagram number 88
      CALL VVV1_0(W(1,6),W(1,4),W(1,11),GC_10,AMP(88))
...
C     Amplitude(s) for diagram number 92
      CALL FFV1_0(W(1,26),W(1,3),W(1,29),GC_11,AMP(94))
C     Amplitude(s) for diagram number 93
      CALL FFV1_0(W(1,26),W(1,14),W(1,4),GC_11,AMP(95))
C     Amplitude(s) for diagram number 94
      CALL FFV1_0(W(1,22),W(1,3),W(1,6),GC_11,AMP(96))
C     Amplitude(s) for diagram number 95
      CALL VVV1_0(W(1,6),W(1,4),W(1,17),GC_10,AMP(97))
...
C     Amplitude(s) for diagram number 98
      ...
      CALL FFV1_0(W(1,16),W(1,3),W(1,15),GC_11,AMP(101))
      CALL FFV1_0(W(1,16),W(1,3),W(1,8),GC_11,AMP(102))
      JAMP(1)=+1D0/2D0*(-1D0/3D0*AMP(13)-1D0/3D0*AMP(14)-1D0/3D0
     ...
     $ *AMP(42)-1D0/3D0*AMP(44)-1D0/3D0*AMP(47))
      JAMP(2)=+1D0/2D0*(+AMP(13)+AMP(14)+AMP(15)+AMP(16)+AMP(20)
     ...
     $ *AMP(61)-1D0/3D0*AMP(64))
      JAMP(12)=+1D0/2D0*(+IMAG1*AMP(1)-AMP(4)+IMAG1*AMP(5)+IMAG1
     ...
     $ -AMP(91)+IMAG1*AMP(94)+AMP(95)-AMP(99)+AMP(102)-AMP(100))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX13 = P1_MATRIX13+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
