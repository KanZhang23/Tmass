...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX86(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX86(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL FFV2_2(W(1,6),W(1,5),GC_100,ZERO,ZERO,W(1,9))
      CALL FFV1_1(W(1,4),W(1,8),GC_11,ZERO,ZERO,W(1,10))
      CALL FFV1P0_3(W(1,9),W(1,2),GC_11,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,7),W(1,10),W(1,11),GC_11,AMP(1))
      CALL FFV1_2(W(1,7),W(1,8),GC_11,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,12),W(1,4),W(1,11),GC_11,AMP(2))
      CALL FFV1P0_3(W(1,7),W(1,4),GC_11,ZERO,ZERO,W(1,13))
      CALL FFV1_2(W(1,9),W(1,8),GC_11,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,14),W(1,2),W(1,13),GC_11,AMP(3))
      CALL FFV1_1(W(1,2),W(1,8),GC_11,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,9),W(1,14),W(1,13),GC_11,AMP(4))
      CALL VVV1P0_1(W(1,8),W(1,13),GC_10,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,9),W(1,2),W(1,15),GC_11,AMP(5))
      CALL FFV1P0_3(W(1,6),W(1,4),GC_11,ZERO,ZERO,W(1,16))
      CALL FFV1_2(W(1,7),W(1,16),GC_11,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,17),W(1,14),W(1,5),GC_100,AMP(6))
      CALL FFV1_1(W(1,2),W(1,16),GC_11,ZERO,ZERO,W(1,18))
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,12),W(1,18),W(1,5),GC_100,AMP(7))
      CALL FFV2_1(W(1,2),W(1,5),GC_100,ZERO,ZERO,W(1,19))
      CALL VVV1P0_1(W(1,8),W(1,16),GC_10,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,7),W(1,19),W(1,20),GC_11,AMP(8))
      CALL FFV1_1(W(1,19),W(1,8),GC_11,ZERO,ZERO,W(1,21))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,7),W(1,21),W(1,16),GC_11,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,12),W(1,19),W(1,16),GC_11,AMP(10))
      CALL FFV2_2(W(1,7),W(1,5),GC_100,ZERO,ZERO,W(1,22))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,22),W(1,2),W(1,20),GC_11,AMP(11))
      CALL FFV1_2(W(1,22),W(1,8),GC_11,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,20),W(1,2),W(1,16),GC_11,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,22),W(1,14),W(1,16),GC_11,AMP(13))
      CALL FFV1_2(W(1,6),W(1,8),GC_11,ZERO,ZERO,W(1,20))
      CALL FFV1P0_3(W(1,7),W(1,19),GC_11,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,20),W(1,4),W(1,8),GC_11,AMP(14))
      CALL FFV1P0_3(W(1,6),W(1,19),GC_11,ZERO,ZERO,W(1,23))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,7),W(1,10),W(1,23),GC_11,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,6),W(1,10),W(1,8),GC_11,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,12),W(1,4),W(1,23),GC_11,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,20),W(1,19),W(1,13),GC_11,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,6),W(1,21),W(1,13),GC_11,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,6),W(1,19),W(1,15),GC_11,AMP(20))
      CALL FFV1P0_3(W(1,22),W(1,2),GC_11,ZERO,ZERO,W(1,19))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,20),W(1,4),W(1,19),GC_11,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,6),W(1,10),W(1,19),GC_11,AMP(22))
      CALL FFV1_1(W(1,2),W(1,13),GC_11,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 23
      CALL FFV2_0(W(1,20),W(1,10),W(1,5),GC_100,AMP(23))
      CALL FFV1_2(W(1,6),W(1,13),GC_11,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 24
      CALL FFV2_0(W(1,20),W(1,14),W(1,5),GC_100,AMP(24))
      CALL FFV1P0_3(W(1,3),W(1,2),GC_11,ZERO,ZERO,W(1,14))
      CALL FFV1_1(W(1,4),W(1,14),GC_11,ZERO,ZERO,W(1,15))
      CALL FFV1P0_3(W(1,9),W(1,1),GC_11,ZERO,ZERO,W(1,21))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,7),W(1,15),W(1,21),GC_11,AMP(25))
      CALL FFV1_2(W(1,7),W(1,14),GC_11,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,12),W(1,4),W(1,21),GC_11,AMP(26))
      CALL FFV1_2(W(1,9),W(1,14),GC_11,ZERO,ZERO,W(1,24))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,24),W(1,1),W(1,13),GC_11,AMP(27))
      CALL FFV1_1(W(1,1),W(1,14),GC_11,ZERO,ZERO,W(1,24))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,9),W(1,24),W(1,13),GC_11,AMP(28))
      CALL VVV1P0_1(W(1,14),W(1,13),GC_10,ZERO,ZERO,W(1,25))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,9),W(1,1),W(1,25),GC_11,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV2_0(W(1,17),W(1,24),W(1,5),GC_100,AMP(30))
      CALL FFV1_1(W(1,1),W(1,16),GC_11,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 31
      CALL FFV2_0(W(1,12),W(1,17),W(1,5),GC_100,AMP(31))
      CALL FFV2_1(W(1,1),W(1,5),GC_100,ZERO,ZERO,W(1,9))
      CALL VVV1P0_1(W(1,14),W(1,16),GC_10,ZERO,ZERO,W(1,26))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,7),W(1,9),W(1,26),GC_11,AMP(32))
      CALL FFV1_1(W(1,9),W(1,14),GC_11,ZERO,ZERO,W(1,27))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,7),W(1,27),W(1,16),GC_11,AMP(33))
C     Amplitude(s) for diagram number 34
      CALL FFV1_0(W(1,12),W(1,9),W(1,16),GC_11,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL FFV1_0(W(1,22),W(1,1),W(1,26),GC_11,AMP(35))
      CALL FFV1_2(W(1,22),W(1,14),GC_11,ZERO,ZERO,W(1,26))
C     Amplitude(s) for diagram number 36
      CALL FFV1_0(W(1,26),W(1,1),W(1,16),GC_11,AMP(36))
C     Amplitude(s) for diagram number 37
      CALL FFV1_0(W(1,22),W(1,24),W(1,16),GC_11,AMP(37))
      CALL FFV1_2(W(1,6),W(1,14),GC_11,ZERO,ZERO,W(1,26))
      CALL FFV1P0_3(W(1,7),W(1,9),GC_11,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 38
      CALL FFV1_0(W(1,26),W(1,4),W(1,14),GC_11,AMP(38))
      CALL FFV1P0_3(W(1,6),W(1,9),GC_11,ZERO,ZERO,W(1,28))
C     Amplitude(s) for diagram number 39
      CALL FFV1_0(W(1,7),W(1,15),W(1,28),GC_11,AMP(39))
C     Amplitude(s) for diagram number 40
      CALL FFV1_0(W(1,6),W(1,15),W(1,14),GC_11,AMP(40))
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,12),W(1,4),W(1,28),GC_11,AMP(41))
C     Amplitude(s) for diagram number 42
      CALL FFV1_0(W(1,26),W(1,9),W(1,13),GC_11,AMP(42))
C     Amplitude(s) for diagram number 43
      CALL FFV1_0(W(1,6),W(1,27),W(1,13),GC_11,AMP(43))
C     Amplitude(s) for diagram number 44
      CALL FFV1_0(W(1,6),W(1,9),W(1,25),GC_11,AMP(44))
      CALL FFV1P0_3(W(1,22),W(1,1),GC_11,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 45
      CALL FFV1_0(W(1,26),W(1,4),W(1,9),GC_11,AMP(45))
C     Amplitude(s) for diagram number 46
      CALL FFV1_0(W(1,6),W(1,15),W(1,9),GC_11,AMP(46))
      CALL FFV1_1(W(1,1),W(1,13),GC_11,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 47
      CALL FFV2_0(W(1,26),W(1,15),W(1,5),GC_100,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL FFV2_0(W(1,20),W(1,24),W(1,5),GC_100,AMP(48))
      CALL FFV1_2(W(1,3),W(1,13),GC_11,ZERO,ZERO,W(1,24))
C     Amplitude(s) for diagram number 49
      CALL FFV1_0(W(1,24),W(1,2),W(1,21),GC_11,AMP(49))
C     Amplitude(s) for diagram number 50
      CALL FFV1_0(W(1,24),W(1,1),W(1,11),GC_11,AMP(50))
C     Amplitude(s) for diagram number 51
      CALL FFV1_0(W(1,3),W(1,10),W(1,21),GC_11,AMP(51))
C     Amplitude(s) for diagram number 52
      CALL FFV1_0(W(1,3),W(1,15),W(1,11),GC_11,AMP(52))
      CALL FFV1_2(W(1,3),W(1,16),GC_11,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 53
      CALL FFV1_0(W(1,11),W(1,2),W(1,14),GC_11,AMP(53))
C     Amplitude(s) for diagram number 54
      CALL FFV1_0(W(1,3),W(1,18),W(1,14),GC_11,AMP(54))
C     Amplitude(s) for diagram number 55
      CALL FFV1_0(W(1,11),W(1,1),W(1,8),GC_11,AMP(55))
C     Amplitude(s) for diagram number 56
      CALL FFV1_0(W(1,3),W(1,17),W(1,8),GC_11,AMP(56))
C     Amplitude(s) for diagram number 57
      CALL FFV1_0(W(1,11),W(1,2),W(1,9),GC_11,AMP(57))
C     Amplitude(s) for diagram number 58
      CALL FFV1_0(W(1,11),W(1,1),W(1,19),GC_11,AMP(58))
C     Amplitude(s) for diagram number 59
      CALL FFV1_0(W(1,3),W(1,17),W(1,19),GC_11,AMP(59))
C     Amplitude(s) for diagram number 60
      CALL FFV1_0(W(1,3),W(1,18),W(1,9),GC_11,AMP(60))
C     Amplitude(s) for diagram number 61
      CALL FFV1_0(W(1,24),W(1,2),W(1,28),GC_11,AMP(61))
C     Amplitude(s) for diagram number 62
      CALL FFV1_0(W(1,3),W(1,10),W(1,28),GC_11,AMP(62))
C     Amplitude(s) for diagram number 63
      CALL FFV1_0(W(1,24),W(1,1),W(1,23),GC_11,AMP(63))
C     Amplitude(s) for diagram number 64
      CALL FFV1_0(W(1,3),W(1,15),W(1,23),GC_11,AMP(64))
      JAMP(1)=+1D0/4D0*(-1D0/9D0*AMP(1)-1D0/9D0*AMP(2)-1D0/9D0*AMP(3)
     $ -1D0/9D0*AMP(4)-1D0/3D0*AMP(6)-1D0/3D0*AMP(7)-1D0/3D0*AMP(9)
     $ -1D0/3D0*AMP(10)-1D0/3D0*AMP(12)-1D0/3D0*AMP(13)-1D0/3D0
     $ *AMP(14)-1D0/9D0*AMP(15)-1D0/3D0*AMP(16)-1D0/9D0*AMP(17)
     $ -1D0/9D0*AMP(18)-1D0/9D0*AMP(19)-1D0/3D0*AMP(21)-1D0/3D0
     $ *AMP(22)-1D0/9D0*AMP(23)-1D0/9D0*AMP(24)-1D0/3D0*AMP(27)
     $ -1D0/3D0*AMP(28)-AMP(30)+IMAG1*AMP(32)-AMP(33)+IMAG1*AMP(35)
     $ -AMP(37)-AMP(38)-1D0/3D0*AMP(42)-1D0/3D0*AMP(43)-AMP(45)
     $ -1D0/3D0*AMP(47)-1D0/3D0*AMP(48)-1D0/3D0*AMP(49)-1D0/9D0
     $ *AMP(50)-1D0/3D0*AMP(51)-1D0/9D0*AMP(52)-AMP(54)-AMP(60)
     $ -1D0/3D0*AMP(61)-1D0/3D0*AMP(62)-1D0/9D0*AMP(63)-1D0/9D0
     $ *AMP(64))
      JAMP(2)=+1D0/4D0*(+1D0/3D0*AMP(1)+1D0/3D0*AMP(2)+1D0/3D0*AMP(3)
     $ +1D0/3D0*AMP(4)+1D0/9D0*AMP(6)+1D0/9D0*AMP(7)+1D0/9D0*AMP(9)
     $ +1D0/9D0*AMP(10)+1D0/9D0*AMP(12)+1D0/9D0*AMP(13)+1D0/9D0
     $ *AMP(14)+1D0/3D0*AMP(15)+1D0/9D0*AMP(16)+1D0/3D0*AMP(17)
     $ +1D0/3D0*AMP(18)+1D0/3D0*AMP(19)+1D0/9D0*AMP(21)+1D0/9D0
     $ *AMP(22)+1D0/3D0*AMP(23)+1D0/3D0*AMP(24)+AMP(26)+AMP(28)
     $ -IMAG1*AMP(29)+1D0/3D0*AMP(30)+1D0/3D0*AMP(31)+1D0/3D0*AMP(33)
     $ +1D0/3D0*AMP(34)+1D0/3D0*AMP(36)+1D0/3D0*AMP(37)+AMP(41)
     $ +AMP(43)-IMAG1*AMP(44)+AMP(48)+AMP(51)+1D0/3D0*AMP(53)
     $ +1D0/3D0*AMP(54)+1D0/9D0*AMP(55)+1D0/9D0*AMP(56)+1D0/3D0
     $ *AMP(57)+1D0/9D0*AMP(58)+1D0/9D0*AMP(59)+1D0/3D0*AMP(60)
     $ +AMP(62))
      JAMP(3)=+1D0/4D0*(+1D0/3D0*AMP(3)+1D0/3D0*AMP(4)+AMP(6)
     $ -IMAG1*AMP(8)+AMP(9)-IMAG1*AMP(11)+AMP(13)+AMP(14)+1D0/3D0
     $ *AMP(18)+1D0/3D0*AMP(19)+AMP(21)+1D0/3D0*AMP(23)+1D0/3D0
     $ *AMP(24)+1D0/9D0*AMP(25)+1D0/9D0*AMP(26)+1D0/9D0*AMP(27)
     $ +1D0/9D0*AMP(28)+1D0/3D0*AMP(30)+1D0/3D0*AMP(31)+1D0/3D0
     $ *AMP(33)+1D0/3D0*AMP(34)+1D0/3D0*AMP(36)+1D0/3D0*AMP(37)
     $ +1D0/3D0*AMP(38)+1D0/9D0*AMP(39)+1D0/3D0*AMP(40)+1D0/9D0
     $ *AMP(41)+1D0/9D0*AMP(42)+1D0/9D0*AMP(43)+1D0/3D0*AMP(45)
     $ +1D0/3D0*AMP(46)+1D0/9D0*AMP(47)+1D0/9D0*AMP(48)+1D0/9D0
     $ *AMP(49)+1D0/3D0*AMP(50)+1D0/9D0*AMP(51)+1D0/3D0*AMP(52)
     $ +AMP(56)+AMP(59)+1D0/9D0*AMP(61)+1D0/9D0*AMP(62)+1D0/3D0
     $ *AMP(63)+1D0/3D0*AMP(64))
      JAMP(4)=+1D0/4D0*(-AMP(1)-AMP(3)-IMAG1*AMP(5)-1D0/3D0*AMP(14)
     $ -AMP(15)-1D0/3D0*AMP(16)-AMP(18)-IMAG1*AMP(20)-1D0/3D0*AMP(21)
     $ -1D0/3D0*AMP(22)-AMP(23)-1D0/3D0*AMP(25)-1D0/3D0*AMP(26)
     $ -AMP(31)-IMAG1*AMP(32)-AMP(34)-IMAG1*AMP(35)-AMP(36)-1D0/3D0
     $ *AMP(39)-AMP(40)-1D0/3D0*AMP(41)-AMP(46)-1D0/3D0*AMP(49)
     $ -AMP(50)-1D0/3D0*AMP(51)-AMP(53)-1D0/3D0*AMP(55)-1D0/3D0
     $ *AMP(56)-AMP(57)-1D0/3D0*AMP(58)-1D0/3D0*AMP(59)-1D0/3D0
     $ *AMP(61)-1D0/3D0*AMP(62)-AMP(63))
      JAMP(5)=+1D0/4D0*(-AMP(2)-AMP(4)+IMAG1*AMP(5)-1D0/3D0*AMP(6)
     $ -1D0/3D0*AMP(7)-1D0/3D0*AMP(9)-1D0/3D0*AMP(10)-1D0/3D0*AMP(12)
     $ -1D0/3D0*AMP(13)-AMP(17)-AMP(19)+IMAG1*AMP(20)-AMP(24)
     $ -1D0/3D0*AMP(25)-1D0/3D0*AMP(26)-1D0/3D0*AMP(27)-1D0/3D0
     $ *AMP(28)-1D0/9D0*AMP(30)-1D0/9D0*AMP(31)-1D0/9D0*AMP(33)
     $ -1D0/9D0*AMP(34)-1D0/9D0*AMP(36)-1D0/9D0*AMP(37)-1D0/9D0
     $ *AMP(38)-1D0/3D0*AMP(39)-1D0/9D0*AMP(40)-1D0/3D0*AMP(41)
     $ -1D0/3D0*AMP(42)-1D0/3D0*AMP(43)-1D0/9D0*AMP(45)-1D0/9D0
     $ *AMP(46)-1D0/3D0*AMP(47)-1D0/3D0*AMP(48)-AMP(52)-1D0/9D0
     $ *AMP(53)-1D0/9D0*AMP(54)-1D0/3D0*AMP(55)-1D0/3D0*AMP(56)
     $ -1D0/9D0*AMP(57)-1D0/3D0*AMP(58)-1D0/3D0*AMP(59)-1D0/9D0
     $ *AMP(60)-AMP(64))
      JAMP(6)=+1D0/4D0*(+1D0/3D0*AMP(1)+1D0/3D0*AMP(2)+AMP(7)
     $ +IMAG1*AMP(8)+AMP(10)+IMAG1*AMP(11)+AMP(12)+1D0/3D0*AMP(15)
     $ +AMP(16)+1D0/3D0*AMP(17)+AMP(22)+AMP(25)+AMP(27)+IMAG1*AMP(29)
     $ +1D0/3D0*AMP(38)+AMP(39)+1D0/3D0*AMP(40)+AMP(42)+IMAG1*AMP(44)
     $ +1D0/3D0*AMP(45)+1D0/3D0*AMP(46)+AMP(47)+AMP(49)+1D0/3D0
     $ *AMP(50)+1D0/3D0*AMP(52)+1D0/3D0*AMP(53)+1D0/3D0*AMP(54)
     $ +AMP(55)+1D0/3D0*AMP(57)+AMP(58)+1D0/3D0*AMP(60)+AMP(61)
     $ +1D0/3D0*AMP(63)+1D0/3D0*AMP(64))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX86 = P1_MATRIX86+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
