...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX19(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX19(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1_2(W(1,2),W(1,8),GC_11,ZERO,ZERO,W(1,10))
      CALL FFV1P0_3(W(1,7),W(1,14),GC_11,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,10),W(1,6),W(1,15),GC_11,AMP(9))
      CALL FFV1_1(W(1,6),W(1,8),GC_11,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,2),W(1,14),W(1,15),GC_11,AMP(10))
      CALL FFV1P0_3(W(1,12),W(1,3),GC_11,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,10),W(1,6),W(1,8),GC_11,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,2),W(1,14),W(1,8),GC_11,AMP(12))
...
C     Amplitude(s) for diagram number 20
      ...
      CALL FFV1_2(W(1,2),W(1,14),GC_11,ZERO,ZERO,W(1,10))
      CALL FFV1P0_3(W(1,7),W(1,17),GC_11,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,10),W(1,6),W(1,5),GC_11,AMP(21))
      CALL FFV1_1(W(1,6),W(1,14),GC_11,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,2),W(1,17),W(1,5),GC_11,AMP(22))
      CALL FFV1P0_3(W(1,12),W(1,4),GC_11,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,10),W(1,6),W(1,14),GC_11,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,2),W(1,17),W(1,14),GC_11,AMP(24))
...
C     Amplitude(s) for diagram number 32
     ...
     $ *AMP(26)+AMP(27)+1D0/3D0*AMP(29)+AMP(30)+1D0/3D0*AMP(32))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX19 = P1_MATRIX19+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
