...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX6(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX6(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1P0_3(W(1,2),W(1,3),GC_11,ZERO,ZERO,W(1,13))
...
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,19),W(1,3),W(1,26),GC_11,AMP(28))
...
C     Amplitude(s) for diagram number 38
      CALL FFV1_0(W(1,16),W(1,6),W(1,28),GC_11,AMP(38))
      CALL FFV1P0_3(W(1,24),W(1,3),GC_11,ZERO,ZERO,W(1,28))
...
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,21),W(1,6),W(1,28),GC_11,AMP(41))
...
C     Amplitude(s) for diagram number 43
      CALL FFV1_0(W(1,26),W(1,3),W(1,11),GC_11,AMP(43))
...
C     Amplitude(s) for diagram number 46
      CALL FFV1_0(W(1,26),W(1,3),W(1,17),GC_11,AMP(46))
C     Amplitude(s) for diagram number 47
      CALL FFV1_0(W(1,22),W(1,6),W(1,28),GC_11,AMP(47))
...
C     Amplitude(s) for diagram number 49
      CALL FFV1_0(W(1,26),W(1,6),W(1,25),GC_11,AMP(49))
      CALL FFV1P0_3(W(1,28),W(1,9),GC_11,ZERO,ZERO,W(1,24))
C     Amplitude(s) for diagram number 50
      CALL FFV1_0(W(1,2),W(1,23),W(1,24),GC_11,AMP(50))
...
C     Amplitude(s) for diagram number 53
      CALL FFV1_0(W(1,26),W(1,6),W(1,27),GC_11,AMP(53))
C     Amplitude(s) for diagram number 54
      CALL FFV1_0(W(1,19),W(1,3),W(1,24),GC_11,AMP(54))
...
C     Amplitude(s) for diagram number 59
      CALL FFV1_0(W(1,26),W(1,6),W(1,29),GC_11,AMP(59))
...
C     Amplitude(s) for diagram number 61
      CALL FFV1_0(W(1,2),W(1,26),W(1,11),GC_11,AMP(61))
...
C     Amplitude(s) for diagram number 64
      CALL FFV1_0(W(1,2),W(1,26),W(1,17),GC_11,AMP(64))
      CALL FFV1_2(W(1,16),W(1,1),GC_11,ZERO,ZERO,W(1,26))
C     Amplitude(s) for diagram number 65
      CALL FFV1_0(W(1,26),W(1,6),W(1,25),GC_11,AMP(65))
...
C     Amplitude(s) for diagram number 68
      ...
      CALL VVV1P0_1(W(1,1),W(1,13),GC_10,ZERO,ZERO,W(1,2))
...
C     Amplitude(s) for diagram number 71
      CALL FFV1_0(W(1,7),W(1,18),W(1,2),GC_11,AMP(71))
...
C     Amplitude(s) for diagram number 77
      CALL FFV1_0(W(1,26),W(1,6),W(1,27),GC_11,AMP(77))
...
C     Amplitude(s) for diagram number 87
      CALL FFV1_0(W(1,7),W(1,15),W(1,2),GC_11,AMP(87))
C     Amplitude(s) for diagram number 88
      CALL VVV1_0(W(1,2),W(1,4),W(1,11),GC_10,AMP(88))
...
C     Amplitude(s) for diagram number 98
     ...
     $ -1D0/3D0*AMP(72)-1D0/3D0*AMP(89)-1D0/3D0*AMP(95))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX6 = P1_MATRIX6+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
