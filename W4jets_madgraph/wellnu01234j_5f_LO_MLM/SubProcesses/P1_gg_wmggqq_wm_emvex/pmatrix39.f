...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX39(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX39(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV1P0_3(W(1,6),W(1,3),GC_11,ZERO,ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,1),W(1,14),W(1,11),GC_11,AMP(26))
...
C     Amplitude(s) for diagram number 32
     ...
     $ *AMP(26)-AMP(27)-AMP(29)-1D0/3D0*AMP(31)-1D0/3D0*AMP(32))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX39 = P1_MATRIX39+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
