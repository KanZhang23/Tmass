      DOUBLE PRECISION FUNCTION P1_DSIG27(PP,WGT,IMODE)
C     ****************************************************
C     
...
C     ----------
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! u s > e- ve~ u u c u~
      PD(IPROC)=U1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! c d > e- ve~ c u c c~
      PD(IPROC)=C1*D2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! d s > e- ve~ d c d d~
      PD(IPROC)=D1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      CALL SP1_MATRIX27(PP,P1_DSIGUU)
      IF (P1_DSIGUU.LT.1D199) THEN
        P1_DSIG27=PD(0)*CONV*P1_DSIGUU
      ELSE
