...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX24(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX24(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL FFV2_2(W(1,2),W(1,5),GC_100,ZERO,ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV1P0_3(W(1,2),W(1,6),GC_11,ZERO,ZERO,W(1,16))
...
C     Amplitude(s) for diagram number 13
      ...
      CALL FFV1_2(W(1,2),W(1,8),GC_11,ZERO,ZERO,W(1,20))
      CALL FFV1P0_3(W(1,7),W(1,19),GC_11,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,20),W(1,6),W(1,8),GC_11,AMP(14))
      CALL FFV1P0_3(W(1,2),W(1,19),GC_11,ZERO,ZERO,W(1,23))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,7),W(1,10),W(1,23),GC_11,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,2),W(1,10),W(1,8),GC_11,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,12),W(1,6),W(1,23),GC_11,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,20),W(1,19),W(1,13),GC_11,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,2),W(1,21),W(1,13),GC_11,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,2),W(1,19),W(1,15),GC_11,AMP(20))
      CALL FFV1P0_3(W(1,22),W(1,3),GC_11,ZERO,ZERO,W(1,19))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,20),W(1,6),W(1,19),GC_11,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,2),W(1,10),W(1,19),GC_11,AMP(22))
      CALL FFV1_1(W(1,3),W(1,13),GC_11,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 23
      CALL FFV2_0(W(1,20),W(1,10),W(1,5),GC_100,AMP(23))
      CALL FFV1_2(W(1,2),W(1,13),GC_11,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 24
      CALL FFV2_0(W(1,20),W(1,14),W(1,5),GC_100,AMP(24))
      CALL FFV1P0_3(W(1,1),W(1,3),GC_11,ZERO,ZERO,W(1,14))
      CALL FFV1_1(W(1,6),W(1,14),GC_11,ZERO,ZERO,W(1,15))
...
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,12),W(1,6),W(1,21),GC_11,AMP(26))
...
C     Amplitude(s) for diagram number 64
     ...
     $ +1D0/3D0*AMP(63)+1D0/3D0*AMP(64))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX24 = P1_MATRIX24+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
