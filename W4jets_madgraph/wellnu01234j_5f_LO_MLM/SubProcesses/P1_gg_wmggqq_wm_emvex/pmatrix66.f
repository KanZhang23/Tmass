...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX66(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX66(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV1_2(W(1,1),W(1,8),GC_11,ZERO,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,1),W(1,12),W(1,13),GC_11,AMP(3))
      CALL FFV1_1(W(1,12),W(1,8),GC_11,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,1),W(1,14),W(1,9),GC_11,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,11),W(1,12),W(1,9),GC_11,AMP(5))
      CALL FFV2_2(W(1,1),W(1,5),GC_100,ZERO,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1P0_3(W(1,1),W(1,12),GC_11,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,10),W(1,3),W(1,13),GC_11,AMP(9))
      CALL FFV1_1(W(1,3),W(1,8),GC_11,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,7),W(1,14),W(1,13),GC_11,AMP(10))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV1_2(W(1,1),W(1,10),GC_11,ZERO,ZERO,W(1,16))
...
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,1),W(1,12),W(1,17),GC_11,AMP(15))
      CALL FFV1_1(W(1,12),W(1,14),GC_11,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,1),W(1,5),W(1,10),GC_11,AMP(16))
...
C     Amplitude(s) for diagram number 20
      ...
      CALL FFV1_2(W(1,7),W(1,14),GC_11,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,15),W(1,4),W(1,13),GC_11,AMP(21))
      CALL FFV1_1(W(1,4),W(1,14),GC_11,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,7),W(1,11),W(1,13),GC_11,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,15),W(1,4),W(1,8),GC_11,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,7),W(1,11),W(1,8),GC_11,AMP(24))
      CALL FFV1_2(W(1,6),W(1,10),GC_11,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,11),W(1,3),W(1,13),GC_11,AMP(25))
      CALL FFV1_1(W(1,3),W(1,10),GC_11,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,6),W(1,7),W(1,13),GC_11,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,11),W(1,3),W(1,8),GC_11,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,6),W(1,7),W(1,8),GC_11,AMP(28))
      CALL FFV1_2(W(1,6),W(1,9),GC_11,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,7),W(1,4),W(1,13),GC_11,AMP(29))
      CALL FFV1_1(W(1,4),W(1,9),GC_11,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,6),W(1,11),W(1,13),GC_11,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,7),W(1,4),W(1,8),GC_11,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,6),W(1,11),W(1,8),GC_11,AMP(32))
     ...
     $ +1D0/9D0*AMP(32))
      JAMP(2)=+1D0/4D0*(-1D0/3D0*AMP(9)-1D0/3D0*AMP(10)-1D0/3D0
     ...
     $ -AMP(25)-AMP(27))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX66 = P1_MATRIX66+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
