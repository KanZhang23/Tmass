...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 2) THEN
          T=P1_MATRIX94(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION P1_MATRIX94(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.2.2, 2014-11-06
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,3),W(1,2),GC_11,ZERO,ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,17),W(1,4),W(1,8),GC_11,AMP(14))
...
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,12),W(1,4),W(1,20),GC_11,AMP(17))
...
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,17),W(1,4),W(1,16),GC_11,AMP(21))
...
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,10),W(1,2),W(1,11),GC_11,AMP(25))
...
C     Amplitude(s) for diagram number 32
     ...
     $ *AMP(26)-AMP(27)-AMP(29)-1D0/3D0*AMP(31)-1D0/3D0*AMP(32))
      JAMP(5)=+1D0/4D0*(-1D0/3D0*AMP(1)-1D0/3D0*AMP(2)-1D0/3D0*AMP(3)
     ...
     $ -1D0/9D0*AMP(28)-1D0/9D0*AMP(29)-1D0/9D0*AMP(30))
      JAMP(6)=+1D0/4D0*(+AMP(1)+AMP(3)+IMAG1*AMP(5)+1D0/3D0*AMP(14)
     ...
     $ *AMP(28)+1D0/3D0*AMP(29)+1D0/3D0*AMP(30)+AMP(31))
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        P1_MATRIX94 = P1_MATRIX94+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      END
