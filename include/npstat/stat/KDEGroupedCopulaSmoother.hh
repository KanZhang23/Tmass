#ifndef NPSTAT_KDEGROUPEDCOPULASMOOTHER_HH_
#define NPSTAT_KDEGROUPEDCOPULASMOOTHER_HH_

/*!
// \file KDEGroupedCopulaSmoother.hh
//
...
namespace npstat {
    ...
    class KDEGroupedCopulaSmoother : public GCVCopulaSmoother<KDEFilterND<MaxKDEDeg> >
    {
    public:
        ...
        */
        KDEGroupedCopulaSmoother(const unsigned* nBinsInEachDim,
        ...
        virtual ~KDEGroupedCopulaSmoother();
...
#endif // NPSTAT_KDEGROUPEDCOPULASMOOTHER_HH_
